        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-border-width', 73, $styledata, 1, 'Border', 'Set Your Front Border Width', 'true', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-section-box', 'border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-front-border', 89, $styledata, 'true', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-section-box', 'border-style');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-border-width', 129, $styledata, 1, 'Border', 'Set Your Back Part Border', 'true', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section-box', 'border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-border', 145, $styledata, 'true', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section-box','border-style');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-border-width', $styledata[237], $styledata[238], $styledata[239], 1, 'Border Width', 'Set Your Front Heading Border Width', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'width');
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-border-height', $styledata[241], $styledata[242], $styledata[243], 1, 'Border Height', 'Set Your Front Heading Border Height', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'height');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-heading-border-color', $styledata[245], 'rgba', 'Color', 'Set Your Front Heading Border Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','background');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_24_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
