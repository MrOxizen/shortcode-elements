...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        . 'oxi_addons-flip-box-front-heading-BG |' . sanitize_text_field($_POST['oxi_addons-flip-box-front-heading-BG']) . '|'
        . oxi_addons_adm_help_padding_margin_senitize('oxi_addons-flip-box-front-heading-margin')
        . '';
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-front-heading-BG', $styledata[375], 'rgba', 'Background', 'Set Your Front Heading Background', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-headding','background');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-heading-margin', 377, $styledata, 1, 'Margin', 'Set Your Front Heading Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-headding','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_28_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <form method="post">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-heading', $listitemdata[3], 'Heading', 'Set Your Back Heading', 'false');
