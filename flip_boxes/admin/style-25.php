...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        . oxi_addons_adm_help_single_size('oxi_addons-flip-box-back-heading-border-width')
        . oxi_addons_adm_help_single_size('oxi_addons-flip-box-back-heading-border-height')
        . 'oxi_addons-flip-box-back-heading-border-color |' . sanitize_text_field($_POST['oxi_addons-flip-box-back-heading-border-color']) . '|'
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = ' oxi_addons-flip-box-front-part-icon ||#||' . OxiAddonsADMHelpTextSenitize($_POST['oxi_addons-flip-box-front-part-icon']) . '||#|| '
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpBGImage('oxi_addons-flip-box-front-image', $styledata, 69, 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-section-box', 'background');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-front-icon-font-size', $styledata[129], $styledata[130], $styledata[131], 1, 'Font Size', 'Set Your Front Icon Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-number','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-front-icon-color', $styledata[133], '', 'Color', 'Set Your Front Icon Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-number','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-front-icon-bg-color', $styledata[135], 'rgba', 'Backgroud', 'Set Your Front Icon Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-number','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-border-width', 137, $styledata, 1, 'Border', 'Set Your Front Icon Border Width', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-number','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-front-icon-border', 153, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-number','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-border-radius', 157, $styledata, 1, 'Border Radius', 'Set Your Front Icon Border Radius', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-number','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-padding', 429, $styledata, 1, 'Padding', 'Set Your Front Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpBGImage('oxi_addons-flip-box-back-image', $styledata, 201, 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section-box ', 'background');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-font-size', $styledata[257], $styledata[258], $styledata[259], 1, 'Font Size', 'Set Your Front Heading Font Size', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-heading-color', $styledata[261], '', 'Color', 'Set Your Front Heading Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','color');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-heading-font', 263, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-heading-padding', 269, $styledata, 1, 'Padding', 'Set Your Front Heading Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-border-width', $styledata[419], $styledata[420], $styledata[421], 1, 'Border Width', 'Set Your Front Heading Border Width', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'width');
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-border-height', $styledata[423], $styledata[424], $styledata[425], 1, 'Border Height', 'Set Your Front Heading Border Height', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'height');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-heading-border-color', $styledata[427], 'rgba', 'Color', 'Set Your Front Heading Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','background');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-info-font-size', $styledata[285], $styledata[286], $styledata[287], 1, 'Font Size', 'Set Your Back Part Font Size', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-info-color', $styledata[289], '', 'Color', 'Set Your Back Part Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info','color');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-info-font', 291, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-info-padding', 297, $styledata, 1, 'Padding', 'Set Your Back Part Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-button-font-size', $styledata[313], $styledata[314], $styledata[315], 1, 'Font Size', 'Set Your Back Part Button Font Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-color', $styledata[317], '', 'Color', 'Set Your Back Part Button Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-bg-color', $styledata[319], 'rgba', 'Background Color', 'Set Your Back Part Button Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-border-width', 321, $styledata, 1, 'Border', 'Set Border for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-button-border', 337, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-style');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-button-font', 341, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-border-radius', 347, $styledata, 1, 'Border Radius', 'Set Border Radius for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-padding', 363, $styledata, 1, 'Padding', 'Set Padding for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-margin', 379, $styledata, 1, 'Margin', 'Set Margin for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-button','padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover Typography
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-H-color', $styledata[395], '', 'Color', 'Set Your Back Part Button Hover Color', 'false','.oxi-addons-flip-box-' . $oxiid . '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-H-bg-color', $styledata[397], 'rgba', 'Background', 'Set Your Back Part Button Hover Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','background');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-border-button-hover', 399, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-button-back-H-border-radius', 403, $styledata, 1, 'Border Radius', 'Set Border Radius for Your Back Part Button Hover', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','border-radius');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_25_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-front-part-icon', $listitemdata[1], 'Number', 'Set Your Front Number', 'false');
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_modal_textarea('oxi_addons-flip-box-back-part-SD', $listitemdata[7], 'Short Details', 'Set Your Back Part Short Details ', 'false');
