        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-font-size', $styledata[247], $styledata[248], $styledata[249], 1, 'Font Size', 'Set Your Front Heading Font Size', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-heading-color', $styledata[251], '', 'Color', 'Set Your Front Heading Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','color');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-heading-font', 253, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-heading-padding', 259, $styledata, 1, 'Padding', 'Set Your Front Heading Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-border-width', $styledata[275], $styledata[276], $styledata[277], 1, 'Border Width', 'Set Your Front Heading Border Width', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'width');
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-border-height', $styledata[279], $styledata[280], $styledata[281], 1, 'Border Height', 'Set Your Front Heading Border Height', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'height');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-heading-border-color', $styledata[283], 'rgba', 'Color', 'Set Your Front Heading Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','background');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_26_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_modal_textarea('oxi_addons-flip-box-front-part-SD', $listitemdata[3], 'Short Details', 'Set Your Front Short Details', 'false');
                    ?>
                </div>
                <div class="modal-header">                    
