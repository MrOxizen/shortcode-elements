...
function oxi_category_style_2_shortcode($styledata = FALSE, $listdata = array(), $user = 'user') {
    $css = $listcatdata = '';
    ...
    foreach ($listdata as $value) {
        ...
        echo '<div class="oxi-single-item oxi-cat-width-' . $oxiid . ' ' . $listfiles[5] . '  ' . $listcatdata . ' ' . OxiAddonsAdminDefine($user) . '">';
