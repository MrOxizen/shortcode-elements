...
function oxi_image_effects_style_15_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-hinge-effects', 'image_effects', 'css', 'style-hinge-effects');
}
