...
function oxi_image_effects_style_31_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-throw-effects', 'image_effects', 'css', 'style-throw-effects');
}
