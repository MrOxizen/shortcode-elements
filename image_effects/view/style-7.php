...
function oxi_image_effects_style_7_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-circle-effects', 'image_effects', 'css', 'style-circle-effects');
