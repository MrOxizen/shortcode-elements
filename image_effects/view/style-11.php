...
function oxi_image_effects_style_11_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-fall-away-effects', 'image_effects', 'css', 'image-style-fall-away-effects');
}
