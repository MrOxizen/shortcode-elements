...
function oxi_image_effects_style_28_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-stack-effects', 'image_effects', 'css', 'style-stack-effects');
}
