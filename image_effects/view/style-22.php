...
function oxi_image_effects_style_22_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-reveal-effects', 'image_effects', 'css', 'style-reveal-effects');
}
