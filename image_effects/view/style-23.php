...
function oxi_image_effects_style_23_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-rotate-effects', 'image_effects', 'css', 'style-rotate-effects');
}
