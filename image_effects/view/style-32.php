...
function oxi_image_effects_style_32_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-zoom-effects', 'image_effects', 'css', 'style-zoom-effects');
}
