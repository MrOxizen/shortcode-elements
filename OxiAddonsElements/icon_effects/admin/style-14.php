        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-border', $styledata[39], $styledata[40], $styledata[41], 1, 'Border', 'Your Icon Border with Responsive Size', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'box-shadow');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-hover-border-color', $styledata[33], '', 'Border Color', 'Select Your Icon Border Color', '', '.oxi-addons-container .oxi-icon-' . $oxiid . '  .oxi-icons', 'border-color');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-bg-color', $styledata[21], 'rgba', 'Background Color', 'Select Your Icon Hover Background Color', '', '.oxi-addons-container .oxi-icon-' . $oxiid . ':after', 'background');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_effects_style_14_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
