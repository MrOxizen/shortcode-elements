...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi_addons-icon-link-opening |' . sanitize_text_field($_POST['oxi_addons-icon-link-opening']) . '|'
                ...
                . ' oxi_addons-icon-hover-border-color |' . sanitize_text_field($_POST['oxi_addons-icon-hover-border-color']) . '|'
                . ' ||||'
                ...
                . ' oxi_addons-icon-padding-top |' . sanitize_text_field($_POST['oxi_addons-icon-padding-top']) . '|' . sanitize_text_field($_POST['oxi_addons-icon-padding-top-tab']) . '|' . sanitize_text_field($_POST['oxi_addons-icon-padding-top-mobile']) . '|'
                . ' oxi_addons-icon-padding-left |' . sanitize_text_field($_POST['oxi_addons-icon-padding-left']) . '|' . sanitize_text_field($_POST['oxi_addons-icon-padding-left-tab']) . '|' . sanitize_text_field($_POST['oxi_addons-icon-padding-left-mobile']) . '|'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 51, 'false', '.oxi-addons-admin-edit-list');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_Animation('oxi_addons-icon-animation', 23, $styledata, 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . '');
                                        ?>  
                                    </div>
                                </div>
                            </div>
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-border', $styledata[39], $styledata[40], $styledata[41], 1, 'Border', 'Your Icon Border with Responsive Size', 'true', '');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-border-color', $styledata[21], '', 'Border Color', 'Select Your Icon Border Color', '', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'box-shadow');
                                        ...
                                        echo oxi_addons_adm_help_number_double_dtm('oxi_addons-icon-padding-top', $styledata[43], $styledata[44], $styledata[45], 'oxi_addons-icon-padding-left', $styledata[47], $styledata[48], $styledata[49], '1', 'Padding', 'Set Your Icon  Padding Top Bottom and Left Right', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ':after', 'padding');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-hover-border-color', $styledata[33], '', 'Border Color', 'Select Your Icon Hover Border Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover', 'box-shadow');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_effects_style_16_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
