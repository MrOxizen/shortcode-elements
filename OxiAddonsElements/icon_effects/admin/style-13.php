...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi_addons-icon-link-opening |' . sanitize_text_field($_POST['oxi_addons-icon-link-opening']) . '|'
                ...
                . ' oxi_addons-icon-hover-border |' . sanitize_text_field($_POST['oxi_addons-icon-hover-border']) . '|' . sanitize_text_field($_POST['oxi_addons-icon-hover-border-tab']) . '|' . sanitize_text_field($_POST['oxi_addons-icon-hover-border-mobile']) . '|'
                . ' oxi_addons-icon-hover-hover-color |' . sanitize_text_field($_POST['oxi_addons-icon-hover-border-color']) . '|'
        ...
        <div class="oxi-addons-row">
            ...
            <div class="oxi-addons-style-left">
                <form method="post" id="oxi-addons-form-submit">
                    <div class="oxi-addons-style-settings"><div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 49, 'false', '.oxi-addons-admin-edit-list');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-hover-color', $styledata[31], '', 'Color', 'Select Your Icon Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . '  .oxi-icons', 'color');
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-border', $styledata[39], $styledata[40], $styledata[41], 1, 'Border Size', 'Your Icon Border with Responsive Size', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'border');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-border-color', $styledata[33], '', 'Border Color', 'Select Your Icon Border Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'box-shadow');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-color', $styledata[19], '', 'Color', 'Select Your Icon Hover Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover  .oxi-icons', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-bg-color', $styledata[21], 'rgba', 'Background Color', 'Select Your Icon Hover Background Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover', 'background');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-hover-border-color', $styledata[47], '', 'Border Color', 'Select Your Icon Border Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover', 'border-color');
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-hover-border', $styledata[43], $styledata[44], $styledata[45], 1, 'Border Size', 'Your Icon Border with Responsive Size', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover', 'border-radius');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_effects_style_13_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
