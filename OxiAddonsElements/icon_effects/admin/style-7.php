...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi_addons-icon-link-opening |' . sanitize_text_field($_POST['oxi_addons-icon-link-opening']) . '|'
                ...
                . ' oxi_addons-icon-border-hover-color |' . sanitize_text_field($_POST['oxi_addons-icon-border-hover-color']) . '|'
                . ' oxi_addons-icon-hover-border |' . sanitize_text_field($_POST['oxi_addons-icon-hover-border']) . '|oxi_addons-icon-hover-border-type|' . sanitize_text_field($_POST['oxi_addons-icon-hover-border-type']) . '|'
                . ' oxi_addons-icon-border |' . sanitize_text_field($_POST['oxi_addons-icon-border']) . '|oxi_addons-icon-border-type|' . sanitize_text_field($_POST['oxi_addons-icon-border-type']) . '|'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-border-color', $styledata[21], '', 'Border Color', 'Select Your Icon Border Color', '', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'border-color');
                                        echo oxi_addons_adm_help_border('oxi_addons-icon-border', $styledata[39], $styledata[41], 'Border', 'Set Your Border  Size Type', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . '');
                                        echo oxi_addons_adm_help_number('oxi-addons-icon-border-radius', $styledata[27], '1', 'Border Radius', 'Set Icon Border Radius', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover', 'border-radius');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-border-hover-color', $styledata[33], '', 'Border Color', 'Select Your Icon Hover Border Color', 'false', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover:after', 'border-color');
                                        echo oxi_addons_adm_help_border('oxi_addons-icon-hover-border', $styledata[35], $styledata[37], 'Border', 'Set Your Border  Size Type', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ':hover:after', 'border');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_effects_style_7_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
