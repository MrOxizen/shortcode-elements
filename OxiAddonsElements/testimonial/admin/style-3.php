        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="testimonial-position" name="testimonial-position">
                                                        <option <?php
                                                                ...
                                                                ?> value="">Left</option>
                                                        <option <?php
                                                                if ($styledata[270] == 'oxi-addonsdata-center') {
                                                                    echo 'selected';
                                                                }
                                                                ?> value="oxi-addonsdata-center">Center</option>
                                                        <option <?php
                                                                if ($styledata[270] == 'oxi-addonsdata-right') {
                                                                    echo 'selected';
                                                                }
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiAddonsTestimonial-animation', 63, $styledata, 'true', '');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-p-border', 83, $styledata, 1, 'Border width', 'Set Your Testimonial Border width', 'true', '  .oxi-testimonials-style-' . $oxiid . '', 'border-width');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-info-size', $styledata[134], $styledata[135], $styledata[136], 1, 'Font Size', 'Select Your Information Font Size', 'false ', '', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-info-color', $styledata[138], '', 'Color', 'Select Your Information Color', 'false', ' .oxi-testimonials-style-' . $oxiid . '-info', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsTestimonial-font-info', 140, $styledata, 'true', ' .oxi-testimonials-style-' . $oxiid . '-info');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-info-padding', 146, $styledata, 1, 'Padding', 'Set Your Information Padding', 'true', ' .oxi-testimonials-style-' . $oxiid . '-info', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-n-FS', $styledata[162], $styledata[163], $styledata[164], '2', 'Font Size', 'Set Testimonial Name Font Size', 'true', '  .oxi-testimonials-style-' . $oxiid . '-name', 'font-size');
                                            ...
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsTestimonial-n', 174, $styledata, 'true', '  .oxi-testimonials-style-' . $oxiid . '-name');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-n-padding', 196, $styledata, 1, 'Padding', 'Set Your Name Padding', 'true',  '  .oxi-testimonials-style-' . $oxiid . '-name', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-DC-FS', $styledata[238], $styledata[239], $styledata[240], '1', 'Font Size', 'Set Testimonial Name Font Size', 'true', '.oxi-testimonials-style-' . $oxiid . '-working', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-designation-c', $styledata[242], '', 'Color', 'Set your Designation Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-working', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-company-c', $styledata[244], '', 'Company Color', 'Set your Company Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-working a', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-company-hc', $styledata[246], '', 'Company Hover Color', 'Set your Company Hover Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-working a:hover', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsTestimonial-dc', 248, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . '-working');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-dc-padding', 254, $styledata, 1, 'Padding', 'Set Your Designation Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-working', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-r-FS', $styledata[212], $styledata[213], $styledata[214], '2', 'Font Size', 'Set Testimonial Rating Font Size', 'true', '.oxi-testimonials-style-' . $oxiid . '-rating i', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-r-c', $styledata[216], '', 'Color', 'Set your Rating Color', 'false', ' .oxi-testimonials-style-' . $oxiid . '-rating i', 'color');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-r-padding', 218, $styledata, 1, 'Padding', 'Set Your Rating Padding', 'true', '   .oxi-testimonials-style-' . $oxiid . '-rating', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_3_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_textbox('OxiAddonstestimonial-url', $listitemdata[9], 'Company URL', 'Set Testimonial Button Text', 'false');
                    echo oxi_addons_adm_help_number('OxiAddonstestimonial-wr', $listitemdata[5], '0.1', 'Writer Rating', 'Set Testimonial Heading Two', 'false');
