...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-p-padding-left') . ''
            . '|';
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="testimonial-position" name="testimonial-position">
                                                        <option <?php
                                                                ...
                                                                ?> value="">Left</option>
                                                        <option <?php
                                                                if ($styledata[222] == 'oxi-addonsdata-center') {
                                                                    echo 'selected';
                                                                }
                                                                ?> value="oxi-addonsdata-center">Center</option>
                                                        <option <?php
                                                                if ($styledata[222] == 'oxi-addonsdata-right') {
                                                                    echo 'selected';
                                                                }
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-DC-FS', $styledata[190], $styledata[191], $styledata[192], '1', 'Font Size', 'Set Testimonial Name Font Size', 'true', '.oxi-testimonials-style-' . $oxiid . '-working', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-designation-c', $styledata[194], '', 'Color', 'Set your Designation Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-working a', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-company-hc', $styledata[198], '', 'Company Hover Color', 'Set your Company Hover Color', 'false', ' .oxi-testimonials-style-' . $oxiid . '-working a:hover', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsTestimonial-dc', 200, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . '-working');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-dc-padding', 206, $styledata, 1, 'Padding', 'Set Your Designation Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-working', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_4_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_textbox('OxiAddonstestimonial-wc', $listitemdata[11], 'Company Name ', 'Add Writer Company Name.', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonstestimonial-url', $listitemdata[7], 'Company URL', 'Set Testimonial Button Text', 'false');
