...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-icon-FS') . ''
            . ' OxiAddonsTestimonial-icon-c |' . sanitize_hex_color($_POST['OxiAddonsTestimonial-icon-c']) . '|'
            . ' OxiAddonsTestimonial-icon-hc |' . sanitize_hex_color($_POST['OxiAddonsTestimonial-icon-hc']) . '|'
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-p-margin') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-qu-margin-top') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-qu-margin-bottom') . ''
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = '   OxiAddonstestimonial-BG ||#||' . OxiAddonsAdminUrlConvert($_POST['OxiAddonstestimonial-BG']) . '||#||'
            ...
            . ' OxiAddonstestimonial-icon||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonstestimonial-icon']) . '||#|| '
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-p-margin', $styledata[222], $styledata[223], $styledata[224], 1, 'Margin Bottom', 'Set Your Testimonial Image Bottom Margin', 'false', ' .oxi-testimonials-style-' . $oxiid . '-image', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsTestimonial-hover-BS', 234, $styledata, 'true', ' .oxi-testimonials-style-' . $oxiid . ':hover');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-info-padding', 130, $styledata, 1, 'Padding', 'Set Your Information Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-info', '');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Quote Style
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-quote-size', $styledata[208], $styledata[209], $styledata[210], 1, 'Font Size', 'Select Your Quote Font Size', 'true ', '.oxi-testimonials-style-' . $oxiid . '-info:before, .oxi-testimonials-style-' . $oxiid . '-info:after', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-quote-color', $styledata[212], '', 'Color', 'Select Your Quote Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-info:before, .oxi-testimonials-style-' . $oxiid . '-info:after', 'color');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-qu-margin-top', $styledata[226], $styledata[227], $styledata[228], 1, 'Margin Top', 'Set Your Testimonial Quote Bottom Margin', 'true', '.oxi-testimonials-style-' . $oxiid . '-info:before', 'top');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-qu-margin-bottom', $styledata[230], $styledata[231], $styledata[232], 1, 'Margin Bottom', 'Set Your Testimonial Quote Bottom Margin', 'true', '.oxi-testimonials-style-' . $oxiid . '-info:after', 'bottom');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-icon-FS', $styledata[214], $styledata[175], $styledata[176], '1', 'Font Size', 'Set Testimonial Icon Font Size', 'true', '', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-icon-c', $styledata[218], '', 'Color', 'Set your Icon Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-name-body-right i', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-icon-hc', $styledata[220], '', 'Hover Color', 'Set your Icon Hover Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-name-body-right i:hover', 'color');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_8_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_textbox('OxiAddonstestimonial-icon', $listitemdata[5], 'Icon', 'Set Your Testimonial Icon', 'false');
                    echo oxi_addons_adm_help_textbox('OxiAddonstestimonial-url', $listitemdata[9], 'Icon URL', 'Set Testimonial Button Text', 'false');
                    ?>
                </div>
