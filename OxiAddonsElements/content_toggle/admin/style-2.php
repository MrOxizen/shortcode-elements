...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-footer-info-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . ' ||||||||||||||||'
                . ' OxiAddonsCT-B-I-BG |' . sanitize_text_field($_POST['OxiAddonsCT-B-I-BG']) . '|'
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsCT-B-I-W') . ''
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsCT-B-I-H') . ''
                . '' . OxiAddonsADMBoxShadowSanitize('OxiAddonsCT-B-I-Shadow') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsCT-B-I-BR') . ''
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsCT-B-I-M') . ''
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-head">
                                            Before Button Active Color
                                        </div>
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsCT-H-AC', $styledata[175], '', 'Text Color', 'Set Your Before Button Active Text Color', 'false', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-before-text.oxi-active', 'color');
                                            ?>
                                        </div>
                                    </div> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-head">
                                            After Button Active Color
                                        </div>
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsCT-AH-AC', $styledata[177], '', 'Text Color', 'Set Your After Button Active Text Color', 'false', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-after-text.oxi-active', 'color');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsCT-CB-M', 143, $styledata, '1', 'Padding', 'Set your Content Body Padding', 'false', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-CT-main-content', 'padding');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-head">
                                            Button Inner Settings
                                        </div>
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsCT-B-I-BG', $styledata[107], 'rgba', 'Background', 'Set Your  Button Inner Background Color', 'false', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-switch::after', 'background');
                                            echo oxi_addons_adm_help_number_double_dtm('OxiAddonsCT-B-I-W', $styledata[109], $styledata[110], $styledata[111], 'OxiAddonsCT-B-I-H', $styledata[113], $styledata[114], $styledata[115], 1, 'Width Height', 'Set Your  Button Inner width and Height', 'true', '', '');
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsCT-B-I-Shadow', 117, $styledata, 'true', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-switch::after');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsCT-B-I-BR', 123, $styledata, '1', 'Border Radius', 'Set your  Button Inner Border Radius', 'true', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-switch::after', 'padding');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsCT-B-I-M', $styledata[139], $styledata[140], $styledata[141], '1', 'Button Left Length', 'Set Your Button Inner left Length', 'true', '.oxi-addons-CT-'.$oxiid.' .oxi-addons-switchOn:after', 'left');
                                            $NOJSS = array(
                                                array('OxiAddonsCT-B-I-W', 'Button Inner Width'),
                                                array('OxiAddonsCT-B-I-H', 'Button Inner Hight')
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJSS);
                                            ?>
                                        </div>
                                    </div>
                                </div>
