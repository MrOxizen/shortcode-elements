        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 205, 'false', '.oxi-addons-admin-edit-list', '', '.oxi-addons-admin-edit-list');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('OxiAddIconBoxes-icon-bgcolor', $styledata[177], 'rgba', 'Background Color', 'Select Your Icon Background Color', '', '.oxi-addons-icon-boxes-' . $oxiid . ' .oxi-icons-body', 'background');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAddIconBoxes-icon-border', 101, $styledata, 1, 'Border', 'Set Your Icon Boxes border Top Bottom and Left Right', 'true', '.oxi-addons-icon-boxes-' . $oxiid . ' .oxi-icons-body', 'border-width');
                                        echo OxiAddonsADMhelpBorder('OxiAddIconBoxes-icon-border', 183, $styledata, 'true', '.oxi-addons-icon-boxes-' . $oxiid . ' .oxi-icons-body');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddIconBoxes-icon-radius', 187, $styledata, 1, 'Border Radius', 'Set Your Icon Boxes Border Radius Top Bottom and Left Right', 'true', '.oxi-addons-icon-boxes-' . $oxiid . ' .oxi-icons-body', 'border-radius');
                                        ?>
                                    </div>
                                    <div class="oxi-head">
                                        Icon Animation
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_boxes_style_5_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
