        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 179, 'false', '.oxi-addons-admin-edit-list');
                                        echo oxi_addons_adm_help_number_dtm('OxiAddIconBoxes-width', $styledata[3], $styledata[4], $styledata[5], 1, 'Width', 'Set Your Icon Boxes Max Width', 'true', '.oxi-addons-icon-boxes-' . $oxiid . '', 'max-width');
                                        echo OxiAddonsADMHelpBGImage('OxiAddIconBoxes-body', $styledata, 11, 'true', '.oxi-addons-icon-boxes-' . $oxiid . '-data', 'background');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddIconBoxes-border', 15, $styledata, 1, 'Border', 'Set Your Icon Boxes Border Top Bottom and Left Right', 'true', '.oxi-addons-icon-boxes-' . $oxiid . '-data', 'border');
                                        echo OxiAddonsADMhelpBorder('OxiAddIconBoxes-border', 31, $styledata, 'true', '.oxi-addons-icon-boxes-' . $oxiid . '-data');
                                        echo oxi_addons_adm_help_true_false('OxiAddIconBoxes-Tab', $styledata[177], 'Same Tab', '', 'New Tab', '_blank', 'Link Opening Style', 'Link Open same tab or new tab', 'true');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_Text_Align('OxiAddIconBoxes-icon-align', $styledata[99], 'Icon Align', 'Set Your Icon Align', 'true', '.oxi-addons-icon-boxes-' . $oxiid . '', 'text-align');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddIconBoxes-icon-padding', 101, $styledata, 1, 'Padding', 'Set Your Icon Padding Top Bottom and Left Right', 'true', '.oxi-addons-icon-boxes-' . $oxiid . ' .oxi-icons', 'padding');
                                       ?>
                                    </div>
                                    <div class="oxi-head">
                                        Icon Animation
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_boxes_style_1_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
