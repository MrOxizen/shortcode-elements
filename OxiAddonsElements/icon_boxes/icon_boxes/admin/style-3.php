        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAddIconBoxes-margin', 67, $styledata, 1, 'Margin', 'Set Your Icon Boxes  Margin Top Bottom and Left Right', '.oxi-addons-icon-boxes-' . $oxiid . '-data', 'margin');
                                        ?>
                                    </div> 
                                </div>
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAddIconBoxes-icon-radius', 187, $styledata, 1, 'Border Radius', 'Set Your Icon Boxes Border Radius Top Bottom and Left Right', 'true', '.oxi-addons-icon-boxes-' . $oxiid . ' .oxi-icons', 'brder-radius');
                                      ?>
                                    </div>
                                    <div class="oxi-head">
                                        Icon Animation
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_boxes_style_3_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
