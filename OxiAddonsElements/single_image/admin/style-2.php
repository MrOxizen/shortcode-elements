...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddSI-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_single_size('OxiAddSI-I-size') . ''
                . '' . oxi_addons_adm_help_single_size('OxiAddSI-I-width') . ''
                . ' OxiAddSI-I-color|' . sanitize_text_field($_POST['OxiAddSI-I-color']) . '|'
                . ' OxiAddSI-I-bgcolor|' . sanitize_text_field($_POST['OxiAddSI-I-bgcolor']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddSI-I-border') . ''
                . '' . OxiAddonsADMHelpBorderSanitize('OxiAddSI-I-border') . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddSI-I-radius') . ''
                . ' OxiAddSI-IH-color|' . sanitize_text_field($_POST['OxiAddSI-IH-color']) . '|'
                . ' OxiAddSI-IH-bgcolor|' . sanitize_text_field($_POST['OxiAddSI-IH-bgcolor']) . '|'
                . '' . OxiAddonsADMHelpBorderSanitize('OxiAddSI-IH-border') . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddSI-IH-radius') . ''
                ...
                . 'OxiAddSI-Icon ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddSI-Icon']) . '||#||'
                    ...
                    <div class="oxi-addons-style-settings">
                        <div class="oxi-addons-tabs-wrapper">
                            <ul class="oxi-addons-tabs-ul">
                                ...
                                <li ref="#oxi-addons-tabs-id-2"> Icon, Link, Lightbox</li>
                            </ul>
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddSI-class', $stylefiles[3], 'ID', 'Set your Your Image ID');
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_double('OxiAddSIR-top', $styledata[169], 'OxiAddSIR-left', $styledata[171], 1, 'Top Left', 'Set Ribon Top left break', '', '', '', '');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddSI-Icon', $stylefiles[9], 'Icon Class', "Set Your Font Awesome Icon Class", '');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddSI-I-size', $styledata[173], $styledata[174], $styledata[175], 1, 'Font Size', 'Select Your Icon Size', 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddSI-I-width', $styledata[177], $styledata[178], $styledata[179], 1, 'Width Height', 'Select Your Icon  Width Height', 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data', 'width');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddSI-I-color', $styledata[181], '', 'Color', 'Select Your Ribbon Color', '', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data .oxi-icons', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddSI-I-bgcolor', $styledata[183], 'rgba', 'Background', 'Select Your Ribbon Background', '', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data', 'background');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddSI-I-border', 185, $styledata, 1, 'Border', 'Set Your Single Image Border Top Bottom and Left Right', 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddSI-I-border', 201, $styledata, 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddSI-I-radius', 205, $styledata, 1, 'Border Radius', 'Set Your Image Border Radius Top Bottom and Left Right', 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data', 'border-radius');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddSI-IH-color', $styledata[221], '', 'Color', 'Select Your Ribbon Color', '', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data:hover .oxi-icons', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddSI-IH-bgcolor', $styledata[223], 'rgba', 'Background', 'Select Your Ribbon Background', '', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data:hover', 'background');
                                            echo OxiAddonsADMhelpBorder('OxiAddSI-IH-border', 225, $styledata, 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data:hover');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddSI-IH-radius', 229, $styledata, 1, 'Border Radius', 'Set Your Image Border Radius Top Bottom and Left Right', 'true', '.oxi-addons-single-image-container-' . $oxiid . ' .oxi-addons-single-image-icon-data:hover', 'border-radius');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_true_false('OxiAddSI-Link-open', $styledata[247], 'New Tab', '_blank', 'Same Tab', '', 'Link Open', '');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddSI-L-bg', $styledata[251], 'rgba', 'Background', 'Set Your Full body Background Color', '', '.oxi-addons-lightbox-' . $oxiid . '.Oximfp-bg', 'background');
