        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number('oxi-addons-icon-border-radius', $styledata[27], '1', 'Border Radius', 'Set Icon Border Radius', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ', .oxi-addons-container .oxi-icon-' . $oxiid . ':after', 'border-radius');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_style_4_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
