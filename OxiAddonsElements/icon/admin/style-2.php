        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpItemPerRows('OxiADDC-Item', $styledata, 41, 'false', '.oxi-addons-admin-edit-list');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-bg-color', $styledata[21], 'rgba', 'Background Color', 'Select Your Icon Color','false', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'background');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-border-color', $styledata[31], '', 'Border Color', 'Select Your Icon Border Color', '.oxi-addons-container .oxi-icon-' . $oxiid . ':after', 'box-shadow');
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-border-size', $styledata[33], $styledata[34], $styledata[35], 1, 'Border Size', 'Your Icon Border Size', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ':after', 'box-shadow');
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-padding-top', $styledata[37], $styledata[38], $styledata[39], 1, 'Padding', 'Your Icon Padding Size', 'true', '.oxi-addons-container .oxi-icon-' . $oxiid . ':after', 'padding');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_style_2_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
