...
function oxi_icon_style_1_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user')
{
    ...
    foreach ($listdata as $value) {
        ...
        echo '<div class="' . OxiAddonsItemRows($styledata, 31) . ' oxi-addons-center  ' . OxiAddonsAdminDefine($user) . '" ' . OxiAddonsAnimation($styledata, 23) . '>';
        if ($listfiles[7] != '') {
