...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-Image-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '  oxiAddonsInfoImageBoxes-IMG-PS-horizoltal |' . sanitize_text_field($_POST['oxiAddonsInfoImageBoxes-IMG-PS-horizoltal']) . '|'
                . ' OxiAddonsInfoImageBoxes-G-hover-BG |' . sanitize_text_field($_POST['OxiAddonsInfoImageBoxes-G-hover-BG']) . '|'
                . ' OxiAddonsInfoImageBoxes-H-hover-C |' . sanitize_hex_color($_POST['OxiAddonsInfoImageBoxes-H-hover-C']) . '|'
                . ' OxiAddonsInfoImageBoxes-SD-hover-C |' . sanitize_hex_color($_POST['OxiAddonsInfoImageBoxes-SD-hover-C']) . '|'
                . '|';
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsInfoImageBoxes-G-hover-BG', $styledata[206], 'rgba', 'Background Color', 'Set Info Image boxes Hover background color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ':hover', 'background');
                                        ?>
                                    </div>    
                                    <div class="oxi-head">
                                        Box Shadow
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        <div class=" form-group row">
                                            <label for="oxiAddonsInfoImageBoxes-IMG-PS" class="col-sm-6 control-label"  oxi-addons-tooltip="Set your Image Position"> Vertical Position </label>
                                            <div class="col-sm-6 addons-dtm-laptop-lock">
                                                <select class="form-control" id="oxiAddonsInfoImageBoxes-IMG-PS" name="oxiAddonsInfoImageBoxes-IMG-PS">
                                                    ...
                                                    if ($styledata[82] == 'middle') {
                                                        echo 'selected';
                                                    };
                                                    ?>>Center</option>
                                                    <option value="bottom" <?php
                                                    if ($styledata[82] == 'bottom') {
                                                        echo 'selected';
                                                    };
                                                    ?>>Bottom</option>
                                                </select>
                                        ...
                                        <?php
                                        echo oxi_addons_adm_help_true_false('oxiAddonsInfoImageBoxes-IMG-PS-horizoltal', $styledata[204], 'Left', 'left', 'Right', 'right', 'vertical Position', 'Set Your Image Position Verticaly', 'false');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsInfoImageBoxes-H-hover-C', $styledata[208], '', 'Color', 'Set Info Image boxes Heading  Hover Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ':hover .oxi-addons-main-content .oxi-addons-heading', 'color');
                                        ?>
                                    </div>
                                </div> 
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsInfoImageBoxes-SD-hover-C', $styledata[210], '', 'Color', 'Set Info Image boxes :hover Short Details Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ':hover .oxi-addons-main-content .oxi-addons-details', 'color');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_image_boxes_style_4_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
