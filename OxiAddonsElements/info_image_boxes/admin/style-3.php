        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsInfoImageBoxes-G-hover-BG', $styledata[204], 'rgba', 'Background Color', 'Set Info Image boxes Hover background color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ':hover', 'background');
                                        ?>
                                    </div>  
                                    <div class="oxi-head">
                                        Box Shadow
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsInfoImageBoxes-H-hover-C', $styledata[206], '', 'Color', 'Set Info Image boxes Heading  Hover Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ':hover .oxi-addons-main-content .oxi-addons-heading', 'color');
                                        ?>
                                    </div>
                                </div> 
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsInfoImageBoxes-SD-hover-C', $styledata[208], '', 'Color', 'Set Info Image boxes :hover Short Details Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ':hover .oxi-addons-main-content .oxi-addons-details', 'color');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_image_boxes_style_3_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
