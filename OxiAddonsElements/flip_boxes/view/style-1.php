 ...
 */
function oxi_flip_boxes_style_1_shortcode($styledata = FALSE, $listdata = array(), $user = 'user') {
    ...
    foreach ($listdata as $value) {
        ...
        echo'       <div class="' . OxiAddonsItemRows($styledata, 3) . ' ' . OxiAddonsAdminDefine($user) . '"    ' . OxiAddonsAnimation($styledata, 13) . '>
