...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        . oxi_addons_adm_help_padding_margin_senitize('oxi_addons-flip-box-front-icon-margin')
        . oxi_addons_adm_help_padding_margin_senitize('oxi_addons-flip-box-back-icon-margin')
        . '';
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-front-icon-font-size', $styledata[133], $styledata[134], $styledata[135], 1, 'Font Size', 'Set Your Front Icon Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icon','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-front-icon-color', $styledata[137], '', 'Color', 'Set Your Front Icon Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-front-icon-bg-color', $styledata[139], 'rgba', 'Backgroud', 'Set Your Front Icon Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons ','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-border-width', 141, $styledata, 1, 'Border', 'Set Your Front Icon Border Width', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons ','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-front-icon-border', 157, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons ','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-border-radius', 161, $styledata, 1, 'Border Radius', 'Set Your Front Icon Border Radius', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons ','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-padding', 177, $styledata, 1, 'Padding', 'Set Your Front Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-margin', 177, $styledata, 1, 'margin', 'Set Your Front Icon margin', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-icon-width', $styledata[305], $styledata[306], $styledata[307], 1, 'Icon Width', 'Set Your Back Icon Width', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons', 'width');
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-icon-font-size', $styledata[313], $styledata[314], $styledata[315], 1, 'Font Size', 'Set Your Back Icon Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon  .oxi-icons','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-icon-color', $styledata[317], '', 'Color', 'Set Your Back Icon Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon  .oxi-icons','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-icon-bg-color', $styledata[319], 'rgba', 'Backgroud', 'Set Your Back Icon Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-border-width', 321, $styledata, 1, 'Border', 'Set Your Back Icon Border Width', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon ','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-icon-border', 337, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-border-radius', 341, $styledata, 1, 'Border Radius', 'Set Your Back Icon Border Radius', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons ','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-padding', 357, $styledata, 1, 'Padding', 'Set Your Back Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon  .oxi-icons','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-margin', 445, $styledata, 1, 'Margin', 'Set Your Back Icon Margin', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_23_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-front-part-date', $listitemdata[1], 'Icon Class', 'Add your Serial Number, Use Any number for knowing the serial', 'false');
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-button-url', $listitemdata[13], 'Link', 'Set Your Back Part Button Link', 'false');
                    ?>
                </div>
