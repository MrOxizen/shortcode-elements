        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-padding', 391, $styledata, 1, 'Padding', 'Set Your Front Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-button-font-size', $styledata[285], $styledata[286], $styledata[287], 1, 'Font Size', 'Set Your Back Part Button Font Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-color', $styledata[289], '', 'Color', 'Set Your Back Part Button Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-bg-color', $styledata[291], 'rgba', 'Background Color', 'Set Your Back Part Button Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-border-width', 293, $styledata, 1, 'Border', 'Set Border for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-button-border', 309, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-style');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-button-font', 313, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-border-radius', 319, $styledata, 1, 'Border Radius', 'Set Border Radius for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-padding', 335, $styledata, 1, 'Padding', 'Set Padding for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-margin', 351, $styledata, 1, 'Margin', 'Set Margin for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-button','padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover Typography
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-H-color', $styledata[367], '', 'Color', 'Set Your Back Part Button Hover Color', 'false','.oxi-addons-flip-box-' . $oxiid . '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-H-bg-color', $styledata[369], 'rgba', 'Background', 'Set Your Back Part Button Hover Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','background');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-border-button-hover', 371, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-button-back-H-border-radius', 375, $styledata, 1, 'Border Radius', 'Set Border Radius for Your Back Part Button Hover', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','border-radius');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_20_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
