        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpBGImage('oxi_addons-flip-box-back-image', $styledata, 189, 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section', 'background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-border-width', 193, $styledata, 1, 'Border', 'Set Your Back Part Border', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-border', 209, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-padding', 213, $styledata, 1, 'Padding', 'Set Your Back Part Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-margin', 229, $styledata, 1, 'Margin', 'Set Your Back Part Margin', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section-box','padding');
                                            $NOJS = array(
                                                array('oxi_addons-flipping-time', 'Flipping Time'),
                                                array('oxi_addons-flip-box-border-R', 'Border Radius'),
                                                array('oxi_addons-flip-box-back-icon-width', 'Icon Width'),
                                            );
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-icon-width', $styledata[245], $styledata[246], $styledata[247], 1, 'Icon Width', 'Set Your back Icon Width', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons', 'width');
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-icon-font-size', $styledata[249], $styledata[250], $styledata[251], 1, 'Font Size', 'Set Your back Icon Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-icon-color', $styledata[253], '', 'Color', 'Set Your back Icon Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-icon-bg-color', $styledata[255], 'rgba', 'Backgroud', 'Set Your back Icon Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-border-width', 257, $styledata, 1, 'Border', 'Set Your back Icon Border Width', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon i','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-icon-border', 273, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-border-radius', 277, $styledata, 1, 'Border Radius', 'Set Your back Icon Border Radius', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-padding', 293, $styledata, 1, 'Padding', 'Set Your back Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_8_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <form method="post">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-icon', $listitemdata[3], 'Icon Class', 'Set Your Back Icon Class', 'false');
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-button-url', $listitemdata[5], 'Icon Link', 'Set Your Icon Link', 'false');
                    ?>
                </div>
