...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = ' oxi_addons-flip-box-front-part-icon ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['oxi_addons-flip-box-front-part-icon']) . '||#|| '
                ...
                . ' oxi_addons-flip-box-back-part-button ||#||' . OxiAddonsADMHelpTextSenitize($_POST['oxi_addons-flip-box-back-part-button']) . '||#|| '
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-icon-padding', 173, $styledata, 1, 'Padding', 'Set Your Front Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-front-heading-font-size', $styledata[189], $styledata[190], $styledata[191], 1, 'Font Size', 'Set Your Front Heading Font Size', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-headding', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-front-heading-color', $styledata[193], '', 'Color', 'Set Your Front Heading Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-headding','color');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-front-heading-font', 195, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-headding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-front-heading-padding', 201, $styledata, 1, 'Padding', 'Set Your Front Heading Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-headding','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                </div>
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpBGImage('oxi_addons-flip-box-back-image', $styledata, 217, 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section', 'background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-border-width', 221, $styledata, 1, 'Border', 'Set Your Back Part Border', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-border', 237, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-padding', 241, $styledata, 1, 'Padding', 'Set Your Back Part Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-margin', 257, $styledata, 1, 'Margin', 'Set Your Back Part Margin', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-section-box','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-heading-font-size', $styledata[273], $styledata[274], $styledata[275], 1, 'Font Size', 'Set Your Front Heading Font Size', 'false', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-heading-color', $styledata[277], '', 'Color', 'Set Your Front Heading Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','color');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-heading-font', 279, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-heading-padding', 285, $styledata, 1, 'Padding', 'Set Your Front Heading Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-headding','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-icon-width', $styledata[301], $styledata[302], $styledata[303], 1, 'Icon Width', 'Set Your Back Icon Width', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons', 'width');
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-icon-font-size', $styledata[305], $styledata[306], $styledata[307], 1, 'Font Size', 'Set Your Back Icon Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-icon-color', $styledata[309], '', 'Color', 'Set Your Back Icon Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-icon-bg-color', $styledata[311], 'rgba', 'Backgroud', 'Set Your Back Icon Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-border-width', 313, $styledata, 1, 'Border', 'Set Your Front Icon Border Width', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-icon-border', 329, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-border-radius', 333, $styledata, 1, 'Border Radius', 'Set Your Back Icon Border Radius', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon .oxi-icons','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-icon-padding', 349, $styledata, 1, 'Padding', 'Set Your Back Icon Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-icon','padding');
                                            ?>
                                        </div>                                              
                                    </div>     
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-info-font-size', $styledata[365], $styledata[366], $styledata[367], 1, 'Font Size', 'Set Your Back Part Font Size', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-info-color', $styledata[369], '', 'Color', 'Set Your Back Part Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info','color');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-info-font', 371, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-info-padding', 377, $styledata, 1, 'Padding', 'Set Your Back Part Padding', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-info','padding');
                                            ?>
                                        </div>                                              
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi_addons-flip-box-back-button-font-size', $styledata[393], $styledata[394], $styledata[395], 1, 'Font Size', 'Set Your Back Part Button Font Size', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-color', $styledata[397], '', 'Color', 'Set Your Back Part Button Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-bg-color', $styledata[399], 'rgba', 'Background Color', 'Set Your Back Part Button Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','background');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-border-width', 401, $styledata, 1, 'Border', 'Set Border for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-width');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-button-border', 417, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-style');
                                            echo OxiAddonsADMHelpFontSettings('oxi_addons-flip-box-back-button-font', 421, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-border-radius', 427, $styledata, 1, 'Border Radius', 'Set Border Radius for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','border-radius');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-padding', 443, $styledata, 1, 'Padding', 'Set Padding for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link','padding');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-back-button-margin', 459, $styledata, 1, 'Margin', 'Set Margin for Your Back Part Button ', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-button','padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover Typography
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-H-color', $styledata[475], '', 'Color', 'Set Your Back Part Button Hover Color', 'false','.oxi-addons-flip-box-' . $oxiid . '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','color');
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-flip-box-back-button-H-bg-color', $styledata[477], 'rgba', 'Background', 'Set Your Back Part Button Hover Background Color', 'false','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','background');
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-border-button-hover', 479, $styledata, 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','border-style');
                                            echo oxi_addons_adm_help_padding_margin('oxi_addons-flip-box-button-back-H-border-radius', 483, $styledata, 1, 'Border Radius', 'Set Border Radius for Your Back Part Button Hover', 'true','.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link:hover','border-radius');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_11_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <form method="post">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-heading', $listitemdata[5], 'Heading', 'Set Your Back Heading', 'false');
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-icon', $listitemdata[7], 'Icon Class', 'Set Your Back Icon Class', 'false');
                    ...
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-button', $listitemdata[11], 'Button Text', 'Set Your Back Part button Text ', 'false');
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-button-url', $listitemdata[13], 'Button Url', 'Set Your Icon Link', 'false');
                    ?>
                </div>
