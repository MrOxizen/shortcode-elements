        ...
        <div class="oxi-addons-row">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('oxi_addons-flip-box-front-icon-border-width', 'Icon Height & Width'),
                                            );
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_7_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-front-part-icon', $listitemdata[5], 'Icon Class', 'Set Your Front Icon Class', 'false');
                    ?>
                </div>
                <div class="modal-header">                    
