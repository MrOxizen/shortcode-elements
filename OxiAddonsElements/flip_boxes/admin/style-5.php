        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMhelpBorder('oxi_addons-flip-box-back-button-border', 261, $styledata, 'true', '.oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link', 'border-style');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_flip_boxes_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_modal_textbox('oxi_addons-flip-box-back-part-button-url', $listitemdata[7], 'Button Link', 'Set Your Back Part Button Link', 'false');
                    ?>
                </div>
