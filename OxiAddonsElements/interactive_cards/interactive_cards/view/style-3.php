...
function oxi_interactive_cards_style_3_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
		    ...
		    <div class="oxi-addons-Interactive-card-'. $oxiid . '">
                        <div class="oxi-addons-IC-wrapper">
                            <div class="oxi-addons-IC" '.OxiAddonsAnimation($styledata, 29) . '>
                                <div class="oxi-addons-ICfull-content-s3 " id="oxi-front-part-'.$oxiid.'">
		...
		echo OxiAddonsInlineCSSData($css);
                    ...
                    if ($styledata[301] == 'on') {
                        $jquery .= "jQuery(function () {
                            jQuery('.oxi-addons-ICfull-content-s3').on('click', function () {
