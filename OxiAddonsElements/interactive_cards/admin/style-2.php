...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . 'oxi-cards-front-shortcode ||#||' . OxiAddonsADMHelpTextSenitize($_POST['oxi-cards-front-shortcode']) . '||#||'
    ;
        ...
        <div class="oxi-addons-row">
                    ...
                    <div class="oxi-addons-style-settings">
                        <div class="oxi-addons-tabs-wrapper">
                            <ul class="oxi-addons-tabs-ul">
                                ...
                                <li  ref="#oxi-addons-tabs-2">Front Part</li> 
                                <li  ref="#oxi-addons-tabs-3">Back Part</li> 
                            </ul> 
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-12">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textarea('oxi-cards-front-shortcode', $stylefiles[8], 'false');
                                            ?>
                                        </div>
                                    </div> 
                                </div> 
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_interactive_cards_style_2_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
