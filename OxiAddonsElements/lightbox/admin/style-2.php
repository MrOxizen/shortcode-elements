...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddLightbox-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . 'OxiAddLightbox-video ||#||' . sanitize_text_field(OxiAddonsAdminUrlConvert($_POST['OxiAddLightbox-video'])) . '||#||'
            . '|';
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textarea('OxiAddLightbox-video', $stylefiles[5]);
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMhelpBoxShadow('OxiAddLightbox-box-shadow', 33, $styledata, 'true', '.oxi-addons-lightbox-' . $oxiid . ', .oxi-addons-lightbox-' . $oxiid . ' .Oximfp-content .Oximfp-iframe-scaler iframe');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('OxiAddLightbox-preloader', $styledata[43], '', 'Color', 'Select Your Preloader Color', '', '.oxi-addons-lightbox-' . $oxiid . ', .oxi-addons-lightbox-' . $oxiid . ' .Oximfp-close .Oximfp-preloader', 'background');
                                        ?>
                                    </div>
                                </div>
                            </div>
