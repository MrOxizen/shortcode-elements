...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsSocialShare-button-FS') . ''
                . ' OxiAddonsSocialShare-width-type |' . sanitize_text_field($_POST['OxiAddonsSocialShare-width-type']) . '|'
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsSocialShare-button-W') . ''
                . '' . OxiAddonsADMHelpFontSettingsSanitize('OxiAddonsSocialShare-button-F') . ''
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsSocialShare-button-P') . ''
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsSocialShare-icon-P') . ''
                ...
                . '||#||'
                . ' OxiAddonsSocialShare-facebook-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-facebook-text']) . '||#||'
                . ' OxiAddonsSocialShare-facebook-icon ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-facebook-icon']) . '||#||'
                . ' OxiAddonsSocialShare-twitter-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-twitter-text']) . '||#||'
                . ' OxiAddonsSocialShare-twitter-icon ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-twitter-icon']) . '||#||'
                . ' OxiAddonsSocialShare-linkedin-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-linkedin-text']) . '||#||'
                . ' OxiAddonsSocialShare-linkedin-icon ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-linkedin-icon']) . '||#||'
                . ' OxiAddonsSocialShare-google-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-google-text']) . '||#||'
                . ' OxiAddonsSocialShare-google-icon ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-google-icon']) . '||#||'
                . ' OxiAddonsSocialShare-pinterest-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsSocialShare-pinterest-text']) . '||#||'
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsSocialShare-button-FS', $styledata[37], $styledata[38], $styledata[39], '', 'Font Size', 'Set Social share Text Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-text', 'font-size');
                                            echo oxi_addons_adm_help_true_false('OxiAddonsSocialShare-width-type', $styledata[41], 'Dymamic', 'true', 'Manual', 'false', 'Width Type', 'Set With Type as same Width or Dynamic', 'true');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsSocialShare-button-W', $styledata[43], $styledata[44], $styledata[45], '', 'Max-Width', 'Set Social share Max width', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-main-share-circle', 'max-width');
                                            echo OxiAddonsADMHelpButtonFontSettings('OxiAddonsSocialShare-button-F', 47, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-text');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsSocialShare-button-P', 73, $styledata, 1, 'Padding', 'Set Social Share Button padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-main-share-circle', 'padding');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsSocialShare-icon-P', 125, $styledata, 1, 'Padding', 'Set Social Share Button padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-icons', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_textbox('OxiAddonsSocialShare-facebook-text', $stylefiles[2], 'Social Text', 'Write your Social Text');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_textbox('OxiAddonsSocialShare-twitter-text', $stylefiles[6], 'Social Text', 'Write your Social Text');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_textbox('OxiAddonsSocialShare-linkedin-text', $stylefiles[10], 'Social Text', 'Write your Social Text');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_textbox('OxiAddonsSocialShare-google-text', $stylefiles[14], 'Social Text', 'Write your Social Text');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_textbox('OxiAddonsSocialShare-pinterest-text', $stylefiles[18], 'Social Text', 'Write your Social Text');
