...
function oxi_google_map_style_3_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
                            ...
                            echo '  <div class="' . OxiAddonsAdminDefine($user) . '" >
                                    ...
                                    echo '  <div class="oxi-addons-admin-absulote">
                                                <div class="oxi-addons-admin-absulate-edit">
                                                    <form method="post"> ' . wp_nonce_field("OxiAddonsListFileEditgoogle_mapdata") . '
                                                        <input type="hidden" name="oxi-item-id" value="' . $value['id'] . '">
                                                        <button class="btn btn-primary" type="submit" value="edit" name="OxiAddonsListFileEditdata">Edit</button>
                                                    </form>
                                                </div>
                                                <div class="oxi-addons-admin-absulate-delete">
                                                    <form method="post">  ' . wp_nonce_field("OxiAddonsListFileDeletegoogle_mapdata") . '
                                                        <input type="hidden" name="oxi-item-id" value="' . $value['id'] . '">
