...
$listitemdata = array('', '', '', '', '', '#ffffff', '', '#ffffff', '', 'rgba(141,29,143,1.00)', '', 'rgba(92,92,92,1.00)', '', '#7700c7', '', '#5c5c5c');
$listid = '';
        ...
        <div class="oxi-addons-row">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_social_icons_style_10_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
