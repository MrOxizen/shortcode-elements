        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiADDSIC-margin', 13, $styledata, 1, 'Margin', 'Set Your Icon Margin Top Bottom and Left Right', 'ds', '.oxi-addons-social-' . $oxiid . '', 'padding');
                                        ?>
                                    </div>                                               
                                </div>                                            
                                <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_social_icons_style_18_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
