...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsFM-SI-DM-BR') . ''
            ...
            . ' ||||||'
            . ' ||||||||||||||||'
            . ' OxiAddonsFM-SI-I-HR |' . sanitize_text_field($_POST['OxiAddonsFM-SI-I-HR']) . '|'
            ...
            . '' . OxiAddonsADMHelpBorderSizeType('OxiAddonsFM-SI-BI-B') . ''
            . ' OxiAddonsFM-SI-BI-BC |' . sanitize_hex_color($_POST['OxiAddonsFM-SI-BI-BC']) . '|'
            . ' OxiAddonsFM-SI-BI-IP |' . sanitize_text_field($_POST['OxiAddonsFM-SI-BI-IP']) . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsFM-SI-BI-M') . ''


            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsFM-SI-R-FS') . ''
            . ' OxiAddonsFM-SI-R-C |' . sanitize_hex_color($_POST['OxiAddonsFM-SI-R-C']) . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsFM-SI-R-P') . ''
            ...
            . ' OxiAddonsFM-SI-RA-RP |' . sanitize_text_field($_POST['OxiAddonsFM-SI-RA-RP']) . '|'
            . '||#||'
            . ' ||#||';
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = ' ||#||OxiAddonsFM-SI-H ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsFM-SI-H']) . '||#|| '
            . ' OxiAddonsFM-SI-I ||#||' . OxiAddonsAdminUrlConvert($_POST['OxiAddonsFM-SI-I']) . '||#|| '
            ...
            . ' OxiAddonsFM-SI-R ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsFM-SI-R']) . '||#|| ';
        if ($oxilistid > 0) {
            $data = sanitize_text_field($data);
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number('OxiAddonsFM-SI-G-MW', $styledata[149], '1', 'Max Width', 'Set your Box Max Width', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . '', 'max-width');
                                        ...
                                        echo oxi_addons_adm_help_true_false('OxiAddonsFM-SI-G-Tab', $styledata[209], 'Same Tab', '', 'New Bab', '_blank', 'Link Opening Style', 'How to decorte Your Link Opening Style', 'true');
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number('OxiAddonsFM-SI-I-HR', $styledata[173], 1, 'Height Ratio', 'Set your Height based on Width ratio, EX. 100 means same size as width', 'false', '.oxi-addonsFM-SI-wrapper-' . $oxiid . ' .oxi-addonsFM-SI-image img', 'padding-bottom');
                                        echo oxi_addons_adm_help_border('OxiAddonsFM-SI-BI-B', $styledata[211], $styledata[212], 'Border', 'Set your Image Border Size and Type', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . ' .oxi-addonsFM-SI-image img', 'border');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsFM-SI-BI-BC', $styledata[215], '', 'Border Color', 'Set Your Image  Border Color', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . ' .oxi-addonsFM-SI-image img', 'border-color');
                                        echo oxi_addons_adm_help_Text_Align('OxiAddonsFM-SI-BI-IP', $styledata[217], 'Image Position', 'Set Your Image Position', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . ' .oxi-addonsFM-SI-image', 'text-align');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsFM-SI-DM-BR', 85, $styledata, '1', 'Border Radius', 'Set your Image Border Radius', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . ' .oxi-addonsFM-SI-image img', 'border-radius');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsFM-SI-BI-M', 219, $styledata, '1', 'Margin', 'Set your Image Border Radius', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . ' .oxi-addonsFM-SI-image img', 'margin');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsFM-SI-R-FS', $styledata[235], $styledata[236], $styledata[237], 1, 'Font Size', 'Set Your Rating Font Size', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . '  .oxi-addonsFM-SI-rating', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsFM-SI-R-C', $styledata[239], '', 'Color', 'Set Your Rating Color', 'false', '.oxi-addonsFM-SI-wrapper-' . $oxiid . '  .oxi-addonsFM-SI-rating', 'color');
                                        echo oxi_addons_adm_help_Text_Align('OxiAddonsFM-SI-RA-RP', $styledata[285], 'Rating Position', 'Set Your Rating Position', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . '  .oxi-addonsFM-SI-rating', 'text-align');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsFM-SI-R-P', 241, $styledata, '1', 'Padding', 'Set your Rating Padding', 'true', '.oxi-addonsFM-SI-wrapper-' . $oxiid . '  .oxi-addonsFM-SI-rating', 'padding');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_food_menu_style_6_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_model_image_upload('OxiAddonsFM-SI-I', $listitemdata[4], 'Banner Image', 'Set Your Food Menu Image', 'false');
                    echo oxi_addons_adm_help_number('OxiAddonsFM-SI-R', $listitemdata[12], '.1', 'Rating', 'Set Your Food Menu Rating', 'false');
