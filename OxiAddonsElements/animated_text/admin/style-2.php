                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number('adddonsSpeed', $styledata[15], 1, 'Delay', 'Set speed from start till the end');
                                        echo oxi_addons_adm_help_number('letterSpeed', $styledata[17], 1, 'Shuffle Speed', 'Set Your Letter Speed');
                                        ?>
                                    </div>
                                </div>
                            </div>
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo OxiAddonsADMHelpFontSettings('OxiAddons-F', 9, $styledata, 'true', '.oxi-addons-AT-' . $oxiid . '');
                                        ?>
                                    </div>
                                </div>
                            </div>
