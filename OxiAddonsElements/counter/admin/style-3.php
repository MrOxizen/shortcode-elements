...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-counter-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiADDC-G-M') . ''
            ...
            . '' . OxiAddonsBGImageSanitize('OxiADDC-G-bg') . ''
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiADDC-G-BS') . ''
            . '' . OxiAddonsADMHelpBorderSanitize('OxiADDC-G-B') . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiADDC-G-BR') . ''
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiADDC-G-P') . ''
            . '' . OxiAddonsADMBoxShadowSanitize('OxiADDC-B-Shadow') . ''
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpBGImage('OxiADDC-G-bg', $styledata, 193, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-row');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-G-BS', 197, $styledata, '1', 'Border Size', 'Set your body Border Width', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-row', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiADDC-G-B', 213, $styledata, 'false', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-row', 'border-style');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-G-BR', 217, $styledata, '1', 'Border Radius', 'Set Your body Border Radius', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-row', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-G-P', 233, $styledata, '1', 'Padding', 'Set Your body Border Radius', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-row', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-G-M', 21, $styledata, 1, 'Margin', 'Set Your Body Margin Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . '');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiADDC-B-Shadow', 249, $styledata, 'true', '.oxi-addonsOH-wrapper-' . $oxiid . ' .oxi-addonsOH-row');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiADDC-T-size', $styledata[37], $styledata[38], $styledata[39], 1, 'Font Size', 'Select Your Title Font Size', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-title', 'color');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_counter_style_3_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
