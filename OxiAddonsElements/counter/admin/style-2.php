...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-counter-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiADDC-icon-align |' . sanitize_text_field($_POST['OxiADDC-icon-align']) . '|'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMHelpItemPerRows('OxiADDC-Item', $styledata, 17, 'false', '.oxi-addons-admin-edit-list');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-padding', 21, $styledata, 1, 'Padding', 'Set Your Icon Margin Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . '', 'false');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiADDC-animation', 11, $styledata, '', '.oxi-addons-admin-edit-list');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_true_false('OxiADDC-icon-align', $styledata[15], 'Left', 'left', 'Right', 'right', 'Icon Position', 'Set your Icon position as left or Right');
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiADDC-I-width', $styledata[97], $styledata[98], $styledata[99], 1, 'Width', 'Select Your Font Size', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-icon', 'width');
                                            echo oxi_addons_adm_help_MiniColor('OxiADDC-I-color', $styledata[101], '', 'Color', 'Select Your Icon Color', '', '');
                                            echo OxiAddonsADMHelpBGImage('OxiADDC-I-bg', $styledata, 103);
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-I-border', 107, $styledata, 1, 'Border', 'Set Your Icon Margin Top Bottom and Left Right');
                                            echo OxiAddonsADMhelpBorder('OxiADDC-I-border', 123, $styledata);
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-I-radius', 127, $styledata, 1, 'Border Radius', 'Set Your Icon Margin Top Bottom and Left Right');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-I-margin', 143, $styledata, 1, 'Margin', 'Set Your Icon Padding Top Bottom and Left Right');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiADDC-D-width', $styledata[159], $styledata[160], $styledata[161], 1, 'Width', '', 'true', '');
                                            echo oxi_addons_adm_help_number_dtm('OxiADDC-D-border', $styledata[163], $styledata[164], $styledata[165], 1, 'Border', '', 'true', '');
                                            echo OxiAddonsADMhelpBorder('OxiADDC-D-border', 167, $styledata, 'false');
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-D-padding', 171, $styledata, 1, 'Padding', 'Set Your Icon Margin Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-body-data-divider', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiADDC-T-size', $styledata[37], $styledata[38], $styledata[39], 1, 'Font Size', 'Select Your Font Size', '', '');
                                            echo oxi_addons_adm_help_MiniColor('OxiADDC-T-color', $styledata[41], '', 'Color', 'Select Your Title Color', '', '');
                                            echo OxiAddonsADMHelpFontSettings('OxiADDC-T', 43, $styledata);
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-T-padding', 49, $styledata, 1, 'Padding', 'Set Your Title Padding Top Bottom and Left Right');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiADDC-N-size', $styledata[65], $styledata[66], $styledata[67], 1, 'Font Size', 'Select Your Font Size', '', '');
                                            echo oxi_addons_adm_help_MiniColor('OxiADDC-N-color', $styledata[69], '', 'Color', 'Select Your Number Color', '', '');
                                            echo OxiAddonsADMHelpFontSettings('OxiADDC-N', 71, $styledata);
                                            echo oxi_addons_adm_help_padding_margin('OxiADDC-N-padding', 77, $styledata, 1, 'Padding', 'Set Your Number Padding Top Bottom and Left Right');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_counter_style_2_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
