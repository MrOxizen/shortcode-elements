                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_image_upload('oxi-add-bg-img', $stylefiles[9], 'Image', 'Uplode your background Image', '');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-button-width', $styledata[125], $styledata[126], $styledata[127], 1, 'Width', 'Customize the button width with Responsive Size', 'fales', '.oxi-addons-align-' . $oxiid . ' .oxi-button-' . $oxiid . '', 'width');                                        
                                        echo OxiAddonsADMHelpFontSettings('oxi_addons-button-fs', 17, $styledata, 'true', '.oxi-addons-align-' . $oxiid . ' .oxi-button-' . $oxiid . '');
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-padding', 23, $styledata, 1, 'Padding', 'Customize button padding either Easy or Advance mode', '', '.oxi-addons-align-' . $oxiid . ' .oxi-button-' . $oxiid . '', 'padding');
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-margin', 39, $styledata, 1, 'Margin', 'Customize button margin either Easy or Advance mode', 'true', '.oxi-addons-align-' . $oxiid . ' .oxi-addons-button-body', 'margin');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddInfo-button-hover-shadow', 65, $styledata, 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover');
                                            ?>
                                        </div>
                                    </div>
                            </div>
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-color', $styledata[71], '', 'Color', 'Customize the Button active color', '', '.oxi-addons-align-' . $oxiid . ' .oxi-addons-button-align', 'color');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAdd-button-BG-border', 75, $styledata, 1, 'Border', 'set Info box border', '','.oxi-addons-align-' . $oxiid . ' .oxi-addons-button-align', 'border-width');
                                        echo OxiAddonsADMhelpBorder('OxiAdd-button-BG-border-CS', 91, $styledata, '', '.oxi-addons-align-' . $oxiid . ' .oxi-addons-button-align');
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-color', $styledata[97], '', 'Color', 'Customize the Button hover view color', '', '.oxi-addons-align-' . $oxiid . ' .oxi-addons-button-align:hover', 'color');
                                        ...
                                        echo oxi_addons_adm_help_number('oxi-addons-button-hover-border-radius', $styledata[121], '1', 'Border Radius', 'Set border radius. 0 value for angular border, 50 for rounded', 'true', '.oxi-addons-align-' . $oxiid . ' .oxi-addons-button-align', 'border-radius');
                                        ?>
                                    </div>
