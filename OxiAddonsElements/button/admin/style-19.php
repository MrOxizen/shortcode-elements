...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_single_size('oxi_addons-button-hover-font-size') . ''
                ...
                . '' . OxiAddonsADMHelpFontSettingsSanitize('oxi_addons-button-hover-fs') . ''
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_textbox('oxi_addons-button-hover-text', $stylefiles[9], 'Hover Text', 'Add Your Icon Class from Font Awesome Library', 'true');
                                        ...
                                        <div class=" form-group row">
                                            ...
                                            <div class="col-sm-6 addons-dtm-laptop-lock">
                                                <select class="form-control" id="oxi-addons-Button-hover-style" name="oxi-addons-Button-hover-style">
                                                    <option value="1" <?php selected( $styledata[75], 1 ); ?>>Bottom to Top </option>
                                                    <option value="2" <?php selected( $styledata[75], 2 ); ?>>Top to Bottom</option>
                                                    <option value="3" <?php selected( $styledata[75], 3 ); ?>>Left to Right</option>
                                                    <option value="4" <?php selected( $styledata[75], 4 ); ?>>Right to Left</option>
                                                    <option value="5" <?php selected( $styledata[75], 5 ); ?>>Center Top - Bottom</option>
                                                    <option value="6" <?php selected( $styledata[75], 6 ); ?>>Center Left - Right</option>
                                                </select>
                                            </div>
                                        </div>
                                        <?php
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-button-font-size', $styledata[31], $styledata[32], $styledata[33], 1, 'Font Size', 'Customize the button font size, based on Pixels', '', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-txt','font-size');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-color', $styledata[35], '', 'Color', 'Customize the Button color', '', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-txt', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-BG-color', $styledata[37], 'rgba', 'Background Color', 'Customize the Button Background view color', 'fales', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-txt', 'color');
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-button-hover-font-size', $styledata[61], $styledata[62], $styledata[63], 1, 'Font Size', 'Customize the button font size, based on Pixels', '', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-overlay-txt','font-size');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-color', $styledata[65], '', 'Color', 'Customize the Button active color', '', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-overlay-txt', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-BG-color', $styledata[67], 'rgba', 'Background Color', 'Customize the Button Background view color', 'fales', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-overlay', 'color');
                                        echo OxiAddonsADMHelpFontSettings('oxi_addons-button-hover-fs', 69, $styledata, 'true', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-overlay-txt');
                                        ?>
                                    </div>
                                </div>   
