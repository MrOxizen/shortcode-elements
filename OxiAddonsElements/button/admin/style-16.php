                            ...
                            <div class="oxi-addons-col-6">
                                        ...
                                        <div class=" form-group row">
                                            ...
                                            <div class="col-sm-6 addons-dtm-laptop-lock">
                                                <select class="form-control" id="oxi-addons-icon-position" name="oxi-addons-icon-position">
                                                    <option value="1" <?php selected( $styledata[191], 1 ); ?>>Left</option>
                                                    <option value="2" <?php selected( $styledata[191], 2 ); ?>>Right</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-padding', 11, $styledata, 1, 'Padding', 'Customize button padding either Easy or Advance mode', 'true', '.Oxi-addons-btn-'.$oxiid.' .Oxi-btn-align', 'padding');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-bg-color', $styledata[109], 'rgba', 'Background Color', 'Customize the Button Active Background color, either in gradient or solid color mode', 'fales', '.Oxi-addons-btn-'.$oxiid.' .oxi-btn-icon', 'background');
