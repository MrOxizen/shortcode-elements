...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . 'oxi-addons-hover-position|' . sanitize_text_field($_POST['oxi-addons-hover-position']) . '|'
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        <div class=" form-group row">
                                            <label for="oxi-addons-hover-position" class="col-sm-6 control-label" oxi-addons-tooltip="Set your Icon Position">Hover Position</label>
                                            <div class="col-sm-6 addons-dtm-laptop-lock">
                                                <select class="form-control" id="oxi-addons-hover-position" name="oxi-addons-hover-position">
                                        ...
                                        <?php
                                            echo OxiAddonsADMHelpNoJquery(
                                                array(
                                                    array('oxi-addons-hover-position', 'Hover position'),
                                                )
                                            );
                                        ?>
                                    </div>                                               
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-bg-color', $styledata[115], 'rgba', 'Background Color', 'Customize the Button Hover Background color, either in gradient or solid color mode', 'true', '.oxi-button-' . $oxiid . '::before', 'background');
