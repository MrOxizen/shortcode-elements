...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi_addons-button-link-opening |' . sanitize_text_field($_POST['oxi_addons-button-link-opening']) . '|'
                ...
                . ' oxi-addons-button-hover-border||' . sanitize_text_field($_POST['oxi-addons-button-hover-border-type']) . '|' . sanitize_hex_color($_POST['oxi-addons-button-hover-border-color']) . '|'
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-icon-color', $styledata[119], '', 'Color', 'Select Your Icon Color', '', ' .oxi-addons-container .oxi-button-' . $oxiid . ' .oxi-icons', 'color');
                                        ...
                                        OxiAddonsTransformProperty('oxi_addons-button-icon-transform', $styledata[125], 'Viewing Animaton', 'Select Viewing Animation of Icon', '', '.oxi-button-' . $oxiid . '')
                                        ?>
                                    </div>                                                
                                </div>
                            </div>
