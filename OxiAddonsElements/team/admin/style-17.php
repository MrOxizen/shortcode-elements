...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_single_size('OxiAddons-border-width') . ''
                . ' OxiAddons-border-top|' . sanitize_hex_color($_POST['OxiAddons-border-top']) . '|'
                . ' OxiAddons-border-bottom|' . sanitize_hex_color($_POST['OxiAddons-border-bottom']) . '|'
                . '' . oxi_addons_adm_help_single_size('OxiAddons-border-padding') . ''
                . '||'
                            ...
                            <div class="oxi-addons-tabs-content-tabs"  id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-border-width', $styledata[51], $styledata[52], $styledata[53], 1, 'Border Size', 'Select Your Image Border Width', 'true');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-border-top', $styledata[55], 'hex', 'Border Top Color', 'Select Your Border Top & Left Color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-border-bottom', $styledata[57], 'hex', ' Border Bottom Color', 'Select Your Border Right & Bottom Color');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-border-padding', $styledata[59], $styledata[60], $styledata[61], 1, 'Padding', 'Set Your Team Image Border Padding', 'true');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_17_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
