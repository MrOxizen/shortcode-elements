...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddons-namebg-C|' . sanitize_text_field($_POST['OxiAddons-namebg-C']) . '|'
            . ' OxiAddons-icon-bg|' . sanitize_text_field($_POST['OxiAddons-icon-bg']) . '|'
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-namebg-C', $styledata[7], 'rgba', 'Background Color', 'Select Your Content Background Color');
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-icon-bg', $styledata[9], 'rgba', 'Background Color', 'Select Your Icon Background Color');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_7_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
