...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . 'OxiAddons-name-HC|' . sanitize_hex_color($_POST['OxiAddons-name-HC']) . '|'
            . 'OxiAddons-dig-HC|' . sanitize_text_field($_POST['OxiAddons-dig-HC']) . '|'
            . '||||||||||||||||'
            . '||||'
            . '' . oxi_addons_adm_help_single_size('OxiAddons-social-fs') . ''
            . 'OxiAddons-iconbox-bg|' . sanitize_text_field($_POST['OxiAddons-iconbox-bg']) . '|'
            . '||||'
            ...
            . ' OxiAddons-des-BGC|' . sanitize_text_field($_POST['OxiAddons-des-BGC']) . '|'
            . '||#||'
            . $socialindata;
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-iconbox-bg', $styledata[179], 'rgba', 'Hover Background Color', 'Select Your Name & Designation Background Color');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-name-HC', $styledata[151], 'hex', 'Hover Color', 'Select Your Heading Hover Color');
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-dig-HC', $styledata[151], 'hex', 'Hover Color', 'Select Your Designation Hover Color');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-des-BGC', $styledata[303], 'rgba', 'Background Color', 'Select Your Description Background Color');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_19_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
