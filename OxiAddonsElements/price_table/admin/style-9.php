...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsPriceTable-I-C |' . sanitize_hex_color($_POST['OxiAddonsPriceTable-I-C']) . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsPriceTable-I-P') . ''
            . '' . OxiAddonsBGImageSanitize('OxiAddonsPriceTable-Image') . ''
            ...
            . ' OxiAddonsPriceTable-Image-max-height |' . sanitize_text_field($_POST['OxiAddonsPriceTable-Image-max-height']) . '|'
            . '||#||'
            . ' OxiAddonsPriceTable-P-TB ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsPriceTable-P-TB']) . '||#|| '
            . ' OxiAddonsPriceTable-I-TA ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonsPriceTable-I-TA']) . '||#|| '
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-I-TA', $stylefiles[4], 'FontAwesome Icon', 'Write Your FontAwesome Icon Class Name', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons');
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-I-FS', $styledata[106], $styledata[107], $styledata[108], '1', 'Icon Size', 'Set Your Location Icon', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-I-C', $styledata[110], '', 'Icon Color', 'Set Your Icon Font Color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons', 'color');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpBGImage('OxiAddonsPriceTable-Image', $styledata, 128, 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-heading-details', 'background');
                                        echo oxi_addons_adm_help_number('OxiAddonsPriceTable-Image-max-height', $styledata[312], '1', 'Max height', 'Set Price Tabel Image Max Height example: 50%', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-heading-details:before', 'font-size');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_price_table_style_9_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
