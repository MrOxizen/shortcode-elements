        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-wrapper">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        <div class="oxi-head">
                                            Price Box Main Title Setting
                                        </div>
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-T-TA', $stylefiles[12], 'Price', 'Write Your Price Table  title', 'false','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title'); 
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-T-FS', $styledata[289], $styledata[290], $styledata[291], '2', 'Font Size', 'Set  Price Table  Title Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-T-C', $styledata[293], '', 'Color', 'Set Price Title Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-T-BG', $styledata[295], 'rgba', 'Background Color', 'Set   Price Table  Background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title', 'background');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsPriceTable-T-F', 297, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-T-P', 303, $styledata, 1, 'Padding', 'Set  Price Table  Title Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title', 'padding');
                                             ?>
                                        </div>
                                        <div class="oxi-head">
                                          Title Box Shadow
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-Pbox-BG', $styledata[325], 'rgba', 'Background Color', 'Set Price Table  background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'background');
                                             echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Pbox-P', 327, $styledata, 1, 'Padding', 'Set Price Table  Border Radius', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title','border-radius');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                          Price boxes  Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsPriceTable-Pbox-BS', 343, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box');
                                            ?>
                                        </div>
                                    </div> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-P-FS', $styledata[349], $styledata[350], $styledata[351], '1', 'Font Size', 'Set Price Table Price Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price  span', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-P-C', $styledata[359], '', 'Color', 'Set Price Table Price Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price  span', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsPriceTable-P-F', 353, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price  span');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-P-P', 361, $styledata, 1, 'Padding', 'Set Price Table Price Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price  span', 'padding');
                                           ?>
                                        </div>
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                          echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-P-Second-FS', $styledata[377], $styledata[378], $styledata[379], '1', 'Font Size', 'Set Price Table Secondary Text Font Size. You Must Write inside html span tag in your price text', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'font-size');
                                          echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-P-Second-C', $styledata[381], '', 'Secondary Color', 'Set Price Table Secondary Text color . You Must Write inside html span tag in your price text', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'color');
                                        ?>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_true_false('OxiAddonsPriceTable-G-button-top-bottom', $styledata[383], 'Top', 'top', 'Bottom', 'bottom', 'Button Top Bottom', 'Set Your Button Top Or Bottom', 'false');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_price_table_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
