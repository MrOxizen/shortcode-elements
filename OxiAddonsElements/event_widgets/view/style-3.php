...
function oxi_event_widgets_style_3_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    ...
    echo'<div class="' . OxiAddonsItemRows($styledata, 276) . ' ' . OxiAddonsAdminDefine($user) . '">
