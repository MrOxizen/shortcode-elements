...
function oxi_image_effects_style_6_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-bounce-effects', 'image_effects', 'css', 'image-style-bounce-effects');
