...
function oxi_image_effects_style_20_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-pixel-effects', 'image_effects', 'css', 'style-pixel-effects');
}
