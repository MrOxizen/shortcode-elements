...
function oxi_image_effects_style_17_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-modal-effects', 'image_effects', 'css', 'style-style-modal-effects');
}
