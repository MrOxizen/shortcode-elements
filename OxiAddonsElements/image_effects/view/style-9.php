...
function oxi_image_effects_style_9_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-dive-effects', 'image_effects', 'css', 'image-style-dive-effects');
