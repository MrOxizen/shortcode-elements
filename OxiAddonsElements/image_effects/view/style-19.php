...
function oxi_image_effects_style_19_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-pivot-effects', 'image_effects', 'css', 'style-pivot-effects');
}
