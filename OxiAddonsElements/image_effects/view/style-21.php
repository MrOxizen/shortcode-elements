...
function oxi_image_effects_style_21_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-push-effects', 'image_effects', 'css', 'style-push-effects');
}
