...
function oxi_image_effects_style_12_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-flash-effects', 'image_effects', 'css', 'image-style-flash-effects');
}
