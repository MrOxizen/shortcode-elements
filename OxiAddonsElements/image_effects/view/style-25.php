...
function oxi_image_effects_style_25_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-shutter-effects', 'image_effects', 'css', 'style-shutter-effects');
}
