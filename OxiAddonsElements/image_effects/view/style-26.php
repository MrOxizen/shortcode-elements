...
function oxi_image_effects_style_26_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-slide-effects', 'image_effects', 'css', 'style-slide-effects');
}
