...
function oxi_image_effects_style_3_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    $stylefiles = explode('||#||', $styledata['css']);
    $styledata = explode('|', $stylefiles[0]);
    echo oxi_addons_elements_stylejs('css/style-blur-effects', 'image_effects', 'css', 'image-style-blur-effects');
    ...
    foreach ($listdata as $value) {
        ...
        echo '<div class="ihewc-hover-padding-' . $oxiid . '" ' . OxiAddonsAnimation($styledata, 51) . '>
                ' . $valueurl1st . '
                <div class="ihewc-hover ihewc-hover-' . $oxiid . ' ihewc-blur">
