...
function oxi_image_effects_style_24_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-shift-effects', 'image_effects', 'css', 'style-shift-effects');
}
