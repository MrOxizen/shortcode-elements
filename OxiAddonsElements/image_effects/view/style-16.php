...
function oxi_image_effects_style_16_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-lightspeed-effects', 'image_effects', 'css', 'style-lightspeed-effects');
}
