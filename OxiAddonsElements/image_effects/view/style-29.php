...
function oxi_image_effects_style_29_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-strip-effects', 'image_effects', 'css', 'style-strip-effects');
}
