...
function oxi_image_effects_style_18_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    echo oxi_addons_elements_stylejs('css/style-parallax-effects', 'image_effects', 'css', 'style-parallax-effects');
}
