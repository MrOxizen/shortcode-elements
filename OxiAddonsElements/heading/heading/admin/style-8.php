...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-heading-nonce')) {
        ...
        $data = '||'
                ...
                . '' . oxi_addons_adm_help_single_size('oxi_addons-watermark-font-size') . ''
                . '||'
                . 'oxi_addons-watermark-color |' . sanitize_text_field($_POST['oxi_addons-watermark-color']) . '|'
                . '' . OxiAddonsADMHelpFontSettingsSanitize('oxi-addons-watermark-font-S') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('oxi-addons-watermark-padding') . ''
                . '||||||||||||||'
                . '||#||'.'||#||'
                ...
                . 'xi_addons-watermark-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['oxi_addons-watermark-text']) . '||#||'
                . '|';
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php 
                                            echo oxi_addons_adm_help_textarea('oxi_addons-watermark-text', $stylefiles[7],'fales','.oxi-addons-main-heading-body' . $oxiid . ' .oxi-addons-heading-WM'); 
                                            ?>
                                        </div>
                                            <div class="oxi-head">
                                                Watermark Settings
                                            ...
                                            <div class="oxi-addons-content-div-body">
                                                <?php
                                                echo oxi_addons_adm_help_number_dtm('oxi_addons-watermark-font-size', $styledata[101], $styledata[102], $styledata[103], 1, 'Font Size', 'Your Heading Font Size', 'false', '.oxi-addons-main-heading-body' . $oxiid . ' .oxi-addons-heading-WM', 'font-size');
                                                echo oxi_addons_adm_help_MiniColor('oxi_addons-watermark-color', $styledata[107], 'rgba', 'Color', 'Select Your Heading Color', 'false', '.oxi-addons-main-heading-body' . $oxiid . ' .oxi-addons-heading-WM', 'color');
                                                echo OxiAddonsADMHelpFontSettings('oxi-addons-watermark-font-S', 109, $styledata, 'true','.oxi-addons-main-heading-body' . $oxiid . ' .oxi-addons-heading-WM');
                                                echo oxi_addons_adm_help_padding_margin('oxi-addons-watermark-padding', 115, $styledata, 1, 'Margin', 'Set heading Padding', '','.oxi-addons-main-heading-body' . $oxiid . ' .oxi-addons-heading-WM','margin');
                                               ?>
                                            </div>
                                    </div>
                                </div>
