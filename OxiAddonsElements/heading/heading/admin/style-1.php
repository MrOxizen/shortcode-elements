                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Text_Align('oxi_addons-heading-text-align', $styledata[1], 'Text Align', 'Confirm Your Heading Position', 'false', '.oxi-addons-container-' . $oxiid . '', 'text-align');
                                            echo oxi_addons_adm_help_padding_margin('oxi-addons-heading-padding', 3, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', 'oxi-addons-container oxi-addons-container-' . $oxiid . '', 'padding');
                                            echo oxi_addons_adm_help_number_double_dtm('oxi_addons-heading-margin-top', $styledata[33], $styledata[34], $styledata[35], 'oxi_addons-heading-margin-bottom', $styledata[37], $styledata[38], $styledata[39], '1', 'Margin Top Bottom', 'Set Your Heading Margin Top Bottom', 'true', '.oxi-addons-container-' . $oxiid . ' .oxi-addons-heading-' . $oxiid . '', 'margin');
                                            ?>
                                        </div>
                                    </div> 
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('oxi_addons-heading-color', $styledata[25], '', 'Color', 'Select Your Heading Color', 'false', '.oxi-addons-container-' . $oxiid . ' .oxi-addons-heading-' . $oxiid . '', 'color');
                                            echo oxi_addons_adm_help_Font_Family('oxi_addons-heading-family', $styledata[27], 'Font Family', 'Select Your Font Family', 'true', '.oxi-addons-container-' . $oxiid . ' .oxi-addons-heading-' . $oxiid . '');
                                            echo oxi_addons_adm_help_Font_Weight('oxi_addons-heading-font-weight', $styledata[29], 'Font Weight', 'Select Your Heading Font Weight', 'true', '.oxi-addons-container-' . $oxiid . ' .oxi-addons-heading-' . $oxiid . '');
