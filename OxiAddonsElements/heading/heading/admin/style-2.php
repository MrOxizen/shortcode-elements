...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-heading-nonce')) {
        ...
        $data = 'oxi_addons-heading-text ||#||' . OxiAddonsADMHelpTextSenitize(htmlspecialchars($_POST['oxi_addons-heading-text'])) . '||#||'
                . 'heading-image ||#||' . sanitize_textarea_field($_POST['heading-image']) . '||#||'
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Text_Align('oxi_addons-heading-text-align', $styledata[1], 'Text Align', 'Confirm Your Heading Position', '.oxi-addons-container-' . $oxiid . '', 'true', '.oxi-addons-container-' . $oxiid . '', 'text-align');
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div oxi-addons-content-div-textarea">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_body_image_upload('heading-image', $headingimage, 'Heading Image', 'Set Your Heading background Image');
                                            ?>
                                        </div>
                                        <div class="oxi-info">
                                            Set Your Heading background Image 
                                        </div>                                                
                                    </div>
                                    <div class="oxi-addons-content-div oxi-addons-content-div-textarea">                                               
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textarea('oxi_addons-heading-text', $data,'fales','.oxi-addons-heading-' . $oxiid . '');
                                            ?>
                                        </div>
                                        <div class="oxi-info">
