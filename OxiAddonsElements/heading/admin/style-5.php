...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-heading-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('oxi-addons-heading-margin') . ''
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('oxi-addons-heading-border-height') . '' 
                . '||||' 
                . '' . oxi_addons_adm_help_number_dtm_senitize('oxi-addons-main-border-width') . '' 
                . ' oxi_addons-heading-border-color|' .sanitize_text_field($_POST['oxi_addons-heading-border-color']) . '|'
                . '||||||||||||||'
                . '||#||'.'||#||'
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('oxi-addons-main-border-width', $styledata[95],$styledata[96],$styledata[97], 1, 'Border Width', 'set your border  width', 'true','.oxi-addons-Heading-body-'.$oxiid.'','border-bottom-width') ;
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            <div class="oxi-addons-content-div-body">
                                                <?php
                                                echo oxi_addons_adm_help_number_dtm('oxi_addons-heading-font-size', $styledata[3], $styledata[4], $styledata[5], 1, 'Font Size', 'Your Heading Font Size', 'false', '.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title', 'font-size');
                                                echo oxi_addons_adm_help_MiniColor('oxi_addons-heading-color', $styledata[7], '', 'Text Color', 'Select Your Heading Color', 'false', '.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title', 'color');
                                                ...
                                                echo oxi_addons_adm_help_MiniColor('oxi_addons-heading-border-color', $styledata[99], 'rgba', 'Heading Border Color', 'Select Your Heading Background Color', 'true', '.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title:after', 'background');
                                                echo oxi_addons_adm_help_number_dtm('oxi-addons-heading-border-height', $styledata[87],$styledata[88],$styledata[89], 1, 'Border Width', 'set your border  width', 'true','.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title:after','height') ;
                                                echo oxi_addons_adm_help_padding_margin('oxi-addons-heading-margin', 23, $styledata, 1, 'Border Margin', 'Set heading border margin', 'true','.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title:after','margin');
                                                echo oxi_addons_adm_help_MiniColor('oxi_addons-heading-BG-color', $styledata[11], 'rgba', 'Background Color', 'Select Your Heading Background Color', 'true', '.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title', 'background');
                                                echo OxiAddonsADMHelpFontSettings('oxi-addons-heading-font-S', 13, $styledata, 'true','.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title');
                                                echo oxi_addons_adm_help_padding_margin('oxi-addons-heading-padding', 39, $styledata, 1, 'Padding', 'Set heading Padding', 'true','.oxi-addons-Heading-body-'.$oxiid.' .oxi-addons-Heading-title','padding');
                                                ?>
                                            </div>
                                    </div>
                                </div>
