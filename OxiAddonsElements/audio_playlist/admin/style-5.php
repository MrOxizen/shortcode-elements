...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudioPlaylist-playlist-FS') . ''
            . ' OxiAddonsAudioPlaylist-playlist-C |' . sanitize_hex_color($_POST['OxiAddonsAudioPlaylist-playlist-C']) . '|'
            . '||#||'
            ...
            . ' OxiAddonsAudioPlaylist-playlist-I ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonsAudioPlaylist-playlist-I']) . '||#|| '
            . ' ||#||';
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-wrapper">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        <div class="oxi-head">
                                            Playlist Show Or Hide Icon
                                        </div>
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsAudioPlaylist-playlist-I', $stylefiles[24], 'playlist Icon', 'Set FontAwesome Class for playlist icon', 'false');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudioPlaylist-playlist-FS', $styledata[824], $styledata[825], $styledata[826], '1', 'Font Size', 'Set Audio playlist Icon Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-show-playlist > .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsAudioPlaylist-playlist-C', $styledata[828], '', 'Color', 'Set Audio Playlist Icon color', 'false', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-show-playlist > .oxi-icons', 'color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsAudioPlaylist-playlist-item-color', $styledata[688], '', 'Color', 'Set Audio Playlist Item text Hover color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' div.jp-type-playlist div.jp-playlist li.jp-playlist-current a.jp-playlist-current', 'color');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_audio_playlist_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
