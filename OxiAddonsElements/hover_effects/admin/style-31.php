    ...
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-effects-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAdmin-underline-margin') . ''
                 . ' OxiAdmin-title-H-color |' . sanitize_text_field($_POST['OxiAdmin-title-H-color']) . '|'
                . '||#||  ||#||'
                . '|';
        ...
        <div class="oxi-addons-row">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                           ...
                                           echo oxi_addons_adm_help_MiniColor('OxiAdmin-title-color', $styledata[221], '', 'Color', 'Select Your Title Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info h3.oxi-button-heading', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAdmin-title-H-color', $styledata[303], '', 'Hover Color', 'Select Your Title Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info h3.oxi-button-heading', 'color');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_hover_effects_style_31_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
