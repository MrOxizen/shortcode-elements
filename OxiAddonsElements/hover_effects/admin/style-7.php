        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $effectsalignments = $styledata[303];
                                            ?>
                                             ...
                                             <div class="form-group row form-group-sm">
                                                ...
                                                <div class="col-sm-6 nopadding">
                                                    <select class="form-control" id="image-alignments" name="effects-alignments">
                                                        <option value="oxi-hover-left-to-right" <?php
                                                        if ($effectsalignments == 'oxi-hover-left-to-right') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Left to Right</option>
                                                        <option value="oxi-hover-right-to-left" <?php
                                                        if ($effectsalignments == 'oxi-hover-right-to-left') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Right to Left</option>
                                                        <option value="oxi-hover-bottom-to-top" <?php
                                                        if ($effectsalignments == 'oxi-hover-bottom-to-top') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Bottom to Top </option>
                                                        <option value="oxi-hover-top-to-bottom" <?php
                                                        if ($effectsalignments == 'oxi-hover-top-to-bottom') {
                                                            echo 'selected';
                                                        }
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-padding', 13, $styledata, 1, 'Padding', 'Set Your Image Padding Top Bottom and Left Right', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info', 'padding');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-margin', 29, $styledata, 1, 'Margin', 'Set Your Image Margin Top Bottom and Left Right', 'true', '.oxi-hover-effects-' . $oxiid . '', 'padding');
                                            ?>
                                        </div>                                               
                                    </div>  
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number('OxiAdmin-width', $styledata[63], 1, 'Image Width', 'Set Image Width, While it also responsive based on height and width', 'false', 'oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects-map-' . $oxiid . '', 'width', '');
                                            ...
                                            echo OxiAddonsADMHelpBGImage('OxiAdmin-I-bg', $styledata, 67, 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info', 'background');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiAdmin-animation', 45, $styledata, 'true', '.oxi-hover-effects-' . $oxiid . '');
                                            ?>  
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAdmin-box-shadow', 49, $styledata, 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover  Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAdmin-hover-box-shadow', 56, $styledata, 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects:hover');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAdmin-title-size', $styledata[217], $styledata[218], $styledata[219], 1, 'Font Size', 'Select Your Button Text Size', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info h3.oxi-button-heading', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAdmin-title-color', $styledata[221], '', 'Color', 'Select Your Button Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info h3.oxi-button-heading', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-title-margin', 229, $styledata, 1, 'Margin', 'Set Your Button Margin ', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-button-info h3.oxi-button-heading', 'padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Title Underline
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAdmin-button-size', $styledata[103], $styledata[104], $styledata[105], 1, 'Font Size', 'Select Your Button Text Size', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAdmin-button-color', $styledata[111], '', 'Color', 'Select Your Button Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAdmin-button-bgcolor', $styledata[113], 'rgba', 'Background Color', 'Select Your Button Background Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'background');
                                            echo OxiAddonsADMHelpFontSettings('OxiAdmin-button', 207, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-title');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-button-border', 115, $styledata, 1, 'Border', 'Set Your Button Border width', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAdmin-button-border', 131, $styledata, 'true', '.ihewc-hover-' . $oxiid . '  .img-btn.ihewc-button', 'border');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-button-radius', 135, $styledata, 1, 'Border Radius', 'Set Your Content Boxes Border Radius ', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-button-padding', 191, $styledata, 1, 'Padding', 'Set Your Button Padding ', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'paddings');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-button-margin', 151, $styledata, 1, 'Margin', 'Set Your Button Margin ', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a', 'margin');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAdmin-button-hover-color', $styledata[167], '', ' Color', 'Select Your Button Hover Text Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a:hover', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAdmin-button-hover-bgcolor', $styledata[169], 'rgba', 'Background Color', 'Select Your Button Hover Background Color', 'false', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a:hover', 'background');
                                            echo OxiAddonsADMhelpBorder('OxiAdmin-hover-button-border', 171, $styledata, 'true', '.ihewc-hover-' . $oxiid . ' a:hover');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdmin-hover-button-radius', 175, $styledata, 1, 'Border Radius', 'Set Your Button Border Radius Top Bottom and Left Right', 'true', '.oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects a:hover', 'border-radius');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_hover_effects_style_7_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
