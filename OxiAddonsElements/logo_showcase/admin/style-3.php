...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . ' OxiAddonsLogoShowcase-scale |' . sanitize_text_field($_POST['OxiAddonsLogoShowcase-scale']) . '|'
                . ' OxiAddonsLogoShowcase-scale-duration |' . sanitize_text_field($_POST['OxiAddonsLogoShowcase-scale-duration']) . '|'
                . ' OxiAddonsLogoShowcase-hover-scale |' . sanitize_text_field($_POST['OxiAddonsLogoShowcase-hover-scale']) . '|'
                . ' OxiAddlogoshowcase-bgcolor|' . sanitize_text_field($_POST['OxiAddlogoshowcase-bgcolor']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddlogoshowcase-border') . ''
                . '' . OxiAddonsADMHelpBorderSanitize('OxiAddlogoshowcase-border') . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddlogoshowcase-radius') . ''
                . '|';
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddlogoshowcase-bgcolor', $styledata[70], 'rgba', 'Background', 'Select Your Image Background', '', '', 'background');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddlogoshowcase-border', 72, $styledata, 1, 'Border', 'Set Your Single Image Border Top Bottom and Left Right', 'true', '', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddlogoshowcase-border', 88, $styledata, 'true', '');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddlogoshowcase-radius', 92, $styledata, 1, 'Border Radius', 'Set Your Image Border Radius Top Bottom and Left Right', 'true', '', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsLogoShowcase-margin', 31, $styledata, 1, 'Margin', 'Set Yout Logo showcase Margin', 'true', '', 'padding');
                                            ?>
                                        </div>                                               
                                    </div>                                            
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsLogoShowcase-Height', $styledata[11], $styledata[12], $styledata[13], 1, 'Height', 'Select Your Logo Height ', 'false');
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddonsLogoShowcase-scale', $styledata[64], 0.01, 'Scale', 'Set You Logo Image Scale', 'false', '', '');
                                            echo oxi_addons_adm_help_number('OxiAddonsLogoShowcase-scale-duration', $styledata[66], 0.1, 'Scale Duration', 'Set You Logo Image Scale Duration', 'false', '', '');
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsLogoShowcase-scale', 'Scale'),
                                                array('OxiAddonsLogoShowcase-Height','Height'),
                                                array('OxiAddonsLogoShowcase-scale-duration', 'Scale Duration'),
                                            );
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddonsLogoShowcase-hover-scale', $styledata[68], 0.01, ' Hover Scale', 'Set You Logo Image Hover Scale', 'false', '', '');
                                            $NOJS = array(
                                                array('OxiAddonsLogoShowcase-hover-grayscale', 'Hover Grayscale'),
                                                array('OxiAddonsLogoShowcase-hover-scale', 'Hover Scale'),
                                                array('OxiAddonsLogoShowcase-Height','Height'),
                                            );
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_logo_showcase_style_3_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
