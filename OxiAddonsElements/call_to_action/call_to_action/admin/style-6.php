...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . 'oxi-call-button-text-align |' . sanitize_text_field($_POST['oxi-call-button-text-align']) . '|'
            . oxi_addons_adm_help_padding_margin_senitize('oxi-call-full-margin')
            . oxi_addons_adm_help_single_size('oxi-call-content-part-max-width')
            . OxiAddonsADMBoxShadowSanitize('oxi-call-box-shadow')
            . '||||'
            . '||||'
            . '||'
            . oxi_addons_adm_help_padding_margin_senitize('oxi-call-full-border-radius')
            . '||'
            . oxi_addons_adm_help_single_size('oxi-call-action-icon-font-size')
            . 'oxi-call-action-icon-color |' . sanitize_hex_color($_POST['oxi-call-action-icon-color']) . '|'
            . oxi_addons_adm_help_padding_margin_senitize('oxi-call-action-icon-padding')
            . oxi_addons_adm_help_padding_margin_senitize('oxi-call-action-icon-margin')
            . '||#||'
            ...
            . 'oxi-call-action-icon ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['oxi-call-action-icon']) . '||#||'
    ;
                        ...
                        <div class="oxi-addons-tabs-content-tabs" >
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpBGImage('oxi-call-action-bg-image', $styledata, 121, 'false', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-full-content', 'background');
                                        echo oxi_addons_adm_help_number_dtm('oxi-call-content-part-max-width', $styledata[247], $styledata[248], $styledata[249], 1, 'Max-Width', 'Set your Content Part Width', 'true', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-full-content', 'max-width');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('oxi-call-full-margin', 231, $styledata, 1, 'Margin', 'Set Your Body Margin', 'true', '.oxi-addons-call-to-action-' . $oxiid . '', 'padding');
                                        echo oxi_addons_adm_help_padding_margin('oxi-call-full-border-radius', 267, $styledata, 1, 'Border Radius', 'Set Border Radius of Body', 'true', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-full-content', 'border-radius');
                                        echo oxi_addons_adm_help_true_false('oxi-call-button-text-align', $styledata[229], 'Left', 'left', 'Right', 'right', 'Position Reverse', 'Set the Position Left or Right', 'true');
                                        ?>
                                    </div>
                                    <div class="oxi-head">
                                        Box Shadow
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMhelpBoxShadow('oxi-call-box-shadow', 251, $styledata, 'true', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-full-content');
                                        ?>
                                    </div>
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi-call-button-H-color', $styledata[19], '', 'Color', 'Set Your ButtonHover  Color', 'false', '.oxi-addons-call-to-action-' . $oxiid . ' .oxi-addons-call-to-action-button-section a.oxi-addons-call-to-action-button:hover', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi-call-button-H-bg-color', $styledata[21], 'rgba', 'Background', 'Set Your Button Hover Background Color', 'false', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-button-section a.oxi-addons-call-to-action-button:hover', 'background');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('oxi-call-button-H-border-radius', 101, $styledata, 1, 'Border Radius', 'Set Border Radius for your Button Hover ', 'true', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-button-section a.oxi-addons-call-to-action-button:hover', 'border-radius');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('oxi-call-action-icon', $stylefiles[10], 'Icon Class ', 'Set Your Icon Class', 'false');
                                        echo oxi_addons_adm_help_number_dtm('oxi-call-action-icon-font-size', $styledata[285], $styledata[286], $styledata[287], 1, 'Font Size', 'Set your Icon Font Size', 'false', '.oxi-addons-call-to-action-icon-section i', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('oxi-call-action-icon-color', $styledata[289], '', 'Color', 'Set Your Icon Color', 'false', '.oxi-addons-call-to-action-icon-section i', 'color');
                                        echo oxi_addons_adm_help_padding_margin('oxi-call-action-icon-padding', 291, $styledata, 1, 'Padding', 'Set Your Icon Padding', 'true', '.oxi-addons-call-to-action-icon-section i', 'padding');
                                        echo oxi_addons_adm_help_padding_margin('oxi-call-action-icon-margin', 307, $styledata, 1, 'Margin', 'Set Your Icon Margin', 'true', '.oxi-addons-call-to-action-icon-section i', 'margin');
                                        ?>
                                    </div>
                                </div>
                            </div>
...
<?php echo oxi_call_to_action_style_6_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
