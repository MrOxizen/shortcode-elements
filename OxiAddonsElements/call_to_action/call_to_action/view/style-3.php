...
function oxi_call_to_action_style_3_shortcode($styledata = false, $listdata = false, $user = 'user') {
	$oxiid = $styledata['id'];
                ...
                <div class="oxi-addons-row">
                    <div class="oxi-addons-call-to-action-' . $oxiid . '">
                       <div class="oxi-addons-call-to-action-full-content">';
                            if(!empty($stylefiles[2])){ echo $leftbutton; }
                            echo '
                                                    <div class="oxi-bt-col-lg-9 oxi-bt-col-md-12 oxi-bt-col-sm-12"> 
                                                            '.$heading.'
                                                            '.$sub_heading.'
                                                    </div>';
                            if(!empty($stylefiles[2])){ echo $rightbutton; }
