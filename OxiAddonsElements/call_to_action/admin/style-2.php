...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . oxi_addons_adm_help_single_size('oxi-call-action-max-width')
            . '||#||'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi-call-action-max-width', $styledata[229], $styledata[230], $styledata[231], 1, 'Max-Width', 'Set Your Content Max-Width', 'false', '.oxi-addons-call-to-action-' . $oxiid . ' h1.oxi-addons-call-to-action-heading', 'max-width');
                                        ?>
                                    </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_call_to_action_style_2_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
