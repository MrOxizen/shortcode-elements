...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                . '||'
                . 'oxi-mailchimp-text-align |' . sanitize_text_field($_POST['oxi-mailchimp-text-align']) . '|'
                . '||||'
                . '||||'
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_true_false('oxi-mailchimp-text-align', $styledata[5], 'left', 'left', 'Right', '', 'Button Align', 'Set the button Align', 'true');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('oxi-mailchimp-form-bg-color', $styledata[305], 'rgba', 'Background Color', 'Select your Input Field Background color', 'false', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-form .oxi-addons-mailchimp-input', 'background');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi-mailchimp-form-margin', 73, $styledata, 1, 'Margin', 'Set Your Input Field Maring','true','.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-form .oxi-addons-mailchimp-input','margin');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_mailChimp_style_2_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
