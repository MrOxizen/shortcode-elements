...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . oxi_addons_adm_help_single_size('oxi-mailchimp-button-width')
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('oxi-mailchimp-form-bg-color', $styledata[337], 'rgba', 'Background Color', 'Select your Input Field Background color', 'false', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-form .oxi-addons-mailchimp-email', 'background');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi-mailchimp-heading-font-size', $styledata[309], $styledata[310], $styledata[311], 1, 'Font Size', 'Set Your Heading color Size', 'true', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-heading-text', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('oxi-mailchimp-heading-color', $styledata[313], '', 'Color', 'Select Your Heading Color', 'false', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-heading-text', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi-mailchimp-heading-padding', 321, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-heading-text', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('oxi-mailchimp-button-width', $styledata[89], $styledata[90], $styledata[91], 1, 'Max-Width', 'Set your Button Max-Width', 'false', '.oxi-addons-mailchimp-' . $oxiid . '  .oxi-addons-mailchimp-button-section button.oxi-addons-mailchimp-button', 'width');
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('oxi-mailchimp-button-bg-color', $styledata[99], 'rgba', 'Background Color', 'Set Your Button Background Color', 'false', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-form .oxi-addons-mailchimp-email', 'backgroud');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_mailChimp_style_6_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
