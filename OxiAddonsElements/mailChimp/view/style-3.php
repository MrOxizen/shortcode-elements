...
function oxi_mailChimp_style_3_shortcode($styledata = false, $listdata = false, $user = 'user') {
    ...
    $jquery .= "
        jQuery('#oxi-addons-mailchimp-full-content-$oxiid').submit(function (e) {
            ...
            jQuery(this)[0].reset();
            OxiAddonsAjaxDataProcess( $oxiid, 'oxi_mailChimp_style_3_request', useremail, 'mailChimp||style-3', '', function (data) {
                if (data === 'success') {
...
function oxi_mailChimp_style_3_request($styleid, $file) {
