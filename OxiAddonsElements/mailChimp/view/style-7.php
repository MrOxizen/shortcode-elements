...
function oxi_mailChimp_style_7_shortcode($styledata = false, $listdata = false, $user = 'user') {
    ...
    $jquery .= "
        jQuery('#oxi-addons-mailchimp-full-content-$oxiid').submit(function (e) {
            ...
            jQuery(this)[0].reset();
            OxiAddonsAjaxDataProcess( $oxiid, 'oxi_mailChimp_style_7_request', useremail, 'mailChimp||style-7', '', function (data) {
                if (data === 'success') {
...
function oxi_mailChimp_style_7_request($styleid, $file) {
