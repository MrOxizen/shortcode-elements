...
function oxi_button_effects_style_9_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    $css = '.oxi-button-hover-' . $oxiid . '{
           ...
           .oxi-button-hover-' . $oxiid . ' .oxi-button-img img{
            ...
            .oxi-button-hover-' . $oxiid . ' .oxi-button-left-to-right:hover .oxi-button-hover a{
            ...
            .oxi-button-hover-' . $oxiid . ' .oxi-button-right-to-left:hover .oxi-button-hover a{
                -webkit-transform: scale(1);
                -moz-transform: scale(1);
                -ms-transform: scale(1);
                -o-transform: scale(1);
