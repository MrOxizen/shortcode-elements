...
function oxi_button_effects_style_3_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    $oxiid = $styledata['id'];
    ...
    $css = '.oxi-button-hover-' . $oxiid . '{
           ...
           .oxi-button-hover-' . $oxiid . ' .oxi-button-img img{
            ...
            .oxi-button-hover-' . $oxiid . ' .oxi-button-left-to-right .oxi-button-hover a:first-child{
                transform: translateX(-100%);
            }
            .oxi-button-hover-' . $oxiid . ' .oxi-button-left-to-right .oxi-button-hover a:last-child{
                transform: translateX(100%);
            }
            .oxi-button-hover-' . $oxiid . ' .oxi-button-right-to-left .oxi-button-hover a:first-child{
                transform: translateX(100%);
            }
            .oxi-button-hover-' . $oxiid . ' .oxi-button-right-to-left .oxi-button-hover a:last-child{
                transform: translateX(-100%);
            }
