...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsTabs-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsTabs-H-BG |' . sanitize_text_field($_POST['OxiAddonsTabs-H-BG']) . '|'
            . ' OxiAddonsTabs-Hover-BG |' . sanitize_text_field($_POST['OxiAddonsTabs-Hover-BG']) . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsTabs-H-R') . ''
            . ' ||#||'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTabs-C-BG', $styledata[119], 'rgba', 'Background Color', 'Set Tabs Content Background color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-H-body-BR', 34, $styledata, 1, 'Border Radius', 'Set Tab Heading Border radius', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper', 'border-radius');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTabs-H-body-W', $styledata[212], $styledata[213], $styledata[214], '', 'Width', 'Set Tab Heading body width', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-main-tab-header', 'width');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsTabs-H-BS', 216, $styledata, 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-body');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTabs-H-BG', $styledata[232], 'rgba', 'Background', 'Set Tabs Header  Background', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header', 'background');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-H-R', 236, $styledata, 1, 'Border Radius', 'Set Tab Heading Border Radius', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header', 'border-radius');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTabs-Hover-BG', $styledata[234], 'rgba', 'Background', 'Set Tabs Header Hover Background', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header:hover', 'background');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTabs-active-BG', $styledata[230], 'rgba', 'Background', 'Set Tabs Header Active Background', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-active', 'background');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_tabs_style_21_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
