...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsTabs-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsTabs-H-M') . ''
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-H-body-BW', 18, $styledata, 1, 'Border Width', 'Set Tab Heading Border Width', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-main-tab-header', 'border-width');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-H-body-M', 50, $styledata, 1, 'Margin', 'Set Tab Heading Margin', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header', 'margin');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-H-M', 212, $styledata, 1, 'Margin', 'Set Tab Heading Margin', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-main-tab-header', 'margin');
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-C-BW', 124, $styledata, 1, 'Border Width', 'Set Tab Heading Border Width', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-body', 'border-width');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-C-BR', 140, $styledata, 1, 'Border Radius', 'Set Tab Content Border radius', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-body', 'border-radius');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_tabs_style_8_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
