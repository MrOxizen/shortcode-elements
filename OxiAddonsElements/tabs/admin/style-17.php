...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsTabs-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsTabs-Active-BR') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTabs-H-body-W') . ''
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsTabs-C-M') . ''
            . '||#||'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTabs-H-body-W', $styledata[226], $styledata[227], $styledata[228], '', 'Width', 'Set Tab Heading width', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header', 'width');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-Active-BR', 210, $styledata, 1, 'Border Radius', 'Set Tab Heading Border radius', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-active', 'border-radius');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTabs-C-M', 230, $styledata, 1, 'Margin', 'Set Tab Heading Margin', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header', 'padding');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_tabs_style_17_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
