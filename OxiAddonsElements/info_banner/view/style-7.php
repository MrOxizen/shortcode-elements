...
function oxi_info_banner_style_7_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    ...
    for ($i = 0; $i <= ($datacount - 1); $i += 2) {
        ...
        $iconboxfirst .= '<div class="oxi-info-banner-style-7-static ' . OxiAddonsAdminDefine($user) . '">';
        ...
        if ($user == 'admin') {
            $iconboxfirst .= '  <div class="oxi-addons-admin-absulote">
                                <div class="oxi-addons-admin-absulate-edit">
                                    <form method="post"> ' . wp_nonce_field("OxiAddonsListFileEditinfo_bannerdata") . '
                                        <input type="hidden" name="oxi-item-id" value="' . $listdata[$i]['id'] . '">
    ...
    for ($i = 1; $i <= ($datacount - 1); $i += 2) {
        ...
        $iconboxlast .= '<div class="' . OxiAddonsItemRows($styledata, 49) . ' oxi-info-banner-style-7-static ' . OxiAddonsAdminDefine($user) . '">';
        ...
        if ($user == 'admin') {
            $iconboxlast .= '<div class="oxi-addons-admin-absulote">
                                <div class="oxi-addons-admin-absulate-edit">
                                    <form method="post"> ' . wp_nonce_field("OxiAddonsListFileEditinfo_bannerdata") . '
                                        <input type="hidden" name="oxi-item-id" value="' . $listdata[$i]['id'] . '">
                                        <button class="btn btn-primary" type="submit" value="edit" name="OxiAddonsListFileEdit">Edit</button>
