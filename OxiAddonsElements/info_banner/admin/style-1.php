        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-icon-size', $styledata[91], $styledata[92], $styledata[93], 1, 'Font Size', 'Select Your Icon Font Size', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-icon-width', $styledata[199], $styledata[200], $styledata[201], 1, 'Width', 'Select Your Icon Width And Height', 'true');
                                            ...
                                            echo oxi_addons_adm_help_Text_Align('OxiAddInfoBanner-icon-position', $styledata[97], 'Text-align', 'Set Your Icon Postion', 'true');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_Animation('OxiAddInfoBanner-icon-animation', 195, $styledata, 'true', '.oxi-addons-content-boxes-icon');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-heading-size', $styledata[115], $styledata[116], $styledata[117], 1, 'Font Size', 'Select Your Heading Font Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfoBanner-heading-color', $styledata[119], '', 'Color', 'Select Your Heading Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddInfoBanner-heading', 121, $styledata, 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfoBanner-heading-padding', 127, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-content-size', $styledata[143], $styledata[144], $styledata[145], 1, 'Font Size', 'Select Your Content Font Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-content', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfoBanner-content-color', $styledata[147], '', 'Color', 'Select Your Content Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-content', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddInfoBanner-content', 149, $styledata, 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-content');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfoBanner-content-padding', 155, $styledata, 1, 'Padding', 'Set Your Content Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-content', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_banner_style_1_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
