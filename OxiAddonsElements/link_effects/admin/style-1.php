...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-nonce')) {
        ...
        $data = 'oxi-addons-link-opening |' . sanitize_text_field($_POST['oxi-addons-link-opening']) . '|'
                ...
                . ' oxi-addons-icon-color |' . sanitize_text_field($_POST['oxi-addons-icon-color']) . '|'
                ...
                . 'oxi-addons-link ||#||' . sanitize_text_field($_POST['oxi-addons-link']) . '||#||'
                . 'oxi-addons-left-icon ||#||' . sanitize_text_field($_POST['oxi-addons-left-icon']) . '||#||'
                . 'oxi-addons-right-icon ||#||' . sanitize_text_field($_POST['oxi-addons-right-icon']) . '||#||'
                . '|';
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_nonjs_popup('oxi-addons-text', 'Link Text');
                                        echo oxi_addons_adm_help_nonjs_popup('oxi-addons-left-icon', 'Left Icon');
                                        echo oxi_addons_adm_help_nonjs_popup('oxi-addons-right-icon', 'Right Icon');
                                        echo oxi_addons_adm_help_textbox('oxi-addons-text', $stylefiles[3], 'Link Text', 'Write your Link Text Here');
                                        echo oxi_addons_adm_help_textbox('oxi-addons-left-icon', $stylefiles[9], 'Left Icon', 'Write you left icon as Example {,[,(');
                                        echo oxi_addons_adm_help_textbox('oxi-addons-right-icon', $stylefiles[11], 'Right Icon', 'Write you left icon as Example }, ],)');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-icon-color', $styledata[11], '', 'Icon Color', 'Select Your Left Right Color');
