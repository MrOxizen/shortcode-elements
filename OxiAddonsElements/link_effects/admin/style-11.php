                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_nonjs_popup('oxi-addons-font-size', 'Font Size');
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-font-size', $styledata[3], $styledata[4], $styledata[5], 1, 'Font Size', 'Your Links Font Size', 'true');
                                        ...
                                        echo oxi_addons_adm_help_Font_Style('oxi-addons-font-style', $styledata[17], 'Font Style', 'Select Your Font Style', '.oxi-links-effects-' . $oxiid . '', '.oxi-links-effects-' . $oxiid . '', 'font-style');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-size', $styledata[43], $styledata[44], $styledata[45], 1, 'Border Size', 'Your Border Size', 'true', '.oxi-links-effects-' . $oxiid . '::before, #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '::after', 'height');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-border-color', $styledata[11], '', 'Border Color', 'Select Your Border Color', '', '.oxi-links-effects-' . $oxiid . '::before, #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '::after', 'background');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-border-hover-color', $styledata[47], '', 'Border Hover Color', 'Select Your Border Hover Color', '', '.oxi-links-effects-' . $oxiid . ':hover::before, .oxi-links-effects-' . $oxiid . ':focus::before, #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . ':hover::after, .oxi-links-effects-' . $oxiid . ':focus::after', 'background');
                                        ?>
                                    </div>
                                </div>   
                            </div>
