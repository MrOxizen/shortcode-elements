...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddCB-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '||'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCB-all-content-margin') . ''
                . ' OxiAddCB-BG-hover-color|' . sanitize_text_field($_POST['OxiAddCB-BG-hover-color']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCB-all-content-hover-margin') . ''
                . '' . oxi_addons_adm_help_single_size('OxiAddIC-font-size') . ''
                . ' OxiAddIC-color |' . sanitize_hex_color($_POST['OxiAddIC-color']) . '|'
                . ' OxiAddIC-color |' . sanitize_hex_color($_POST['OxiAddIC-h-color']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddIC-padding') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAdd-I-margin') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAdd-I-h-margin') . ''
                . '';
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = ' OxiAddCB-Front-IMG ||#||' . OxiAddonsAdminUrlConvert($_POST['OxiAddCB-Front-IMG']) . '||#||'
                ...
                . 'OxiAddCB-icon-class ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddCB-icon-class']) . '||#||'
                . '  ||#||';
        $data = sanitize_text_field($data);
        if ($oxilistid > 0) {
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-margin', 31, $styledata, 1, 'Margin', 'Set Your Content Boxes  Margin', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-full', 'margin');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Box Shadow
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-I-height', $styledata[117], $styledata[118], $styledata[119], 1, 'Image height', 'Set Your Image Height', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-images', 'height');
                                            echo oxi_addons_adm_help_padding_margin('OxiAdd-I-margin', 191, $styledata, 1, 'Margin', 'Set Your Image Margin ', 'true', '.oxi-addons-content-boxes-' . $oxiid . '-image_content', 'margin');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Image Hover
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_padding_margin('OxiAdd-I-h-margin', 207, $styledata, 1, 'Hover Margin', 'Set Your Image Hover Margin ', 'false', '.oxi-addons-content-boxes-' . $oxiid . ':hover .oxi-addons-content-boxes-' . $oxiid . '-image_content', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddIC-font-size', $styledata[167], $styledata[168], $styledata[169], 1, 'Font Size', 'Set Your Font Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . '-data .oxi-addons-content-boxes-' . $oxiid . '-icon .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddIC-color', $styledata[171], '', 'Color', 'Select Your Icon Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . '-data .oxi-addons-content-boxes-' . $oxiid . '-icon .oxi-icons', 'color');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddIC-padding', 175, $styledata, 1, 'Padding', 'Set Your Icon Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . '-data .oxi-addons-content-boxes-' . $oxiid . '-icon .oxi-icons', 'padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Icon Hover
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddIC-h-color', $styledata[173], '', 'Hover Color', 'Select Your Icon Hover Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . '-data .oxi-addons-content-boxes-' . $oxiid . '-icon:hover .oxi-icons', 'color');
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-BG-color', $styledata[121], 'rgba', 'Background Color', 'Select Your Background Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-' . $oxiid . '-data', 'background');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-padding', 15, $styledata, 1, 'Padding', 'Set Your All Content  Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . '-data', 'padding');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-all-content-margin', 133, $styledata, 1, 'Margin', 'Set Your All Content Margin', 'true', ' .oxi-addons-content-boxes-' . $oxiid . '  .oxi-addons-content-boxes-' . $oxiid . '-data', 'margin');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            All Content Hover Settings
                                        </div>
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-BG-hover-color', $styledata[149], 'rgba', 'Hover Background Color', 'Select Your Content Hover  Background Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ':hover .oxi-addons-content-boxes-' . $oxiid . '-data', 'background');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-all-content-hover-margin', 151, $styledata, 1, 'Hover Margin', 'Set Your All Content  Hover Margin', 'true', ' .oxi-addons-content-boxes-' . $oxiid . ':hover .oxi-addons-content-boxes-' . $oxiid . '-data', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_image_boxes_style_4_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_textbox('OxiAddCB-icon-class', $listitemdata[7], 'Icon Class', 'Set your Icon Class');
                    ?>
                </div>
