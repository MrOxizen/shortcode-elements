...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-nonce')) {
        ...
        $data = 'oxi-addons-link-opening |' . sanitize_text_field($_POST['oxi-addons-link-opening']) . '|'
                ...
                . ' oxi-addons-border-width |' . sanitize_text_field($_POST['oxi-addons-border-width']) . '|' . sanitize_text_field($_POST['oxi-addons-border-width-tab']) . '|' . sanitize_text_field($_POST['oxi-addons-border-width-mobile']) . '|'
                . ' oxi-addons-border-2nd-size |' . sanitize_text_field($_POST['oxi-addons-border-2nd-size']) . '|' . sanitize_text_field($_POST['oxi-addons-border-2nd-size-tab']) . '|' . sanitize_text_field($_POST['oxi-addons-border-2nd-size-mobile']) . '|'
                ...
                . ' oxi-addons-border-2nd-color |' . sanitize_text_field($_POST['oxi-addons-border-2nd-color']) . '|'
                . ' oxi-addons-border-2nd-width |' . sanitize_text_field($_POST['oxi-addons-border-2nd-width']) . '|' . sanitize_text_field($_POST['oxi-addons-border-2nd-width-tab']) . '|' . sanitize_text_field($_POST['oxi-addons-border-2nd-width-mobile']) . '|'
                . ' oxi-addons-border-radius |' . sanitize_text_field($_POST['oxi-addons-border-radius']) . '|' . sanitize_text_field($_POST['oxi-addons-border-radius-tab']) . '|' . sanitize_text_field($_POST['oxi-addons-border-radius-mobile']) . '|'
                . '||#||  ||#||'
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_double_dtm('oxi-addons-margin-top', $styledata[27], $styledata[28], $styledata[29], 'oxi-addons-margin-left', $styledata[31], $styledata[32], $styledata[33], '1', 'Margin', 'Set Your Links Margin Top Bottom and Left Right', 'true');
                                        ?>
                                    </div>
                                </div> 
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-size', $styledata[43], $styledata[44], $styledata[45], 1, 'Border Size', 'Your Border Size', '', '.oxi-links-effects-' . $oxiid . '::before, .oxi-links-effects-' . $oxiid . '::after', 'border-width');
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-width', $styledata[19], $styledata[20], $styledata[21], 1, 'Border Width Height', 'Your Border Width and Height', 'true', '.oxi-links-effects-' . $oxiid . '::before, .oxi-links-effects-' . $oxiid . '::after', 'width');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-border-color', $styledata[11], '', 'Border Color', 'Select Your First Border Color', '', '.oxi-links-effects-' . $oxiid . '::before, .oxi-links-effects-' . $oxiid . '::after', 'border-color');
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-2nd-size', $styledata[23], $styledata[24], $styledata[25], 1, 'Second Border Size', 'Your Border Size', 'true', '.oxi-links-effects-' . $oxiid . '::after', 'border-width');
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-2nd-width', $styledata[49], $styledata[50], $styledata[51], 1, 'Second Width Height', 'Your Border Width and Height', 'true', '.oxi-links-effects-' . $oxiid . '::after', 'width');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-border-2nd-color', $styledata[47], '', 'Second Border Color', 'Select Your Second Border Color', '', '.oxi-links-effects-' . $oxiid . '::after', 'border-color');
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-radius', $styledata[53], $styledata[54], $styledata[55], 1, 'Border Radius', 'Your Border Radius', 'true', '.oxi-links-effects-' . $oxiid . '::before, #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '::after', 'border-radius');
                                        ?>
                                    </div>
                                </div>   
                            </div>
...
<script type="text/javascript">
    jQuery("#oxi-addons-border-width").on("change", function () {
        var value1 = jQuery(this).val();
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>::before, .oxi-links-effects-<?php echo $oxiid; ?>::after{height: " + value1 + "px; } </style>").appendTo("#oxi-addons-preview-data");
    });
    jQuery("#oxi-addons-border-2nd-width").on("change", function () {
        var value1 = jQuery(this).val();
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>::after{height: " + value1 + "px; } </style>").appendTo("#oxi-addons-preview-data");
    });
</script>