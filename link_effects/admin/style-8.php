                        ...
                        <div class="oxi-addons-tabs-content-tabs active">
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-size', $styledata[43], $styledata[44], $styledata[45], 1, 'Border Size', 'Your Border Size', '', '.oxi-links-effects-' . $oxiid . '::before, #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '::after', 'border-width');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-border-color', $styledata[11], '', 'Border Color', 'Select Your Border Color', '', '.oxi-links-effects-' . $oxiid . '::before, .oxi-links-effects-' . $oxiid . '::after', 'border-color');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-border-hover-color', $styledata[47], '', 'Border Hover Color', 'Select Your Border Hover Color', '', '.oxi-links-effects-' . $oxiid . ':hover::after, .oxi-links-effects-' . $oxiid . ':focus::after ', 'border-color');
                                        ?>
                                    </div>
                                </div>   
                            </div>
