                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-bg-color', $styledata[11], 'rgba', 'Background Color', 'Select Your Links Background Color');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-bg-hover-color', $styledata[39], 'rgba', 'Hover Background Color', 'Select Your Links Hover Background Color');
...
<script type="text/javascript">
    jQuery("#oxi-addons-bg-color").on("change", function () {
        var value1 = jQuery(this).val();
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>-span{background: " + value1 + "; } </style>").appendTo("#oxi-addons-preview-data");
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>-span::before{background:" + value1 + "; } </style>").appendTo("#oxi-addons-preview-data");
    });
    jQuery("#oxi-addons-bg-hover-color").on("change", function () {
        var value1 = jQuery(this).val();
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>:hover .oxi-links-effects-<?php echo $oxiid; ?>-span, .oxi-links-effects-<?php echo $oxiid; ?>:focus .oxi-links-effects-<?php echo $oxiid; ?>-span{background: " + value1 + "; } </style>").appendTo("#oxi-addons-preview-data");
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>:hover .oxi-links-effects-<?php echo $oxiid; ?>-span::before,.oxi-links-effects-<?php echo $oxiid; ?>:focus .oxi-links-effects-<?php echo $oxiid; ?>-span::before{background:" + value1 + "; } </style>").appendTo("#oxi-addons-preview-data");
    });
</script>