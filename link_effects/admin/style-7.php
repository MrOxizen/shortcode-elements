                        ...
                        <div class="oxi-addons-tabs-content-tabs active">
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-border-size', $styledata[43], $styledata[44], $styledata[45], 1, 'Border Size', 'Your Border Size', '', '');
...
<script type="text/javascript">
    jQuery("#oxi-addons-border-size").on("change", function () {
        ...
        jQuery("<style type='text/css'> #oxi-addons-preview-data .oxi-links-effects-<?php echo $oxiid; ?>::before{height: " + value1 + "px; } </style>").appendTo("#oxi-addons-preview-data");
