...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-nonce')) {
        ...
        $data = 'oxi-addons-link-opening |' . sanitize_text_field($_POST['oxi-addons-link-opening']) . '|'
                ...
                . ' oxi-addons-bg-color |' . sanitize_text_field($_POST['oxi-addons-bg-color']) . '|'
                ...
                . ' oxi-addons-bg-hover-color |' . sanitize_text_field($_POST['oxi-addons-bg-hover-color']) . '|'
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_textbox('oxi-addons-hover-text', $stylefiles[9], 'Hover Text', 'Write your Link Hover Text Here', 'true');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-font-size', $styledata[3], $styledata[4], $styledata[5], 1, 'Font Size', 'Your Links Font Size', 'true', '.oxi-links-effects-' . $oxiid . ', #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '-span', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-color', $styledata[7], '', 'Color', 'Select Your Links Color', '', '.oxi-links-effects-' . $oxiid . '-span', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-hover-color', $styledata[9], '', 'Hover Color', 'Select Your Links Hover Color', '', '.oxi-links-effects-' . $oxiid . '::before', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-bg-color', $styledata[11], 'rgba', 'Background Color', 'Select Your Links Background Color', '', '.oxi-links-effects-' . $oxiid . '-span', 'background');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-bg-hover-color', $styledata[39], 'rgba', 'Hover Background Color', 'Select Your Links Hover Background Color', '', '.oxi-links-effects-' . $oxiid . '::before ', 'background');
                                        echo oxi_addons_adm_help_Font_Family('oxi-addons-family', $styledata[13], 'Font Family', 'Select Your Font Family', 'true', '.oxi-links-effects-' . $oxiid . ', #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '-span ', 'font-family');
                                        echo oxi_addons_adm_help_Font_Weight('oxi-addons-font-weight', $styledata[15], 'Font Weight', 'Select Your Font Wight', 'true', '.oxi-links-effects-' . $oxiid . ', #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '-span ', 'font-weight');
                                        echo oxi_addons_adm_help_Font_Style('oxi-addons-font-style', $styledata[17], 'Font Style', 'Select Your Font Style', 'true', '.oxi-links-effects-' . $oxiid . ', #oxi-addons-preview-data .oxi-links-effects-' . $oxiid . '-span ', 'font-style');
                                        echo oxi_addons_adm_help_number_double_dtm('oxi-addons-padding-top', $styledata[19], $styledata[20], $styledata[21], 'oxi-addons-padding-left', $styledata[23], $styledata[24], $styledata[25], '1', 'Padding', 'Set Your Links Padding Top Bottom and Left Right', 'true');
