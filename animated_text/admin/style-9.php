...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsAnimation-G-margin') . ''
            . '||#||  ||#||'
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo OxiAddonsADMHelpBGImage('OxiAddonsAnimation-G-BG', $styledata, 3, 'true', '.oxi-addons-wrapper-' . $oxiid . '', 'background');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsAnimation-font-size', $styledata[23], $styledata[24], $styledata[25], 1, 'Font Size', 'set your Animation Text Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-para', 'font-size');
                                        echo OxiAddonsADMHelpFontSettings('OxiAddonsAnimation-font-family', 27, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-para');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsAnimation-G-margin', 37, $styledata, 1, 'Margin', 'Set Text Margin', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-para', 'margin');
                                        ?>
                                    </div>
                                    <div class="oxi-head">
                                        Text Settings
