                        ...
                        <div class="oxi-addons-tabs-content-tabs active">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number("oxi-addons-animat-time", $styledata[3], 1, "Speed", "Set text animat time duration", " ");
                                        ?>
                                    </div>
                                </div>
                                 <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('oxi-addons-text-1st', $stylefiles[3], 'Main Text', 'Write Wour main animat text');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-text-1st-color', $styledata[5], '', 'Text Color', 'Set your main text color', '');
                                        ...
                                        echo OxiAddonsADMHelpFontSettings('oxi-addons-text-1st-font', 11, $styledata, 'true');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('oxi-addons-text-2nd', $stylefiles[5], 'Second Text', 'Write Wour animat text');
                                        echo oxi_addons_adm_help_MiniColor('oxi-addons-text-2nd-color', $styledata[17], '', 'Text Color', 'Set your text color', '');
                                        echo oxi_addons_adm_help_number_dtm('oxi-addons-text-2nd-size', $styledata[19], $styledata[20], $styledata[21], 1, 'Font Size', 'Set your font size', 'true');
                                        echo OxiAddonsADMHelpFontSettings('oxi-addons-text-2st-font', 23, $styledata, 'true');
                                        ?>
                                    </div>                                               
                                </div>                                          
