        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                     ...
                                     <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_number_dtm('OxiAddonsgooglechart-CB-BW', $styledata[90], $styledata[91], $styledata[92], '1', 'Border Width', 'Set Chart Bar Border Width', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-title', 'font-size');
                                             $NOJS = array(
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_google_chart_style_1_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
