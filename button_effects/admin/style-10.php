        ...
        <div class="oxi-addons-row">
                                              ...
                                              <div class="form-group row form-group-sm">
                                                ...
                                                <div class="col-sm-6 nopadding">
                                                    <select class="form-control" id="image-alignments" name="effects-alignments">
                                                        ...
                                                        ?>>Horizontal in Out</option>
                                                        <option value="oxi-button-right-to-left" <?php
                                                        if ($effectsalignments == 'oxi-button-right-to-left') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Vertical In Out</option>
                                                        <option value="oxi-button-bottom-to-top" <?php
                                                        if ($effectsalignments == 'oxi-button-bottom-to-top') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Horizontal In</option>
                                                        <option value="oxi-button-top-to-bottom" <?php
                                                        if ($effectsalignments == 'oxi-button-top-to-bottom') {
                                                            echo 'selected';
                                                        }
                                                        ?>>Vertical in</option>
                                                    </select>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_button_effects_style_10_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
