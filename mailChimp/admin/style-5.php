        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('oxi-mailchimp-max-width', $styledata[333], $styledata[334], $styledata[335], 1, 'Max Width', 'Your Full Part Max Width', 'false', '.oxi-addons-mailchimp-' . $oxiid . '','max-width');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('oxi-mailchimp-writing-color', $styledata[41], '', 'Writing Color', 'Select your Active Input Field color', 'false', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-form .oxi-addons-mailchimp-input', 'color');
                                             echo oxi_addons_adm_help_MiniColor('oxi-mailchimp-form-bg-color', $styledata[337], 'rgba', 'Background Color', 'Select your Input Field Background color', 'false', '.oxi-addons-mailchimp-' . $oxiid . ' .oxi-addons-mailchimp-form .oxi-addons-mailchimp-input', 'background');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_mailChimp_style_5_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
