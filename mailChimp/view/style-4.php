...
function oxi_mailChimp_style_4_shortcode($styledata = false, $listdata = false, $user = 'user') {
    ...
    if (!empty($stylefiles[24])) {
        $e_title = OxiAddonsTextConvert($stylefiles[24]);
    }
    if (!empty($stylefiles[26])) {
        $f_title = OxiAddonsTextConvert($stylefiles[26]);
    }
    if (!empty($stylefiles[28])) {
        $l_title = OxiAddonsTextConvert($stylefiles[28]);
    }
    ...
    echo '<div class="oxi-addons-mailchimp-form">
            <div class="oxi-addons-mailchimp-form-input-sec">
                <div class="oxi-addons-mailchimp-form-sec">
                    <label for="oxi-addons-mailchimp-email-' . $oxiid . '" class="oxi-addons-mailchimp-label">' . $e_title . '</label>
                 ...
                 <div class="oxi-addons-mailchimp-form-sec">
                    <label for="oxi-addons-mailchimp-Fname-' . $oxiid . '" class="oxi-addons-mailchimp-label">' . $f_title . '</label>
                 ...
                 <div class="oxi-addons-mailchimp-form-sec">
                    <label for="oxi-addons-mailchimp-Lname-' . $oxiid . '" class="oxi-addons-mailchimp-label">' . $l_title . '</label>
    ...
    $jquery .= "
        jQuery('#oxi-addons-mailchimp-full-content-$oxiid').submit(function (e) {
            ...
            jQuery(this)[0].reset();
            OxiAddonsAjaxDataProcess( $oxiid, 'oxi_mailChimp_style_4_request', useremail, 'mailChimp||style-4', '', function (data) {
                if (data === 'success') {
...
function oxi_mailChimp_style_4_request($styleid, $file) {
