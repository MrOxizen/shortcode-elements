...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-time-LR') . ''
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-time-TB') . ''
            . '||||||||'
            . '||||||||||||||||'
            ...
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-PV-LR') . ''
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-PV-TB') . ''
            . '||||||||'
            ...
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-PBTN-W') . ''
            . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-PBTN-H') . ''
            . ' OxiAddonsAudio-PBTN-BG |' . sanitize_text_field($_POST['OxiAddonsAudio-PBTN-BG']) . '|'
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsAudio-audio-H', 'Height'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div>
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-time-LR', $styledata[130], $styledata[131], $styledata[132], '1', 'Left right', 'Set Audio Play volume Position Left Right', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .mejs-time', 'left');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-time-TB', $styledata[134], $styledata[135], $styledata[136], '1', 'Top bottom', 'Set Audio Play volume  Position Bottom Top', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .mejs-time', 'bottom');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_double_dtm('OxiAddonsAudio-PBTN-W', $styledata[534], $styledata[535], $styledata[536], 'OxiAddonsAudio-PBTN-H', $styledata[538], $styledata[539], $styledata[540], 1, 'Width & Height', 'Set Width Height Progress time handle', 'true');
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsAudio-PBTN-BG', $styledata[542], 'rgba', 'Background Color', 'Set Audio Play button Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .mejs-playpause-button', 'background');
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsAudio-PBTN-W', 'Width '),
                                                array('OxiAddonsAudio-PBTN-H', 'Height'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div>
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsAudio-SBTN-FS', 'Font Size'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div>
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-PV-LR', $styledata[294], $styledata[295], $styledata[296], '1', 'Right Left', 'Set Audio Play volume Position Right Left', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .mejs-horizontal-volume-slider, .oxi-addons-wrapper-' . $oxiid . ' .mejs-volume-button ', 'right');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-PV-TB', $styledata[298], $styledata[299], $styledata[300], '1', 'Bottom Top', 'Set Audio Play volume  Position Bottom Top', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .mejs-horizontal-volume-slider, .oxi-addons-wrapper-' . $oxiid . ' .mejs-volume-button ', 'bottom');
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsAudio-PV-LR', 'Position Right Left'),
                                                array('OxiAddonsAudio-PV-TB', ' Position Bottom Top'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div>
