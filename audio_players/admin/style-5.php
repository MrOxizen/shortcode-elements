...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '||||||||||||||||' 
                . '||'
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-PBTN-LR') . ''
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsAudio-PBTN-TB') . ''
                . '||||'
                . '||||'
                . '||'
                . '|||'
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-G-W', $styledata[7], $styledata[8], $styledata[9], 1, 'Max Width', 'Set audio body max width', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-audio-main','max-width');
                                ...
                                <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsAudio-G-BG', 'Background Color'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div> 
                                ...
                                <div class="oxi-addons-col-6">
                                 <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-PBTN-LR', $styledata[368], $styledata[369], $styledata[370], '1', 'Left Right', 'Set Audio Play volume Position Right Left By % not px', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .mejs-playpause-button', 'right');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudio-PBTN-TB', $styledata[372], $styledata[373], $styledata[374], '1', 'Top Bottom ', 'Set Audio Play volume  Position Bottom Top By % not px', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .mejs-playpause-button', 'bottom');
                                            ...
                                            $NOJS = array(
                                                ...
                                                array('OxiAddonsAudio-PBTN-LR', 'Left Right'),
                                                array('OxiAddonsAudio-PBTN-TB', 'Top Bottom'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div> 
