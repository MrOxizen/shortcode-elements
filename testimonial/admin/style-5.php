...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsTestimonial-p-padding') . ''
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsTestimonial-info-margin') . ''
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsTestimonial-BS', 54, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . '-info');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-p-width', $styledata[60], $styledata[61], $styledata[62], 1, 'Width', 'Set Your Testimonial Max Width', 'false', '  .oxi-testimonials-style-' . $oxiid . '-image', 'width');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-p-height', $styledata[64], $styledata[65], $styledata[66], 1, 'Height', 'Set Your Testimonial Max height', 'false', '.oxi-testimonials-style-' . $oxiid . '-image:after', 'padding-bottom');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-p-border', 68, $styledata, 1, 'Border width', 'Set Your Testimonial Border width', 'true', '  .oxi-testimonials-style-' . $oxiid . '-image img', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddonsTestimonial-p-border', 84, $styledata, 'true', '  .oxi-testimonials-style-' . $oxiid . '-image img', 'border-style');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-p-radius', 88, $styledata, 1, 'Border Radius', 'Set Your Testimonial Border Radius', 'true', '  .oxi-testimonials-style-' . $oxiid . '-image img', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-p-padding', 104, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-image', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-n-FS', $styledata[120], $styledata[121], $styledata[122], '1', 'Font Size', 'Set Testimonial Name Font Size', 'true', '    .oxi-testimonials-style-' . $oxiid . '-name', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-n-c', $styledata[124], '', 'Color', 'Set your Name Color', 'false', '    .oxi-testimonials-style-' . $oxiid . '-name', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-nh-c', $styledata[192], '', 'Hover Color', 'Set your Name Color', 'false', '    .oxi-testimonials-style-' . $oxiid . '-name:hover', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsTestimonial-nf', 126, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . '-name');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-n-padding', 132, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', '    .oxi-testimonials-style-' . $oxiid . '-name', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-info-radius', 194, $styledata, 1, 'Border Radius', 'Set Your Testimonial Border Radius', 'true', '.oxi-testimonials-style-' . $oxiid . '-info', 'border-radius');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-info-margin', 176, $styledata, 1, 'Margin', 'Set Your Information Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-info', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
