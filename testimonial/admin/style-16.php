...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
	if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
		...
		$data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
				...
				. ' OxiAddonsTestimonial-border-left|' . sanitize_text_field($_POST['OxiAddonsTestimonial-border-left']) . '|'
				. ' OxiAddonsTestimonial-border-left-color |' . sanitize_hex_color($_POST['OxiAddonsTestimonial-border-left-color']) . '|'
				. ' OxiAddonsTestimonial-border-bottom|' . sanitize_text_field($_POST['OxiAddonsTestimonial-border-bottom']) . '|'
				. ' OxiAddonsTestimonial-border-hover-color |' . sanitize_hex_color($_POST['OxiAddonsTestimonial-border-hover-color']) . '|'
				. '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-padding-left') . ''
				. '' . OxiAddonsADMBoxShadowSanitize('OxiAddonsTestimonial-BS') . ''
				. 'testimonial-image-position|' . sanitize_text_field($_POST['testimonial-image-position']) . '|'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
									...
									<div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <div class="form-group row form-group-sm">
                                                <label for="testimonial-image-position" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Set your Testimonial Image Position">Image Position</label>
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="testimonial-image-position" name="testimonial-image-position">
                                                        <option <?php
														if ($styledata[168] == 'flex-start') {
															echo 'selected';
														}
														?> value="flex-start">Top</option>                                                            
                                                        <option <?php
														if ($styledata[168] == 'center') {
															echo 'selected';
														}
														?> value="center">Center</option>
                                                        <option <?php
														if ($styledata[168] == 'flex-end') {
															echo 'selected';
														}
														?> value="flex-end">Bottom</option>
                                                    </select>
                                                </div>
                                            </div>
											<?php
                                           ...
                                           echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-padding-left', $styledata[158], $styledata[159], $styledata[160], 1, 'Padding Left Right', 'Set Your Testimonial Image Padding Left Right', 'true', '', '');
											?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
											<?php
											echo OxiAddonsADMhelpBoxShadow('OxiAddonsTestimonial-BS', 162, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . '');
											?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
											<?php
											echo OxiAddonsADMhelpBoxShadow('OxiAddonsTestimonial-hover-BS', 170, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . ':hover');
											?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">                                  
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
											<?php
											echo oxi_addons_adm_help_number('OxiAddonsTestimonial-border-left', $styledata[150], '', 'Border Left Size', 'Set Your Info Image Border Left size', 'true', '', '');
											echo oxi_addons_adm_help_number('OxiAddonsTestimonial-border-bottom', $styledata[154], '', 'Border Bottom Size', 'Set Your Info Image Border Bottom size', 'true', '', '');
											echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-border-left-color', $styledata[152], '', 'Border Color', 'Select Your Info Image Border size Color', 'false', '.oxi-testimonials-style-' . $oxiid . ' .oxi-before', 'border-color');
											echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-border-hover-color', $styledata[156], '', 'Border Hover Color', 'Select Your Info Image Border Hover Color', 'false', '.oxi-testimonials-style-' . $oxiid . ':hover .oxi-before', 'border-color');
											?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
					<?php echo oxi_testimonial_style_16_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<?php
					echo oxi_addons_adm_help_image_upload('OxiAddonstestimonial-BG', $listitemdata[1], 'Background image', 'Set your background image', 'false');
