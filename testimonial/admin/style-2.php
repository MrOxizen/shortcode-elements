        ...
        <div class="oxi-addons-row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="testimonial-position" name="testimonial-position">
                                                        <option <?php
                                                                ...
                                                                ?> value="">Left</option>
                                                        <option <?php
                                                                if ($styledata[270] == 'oxi-testimonials-right') {
                                                                    echo 'selected';
                                                                }
                                                                ?> value="oxi-testimonials-right">Right</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <?php
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsTestimonial-n', 168, $styledata, 'true', '  .oxi-testimonials-style-' . $oxiid . '-name');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_2_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
