...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsTestimonial-p-border-color |' . sanitize_hex_color($_POST['OxiAddonsTestimonial-p-border-color']) . '|'
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-info-radius', 194, $styledata, 1, 'Border Radius', 'Set Your Testimonial Border Radius', 'true', '.oxi-testimonials-style-' . $oxiid . '', 'border-radius');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddonsTestimonial-P-Border-right', $styledata[242], '', 'Border Right', 'Set Your Image Border Right', 'true', '.oxi-testimonials-style-' . $oxiid . '-image-parent', 'border-right');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-p-border-color', $styledata[244], '', 'Border Right Color', 'Select Your Image Border Right Color', 'false', '', '');
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-p-margin-top-bottom', $styledata[238], $styledata[239], $styledata[240], 1, 'Padding Top Bottom', 'Set Your Testimonial Image Padding Top Bottom', 'true', '.oxi-testimonials-style-' . $oxiid . '-image', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-nh-c', $styledata[192], '', 'Hover Color', 'Set your Name Color', 'false', '.oxi-testimonials-style-' . $oxiid . '-name, a .oxi-testimonials-style-' . $oxiid . '-name:hover', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-n-padding', 132, $styledata, 1, 'Padding', 'Set Your Name Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-name, a .oxi-testimonials-style-' . $oxiid . '-name', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_11_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
