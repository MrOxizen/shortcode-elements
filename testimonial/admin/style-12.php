...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddonsTestimonial-p-margin-top-bottom') . ''
            . 'OxiAddonsTestimonial-P-Border-right|' . sanitize_text_field($_POST['OxiAddonsTestimonial-P-Border-right']) . '|'
            . ' OxiAddonsTestimonialbordercolor |' . sanitize_text_field($_POST['OxiAddonsTestimonialbordercolor']) . '|'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonial-BG-color', $styledata[13], 'rgba', 'Background Color', 'Select Your Background Color', 'false', '.oxi-testimonials-style-' . $oxiid . '', 'color');
                                            ?>
                                            ...
                                            <?php
                                            echo oxi_addons_adm_help_number('OxiAddonsTestimonial-P-Border-right', $styledata[242], '', 'Border Bottom', 'Set Your Image Border Right', 'true', ' .oxi-testimonials-style-' . $oxiid . '', 'border-bottom-width');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsTestimonialbordercolor', $styledata[244], '', 'Border Bottom Color', 'Select Your Image Border Right Color', 'false', ' .oxi-testimonials-style-' . $oxiid . '', 'border-bottom-color');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-padding', 15, $styledata, 1, 'Padding', 'Set Your Testimonial Padding', 'true', ' .oxi-testimonials-style-' . $oxiid . '', 'padding');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsTestimonial-BS', 54, $styledata, 'true', ' .oxi-testimonials-style-' . $oxiid . '');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsTestimonial-Hover-BS', 246, $styledata, 'true', '.oxi-testimonials-style-' . $oxiid . ':hover');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-p-width', $styledata[60], $styledata[61], $styledata[62], 1, 'Width', 'Set Your Testimonial Max Width', 'false', '.oxi-testimonials-style-' . $oxiid . '-image', 'max-width');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-p-border', 68, $styledata, 1, 'Border width', 'Set Your Testimonial Border width', 'true', '  .oxi-testimonials-style-' . $oxiid . '-image', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddonsTestimonial-p-border', 84, $styledata, 'true', '  .oxi-testimonials-style-' . $oxiid . '-image');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-p-radius', 88, $styledata, 1, 'Border Radius', 'Set Your Testimonial Border Radius', 'true', '  .oxi-testimonials-style-' . $oxiid . '-image', 'border-radius');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsTestimonial-p-margin-top-bottom', $styledata[238], $styledata[239], $styledata[240], 1, 'Padding Top Bottom', 'Set Your Testimonial Image Padding Top Bottom', 'true', '.oxi-addonsdata-right .oxi-testimonials-style-' . $oxiid . '-image', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsTestimonial-n-padding', 132, $styledata, 1, 'Padding', 'Set Your Name Padding', 'true', '.oxi-testimonials-style-' . $oxiid . '-name, a .oxi-testimonials-style-' . $oxiid . '-name', 'color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_testimonial_style_12_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
