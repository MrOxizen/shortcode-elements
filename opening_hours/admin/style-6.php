...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsOH-SX-I-FS') . ''
                . ' OxiAddonsOH-SX-I-C |' . sanitize_hex_color($_POST['OxiAddonsOH-SX-I-C']) . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsOH-SX-I-M') . ''
                ...
                . '||#||'
                . 'OxiAddonsOH-SX-I ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonsOH-SX-I']) . '||#|| '
                . ' ||#||';
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_border('OxiAddonsOH-SX-CB-B', $styledata[171], $styledata[172], 'Border Bottom', 'Set your Content Body Border Bottom Size and Type', 'true', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-content');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsOH-SX-CB-BC', $styledata[175], '', 'Border Color', 'Set Your Content Body Border Color', 'false', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-content', 'border-color');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsOH-SX-CB-P', 177, $styledata, '1', 'Padding', 'Set your Content Body Padding', 'true', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-content', 'padding');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('OxiAddonsOH-SX-I', $stylefiles[2], 'Icon Class', 'Set Your Icon Class', 'false');
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsOH-SX-I-FS', $styledata[149], $styledata[150], $styledata[151], '1', 'Icon Size', 'Set Your Icon Size', 'true', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-icon .oxi-icons', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsOH-SX-I-C', $styledata[153], '', 'Color', 'Set Your Icon Color', 'false', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-icon .oxi-icons', 'color');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsOH-SX-I-M', 155, $styledata, '1', 'Margin', 'Set Your Icon Margin', 'true', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-icon .oxi-icons', 'margin');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsOH-SX-H-FS', $styledata[89], $styledata[90], $styledata[91], '1', 'Font Size', 'Set Your Day Font Size', 'true', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-heading-text', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsOH-SX-H-C', $styledata[93], '', 'Color', 'Set Your Day Font Color', 'false', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-heading-text', 'color');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                         echo oxi_addons_adm_help_number_dtm('OxiAddonsOH-SX-D-FS', $styledata[117], $styledata[118], $styledata[119], 1, 'Font Size', 'Set Your Time Font Size', 'true', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-date', 'font-size');
                                         echo oxi_addons_adm_help_MiniColor('OxiAddonsOH-SX-D-C', $styledata[121], '', 'Color', 'Set Your Time Color', 'false', '.oxi-addonsOH-SX-wrapper-' . $oxiid . ' .oxi-addonsOH-SX-date', 'color');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_opening_hours_style_6_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
