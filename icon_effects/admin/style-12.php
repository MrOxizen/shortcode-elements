        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-icon-border-color', $styledata[33], '', 'Border Color', 'Select Your Icon Border Color', '', '.oxi-addons-container .oxi-icon-' . $oxiid . '', 'box-shadow');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_icon_effects_style_12_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
