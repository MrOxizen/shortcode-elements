...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddCB-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsDataTable-TB-icon-f') . ''
                . ' OxiAddonsDataTable-TB-icon-color |' . sanitize_hex_color($_POST['OxiAddonsDataTable-TB-icon-color']) . '|'
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsDataTable-TB-width') . ''
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsDataTable-TB-height') . ''
                . ' OxiAddonsDataTable-TB-height-type |' . sanitize_text_field($_POST['OxiAddonsDataTable-TB-height-type']) . '|'
                . '||#||'
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        foreach ($oxicatarray as $value) {
            ...
            $catddtt .= '{{||}}';
            $catddtt .= OxiAddonsADMHelpTextSenitize($_POST[OxiStringToClassReplacce($value) . '-SelectType']);
            $catddtt .= '||type||';
            $catddtt .= OxiAddonsAdminUrlConvert($_POST[OxiStringToClassReplacce($value) . '-image']);
            $catddtt .= '||type||';
            $catddtt .= OxiAddonsAdminFontAwesomeSenitize($_POST[OxiStringToClassReplacce($value) . '-icon']);
            $catddtt .= '||type||';
            $catddtt .= OxiAddonsADMHelpTextSenitize($_POST[OxiStringToClassReplacce($value) . '-text']);
            $catddtt .= '{{}}';
        }
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsDataTable-TH-DI-C', $styledata[111], '', 'Color', 'Set Datatable Descending Icon color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' table.dataTable thead .sorting:before', 'color');
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsDataTable-TB-icon-f', $styledata[567], $styledata[568], $styledata[569], '1', 'Font Size', 'Set Datatable Body Icon Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-table-icon .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsDataTable-TB-icon-color', $styledata[571], '', 'Color', 'Set Datatable Body Icon color', 'false', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-table-icon .oxi-icons', 'color');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Image Setting
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsDataTable-TB-width', $styledata[573], $styledata[574], $styledata[575], '1', 'Max-Width', 'Set Datatable Body Image Width', 'false', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-table-image', 'max-width');
                                            echo oxi_addons_adm_help_true_false('OxiAddonsDataTable-TB-height-type', $styledata[581], 'Manual', 'true', 'Auto', 'false', 'Height Type', 'Set Datatable Image Height Auto Or Manual', 'false');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsDataTable-TB-height', $styledata[577], $styledata[578], $styledata[579], '1', 'Height', 'Set Datatable Body Image height', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-table-image', 'height');
                                            ?>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_data_table_style_2_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="oxi-addons-list-data-modal">
    <form method="post" id="oxi-data-table-data">
                ...
                <div class="modal-body">
                    ...
                    if ($stylefiles[2] != '') {
                        ...
                        foreach ($serialize as $key => $value) {
                            if (strlen($listarray[OxiStringToClassReplacce($value)]) > 24) {
                                $tablefulldata = explode("||type||", $listarray[OxiStringToClassReplacce($value)]);
                            } else {
                                $tablefulldata = array('name', '', '', '');
                            }

                            if (!empty($value)) {
                                ?>
                                <div class="oxi-addons-modal-style-<?php echo $key ?>">
                                    <div class="oxi-addons-head-value-<?php echo $key ?>">
                                        <?php
                                        echo OxiAddonsTextConvert($value) . ':';
                                        ?>
                                    </div>
                                    <div class="oxi-addons-body-type-<?php echo $key ?>">
                                        <div class="form-group row">
                                            <label for="type" class="col-sm-2 col-form-label col-form-label-sm">Type</label>
                                            <div class="col-sm-10">
                                                <select class="form-control form-control-sm" id="oxi-type-<?php echo $key ?>" name="<?php echo OxiStringToClassReplacce($value); ?>-SelectType">
                                    ...
                                    <div class="oxi-addons-rendom-<?php echo $key ?>">
                                        <div class="upload-image-<?php echo $key ?>">
                                            <div class=" form-group row">
                                                <div class="col-sm-8">
                                                    <input type="text " class="form-control oxi-image-<?php echo $key ?>" style="padding-right: 4px; padding-left: 4px;" id="<?php echo OxiStringToClassReplacce($value) ?>-image" name="<?php echo OxiStringToClassReplacce($value) ?>-image" value="<?php echo $tablefulldata[1]; ?>">
                                                </div>
                                                <div class="col-sm-4 addons-dtm-laptop-lock">
                                                    <button type="button" oxiimage="#<?php echo OxiStringToClassReplacce($value); ?>-image" class="oxi-addons-body-image-button btn btn-default">Upload</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="upload-icon-<?php echo $key ?>">
                                            <div class="form-group">
                                                <input type="text" class="form-control oxi-icon-<?php echo $key ?>"  name="<?php echo OxiStringToClassReplacce($value) ?>-icon" id="<?php echo OxiStringToClassReplacce($value) ?>-icon" value="<?php echo $tablefulldata[2]; ?>" placeholder="font-awesome Icon">
                                            </div>
                                        </div>
                                        <div class="upload-name-<?php echo $key ?>">
                                            <div class="form-group">
                                                <input type="text" class="form-control oxi-name-<?php echo $key ?>" name="<?php echo OxiStringToClassReplacce($value) ?>-text" id="<?php echo OxiStringToClassReplacce($value) ?>-text" value="<?php echo $tablefulldata[3]; ?>" placeholder="Name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                $jquery = ' 
                                    ...
                                    jQuery("#oxi-data-table-data").submit(function () {
                                        jQuery("#oxi-data-table-data *").removeAttr("disabled");
                                        return true;
                                    });
                                    var value = "' . $tablefulldata[0] . '";
                                        
                                    jQuery("#oxi-type-' . $key . ' option[value=\'' . $tablefulldata[0] . '\']").attr("selected","selected");

                                     if(value == "image"){
                                        jQuery(".upload-image-' . $key . '").show();
                                        jQuery(".upload-icon-' . $key . '").hide();
                                        jQuery(".upload-name-' . $key . '").hide();
                                        jQuery(".oxi-image-' . $key . '").attr("disabled", false);
                                        jQuery(".oxi-name-' . $key . '").attr("disabled", true);
                                        jQuery(".oxi-icon-' . $key . '").attr("disabled", true);

                                     }else if(value == "icon"){
                                       jQuery(".upload-image-' . $key . '").hide();
                                        jQuery(".upload-icon-' . $key . '").show();
                                       jQuery(".upload-name-' . $key . '").hide();
                                           
                                        jQuery(".oxi-image-' . $key . '").attr("disabled", true);
                                        jQuery(".oxi-name-' . $key . '").attr("disabled", true);
                                        jQuery(".oxi-icon-' . $key . '").attr("disabled", false);
                                            
                                     }else if(value == "name"){
                                       jQuery(".upload-image-' . $key . '").hide();
                                       jQuery(".upload-icon-' . $key . '").hide();
                                       jQuery(".upload-name-' . $key . '").show();
                                           
                                       jQuery(".oxi-name-' . $key . '").attr("disabled", false);
                                       jQuery(".oxi-icon-' . $key . '").attr("disabled", true);
                                       jQuery(".oxi-icon-' . $key . '").attr("disabled", true);
                                     } 
                                    jQuery("#oxi-type-' . $key . '").change(function(){
                                        var value = jQuery(this,":selected").val();
                                         if(value == "image"){
                                            jQuery(".upload-image-' . $key . '").show();
                                            jQuery(".upload-icon-' . $key . '").hide();
                                            jQuery(".upload-name-' . $key . '").hide();
                    ...
                    ';
                                $custom = '
                    .oxi-addons-modal-style-' . $key . '{
                    display:flex;
                    justify-content: space-between;
                    }
                    .oxi-addons-head-value-' . $key . '{
                    display: flex;
                    flex: 0.3;
                    }
                    .oxi-addons-rendom-' . $key . '{
                    display: flex;
                    flex: 0.5;
                    padding: 0px 32px;
                    }
                    ...
                    ';
                                wp_add_inline_style('oxi-addons', $custom);
