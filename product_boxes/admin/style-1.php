                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpItemPerRows('OxiAddonsProductBoxes-rows', $styledata, 3, 'false', '.oxi-addons-parent-wrapper-' . $oxiid . '');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsProductBoxes-pb-bg', $styledata[238], 'rgba', 'Background Color', 'Set Product Boxes Heading One Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . '  .oxi-addons-image-overlay::after', 'background');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsProductBoxes-pb-width', $styledata[246], $styledata[247], $styledata[248], '1', 'Width', 'Set Product Boxes Max Width', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-image-overlay', 'max-width');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsProductBoxes-G-M', 23, $styledata, 1, 'Margin', 'Set Yout Product Boxes Margin', 'true', '.oxi-addons-parent-wrapper-' . $oxiid . '', 'padding');
                                            ?>
                                        </div>                                               
                                    </div>                                            
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsProductBoxes-O-H-FS', $styledata[50], $styledata[51], $styledata[52], '1', 'Font Size', 'Set Product Boxes Heading One Font Size', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper .oxi-addons-heading-one.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper .oxi-addons-heading-one.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper .oxi-addons-heading-one', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsProductBoxes-O-H-C', $styledata[60], '', 'Color', 'Set Product Boxes Heading One Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper .oxi-addons-heading-one', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsProductBoxes-O-H-F', 54, $styledata, 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper .oxi-addons-heading-one');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsProductBoxes-T-H-F', 87, $styledata, 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-wrapper .oxi-addons-heading-two');
