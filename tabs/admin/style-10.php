...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsTabs-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsTabs-H-padding-top |' . sanitize_text_field($_POST['OxiAddonsTabs-H-padding-top']) . '|'
            . ' OxiAddonsTabs-H-padding-bottom |' . sanitize_text_field($_POST['OxiAddonsTabs-H-padding-bottom']) . '|'
            . '||#||'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_double_dtm('OxiAddonsTabs-Line-W', $styledata[222], $styledata[223], $styledata[224], 'OxiAddonsTabs-Line-H', $styledata[226], $styledata[227], $styledata[228], 1, 'Width Height Line', 'Set Tabs Header Line width and height', 'false');
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddonsTabs-H-padding-top', $styledata[232], 1, 'Padding Top Mobile', 'Set Your Padding Top For Mobile', true);
                                            echo oxi_addons_adm_help_number('OxiAddonsTabs-H-padding-bottom', $styledata[234], 1, 'Padding Bottom Mobile', 'Set Your Padding Top For Mobile', true);
                                            ?>
                                        </div>
                                        <div class="oxi-head">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_tabs_style_10_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
