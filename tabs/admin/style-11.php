...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsTabs-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsTabs-H-line-H |' . sanitize_text_field($_POST['OxiAddonsTabs-H-line-H']) . '|'
            . '||#||'
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = ' OxiAddonsTabs-heading-text ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsTabs-heading-text']) . '||#||'
            ...
            . 'OxiAddonsTabs-color ||#||' . sanitize_hex_color($_POST['OxiAddonsTabs-color']) . '||#||'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number('OxiAddonsTabs-H-line-H', $styledata[212], '1', 'Line Height', 'Set Tab Heading Top Line Height', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header-two::before', 'height');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_tabs_style_11_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_MiniColor('OxiAddonsTabs-color', $listitemdata[9], '', 'Color', 'Set Tabs Header line color', 'false');
