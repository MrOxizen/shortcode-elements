...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsTabs-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' ||'
            . ' OxiAddonsTabs-active-Border-bottom |' . sanitize_text_field($_POST['OxiAddonsTabs-active-Border-bottom']) . '|'
            . '||#||'
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddonsTabs-active-Border-bottom', $styledata[210], '', 'Border Bottom', 'Set Tab Heading Active Border Bottom', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-header', 'border-bottom-width');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_tabs_style_18_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
