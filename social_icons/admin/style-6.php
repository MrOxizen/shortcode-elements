...
$listitemdata = array('', '', '', '', '', '#0075a3', '', '#7e00c2', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
$listid = '';
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-width', $styledata[7], $styledata[8], $styledata[9], 1, 'Width Height', 'Your Icon Width with Responsive Size', 'true', '');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiADDSIC-margin', 13, $styledata, 1, 'Margin', 'Set Your Icon Margin Top Bottom and Left Right', 'false', '.oxi-addons-social-' . $oxiid . '','padding');
                                        ?>
                                    </div>                                               
                                </div>                                            
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiADDSIC-size', $styledata[33], $styledata[34], $styledata[35], 1, 'Font Size', 'Your Icon Font Size', '', '.oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . ' .oxi-icons', 'font-size');
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('OxiADDSIC-color', $styledata[39], '', 'Color', 'Select Your Icon Color', '', '');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('OxiADDSIC-H-color', $styledata[43], '', 'Color', 'Select Your Icon Hover Color', '', '.oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . ':hover .oxi-icons');
                                        ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_social_icons_style_6_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
