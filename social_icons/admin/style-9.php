...
$listitemdata = array('', '', '', '', '', '#7700c7', '', '#ffffff', '', 'rgba(119, 0, 199, 1)', '', 'rgba(92,92,92,1.00)', '', '#7700c7', '', '#7700c7');
$listid = '';
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-social-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_single_size('OxiADDSIC-border') . ''
                . '' . OxiAddonsADMHelpBorderSanitize('OxiADDSIC-border') . '|'
                . '' . oxi_addons_adm_help_single_size('OxiADDSIC-radius') . ''
                . ' OxiADDSIC-H-bgcolor-view |' . sanitize_text_field($_POST['OxiADDSIC-H-bgcolor-view']) . '|'
                . ' OxiADDSIC-H-bgcolor |' . sanitize_text_field($_POST['OxiADDSIC-H-bgcolor']) . '|'
                ...
                . ' OxiADDSIC-border-view |' . sanitize_text_field($_POST['OxiADDSIC-border-view']) . '|'
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = 'OxiADDSIC-Icon-Class||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiADDSIC-Icon-Class']) . '||#||'
                ...
                . 'OxiADDSIC-SP-H-icon-bgcolor||#||' . sanitize_textarea_field($_POST['OxiADDSIC-SP-H-icon-bgcolor']) . '||#||'
                . 'OxiADDSIC-SP-border-color||#||' . sanitize_textarea_field($_POST['OxiADDSIC-SP-border-color']) . '||#||'
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiADDSIC-margin', 13, $styledata, 1, 'Margin', 'Set Your Icon Margin Top Bottom and Left Right', 'we', '.oxi-addons-social-' . $oxiid . '', 'padding');
                                        ?>
                                    </div>                                               
                                </div>                                            
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_true_false('OxiADDSIC-border-view', $styledata[79], 'Separately', '', 'Common', 'common', 'Border View', 'Select your color view as added separately or select same Color at all Icons', 'true');
                                        echo oxi_addons_adm_help_number_dtm('OxiADDSIC-border', $styledata[51], $styledata[52], $styledata[53], 1, 'Border', 'Set your border', 'true', '');
                                        echo OxiAddonsADMhelpBorder('OxiADDSIC-border', 55, $styledata, '');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_true_false('OxiADDSIC-H-bgcolor-view', $styledata[63], 'Separately', '', 'Common', 'common', 'Background View', 'Select your color view as added separately or select same Color at all Icons', 'true');
                                        echo oxi_addons_adm_help_MiniColor('OxiADDSIC-H-bgcolor', $styledata[65], 'rgba', 'Background', 'Select Your Icon Color', '', '');
                                        ...
                                        $nojs = array(
                                            array('OxiADDSIC-bgcolor', 'Background Color'),
                                            array('OxiADDSIC-border', 'Border'),
                                            array('OxiADDSIC-border-type', 'Border Type'),
                                            array('OxiADDSIC-border-color', 'Border Color'),
                                            array('OxiADDSIC-H-bgcolor', 'Hover Background'),
                                            array('OxiADDSIC-H-border', 'Hover Border'),
                                            array('OxiADDSIC-H-border-type', 'Hover Border Type'),
                                            array('OxiADDSIC-H-border-color', 'Hover Border Color'),
                                        );
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_social_icons_style_9_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    if ($styledata[47] == '') {
                        echo oxi_addons_adm_help_MiniColor('OxiADDSIC-SP-icon-bgcolor', $listitemdata[9], 'rgba', 'Background', 'Select Your Icon Color', '', '');
                    } else {
                        OxiAddonsADMHelpInputHidden('OxiADDSIC-SP-icon-bgcolor', $listitemdata[9]);
                    }
                    if ($styledata[63] == '') {
                        echo oxi_addons_adm_help_MiniColor('OxiADDSIC-SP-H-icon-bgcolor', $listitemdata[11], 'rgba', 'Hover Background', 'Select Your Icon Color', '', '');
                    } else {
                        OxiAddonsADMHelpInputHidden('OxiADDSIC-SP-H-icon-bgcolor', $listitemdata[11]);
                    }
                    if ($styledata[79] == '') {
                        echo oxi_addons_adm_help_MiniColor('OxiADDSIC-SP-border-color', $listitemdata[13], '', 'Border', 'Select Your Icon Color', '', '');
                    } else {
                        OxiAddonsADMHelpInputHidden('OxiADDSIC-SP-border-color', $listitemdata[13]);
                    }
                    if ($styledata[81] == '') {
