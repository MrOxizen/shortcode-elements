...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
	if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
		...
		$data = 'oxi-tt-sc-textarea ||#||' . OxiAddonsADMHelpTextSenitize($_POST['oxi-tt-sc-textarea']) . '||#|| '
				. 'oxi-tt-hover-text ||#||' . sanitize_text_field($_POST['oxi-tt-hover-text']) . '||#|| '
				.'oxi-tt-sc-link ||#||' . OxiAddonsAdminUrlConvert($_POST['oxi-tt-sc-link']) . '||#|| ';
		$data = sanitize_text_field($data);
		if ($oxilistid > 0) {
		...
		<div class="oxi-addons-row">
			...
			<div class="oxi-addons-style-left-preview">
				...
				<div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
					<?php echo oxi_tooltip_style_3_shortcode($style, $listdata, 'admin'); ?>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<?php
					echo oxi_addons_adm_help_form_textarea('oxi-tt-sc-textarea', $listitemdata[1],'Shortcode ', 'Place your Shortcode Here', 'false');
					echo oxi_addons_adm_help_textbox('oxi-tt-sc-link', $listitemdata[5], 'Link', 'Set Your Tooltip Link', 'false');
