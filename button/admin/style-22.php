...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . ' oxi_addons-button-hover-icon-bg-color |' . sanitize_text_field($_POST['oxi_addons-button-hover-icon-bg-color']) . '|'
                . '' . OxiAddonsADMHelpBorderSanitize('oxi_addons_button_hover-CS') . '|'
                . '' . oxi_addons_adm_help_single_size('oxi_addons-icon-font-size') . ''
                . '' . oxi_addons_adm_help_single_size('oxi_addons-icon-transletX') . ''
                                        ...
                                        <div class=" form-group row">
                                            ...
                                            <div class="col-sm-6 addons-dtm-laptop-lock">
                                                <select class="form-control" id="oxi-addons-icon-position" name="oxi-addons-icon-position">
                                                    <option value="1" <?php selected( $styledata[5], 1 ); ?>>Left</option>
                                                    <option value="2" <?php selected( $styledata[5], 2 ); ?>>Right</option>
                                                </select>
                                            </div>
                                        </div>
                                        <?php
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-icon-transletX', $styledata[205], $styledata[206], $styledata[207], 1, 'Translate X', 'Customize the text hover position with Translate X', '', '.oxi-button-' . $oxiid . ':hover .oxi-btn-txt', 'transform');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-icon-color', $styledata[137], '', 'Color', 'Customize your icon active color', '', '.oxi-addons-align-' . $oxiid . ' .oxi-btn-bg-round', 'color');
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-icon-color', $styledata[193], '', 'Color', 'Customize icon hover  color', '', '.oxi-button-' . $oxiid . ':hover .oxi-btn-bg-round', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-icon-bg-color', $styledata[195], 'rgba', 'Background Color', 'Customize the Button Hover Background color, either in gradient or solid color mode', '', '.oxi-button-' . $oxiid . ':hover .oxi-btn-bg-round', 'background');
                                        echo OxiAddonsADMhelpBorder('oxi_addons_button_hover-CS', 197, $styledata, 'true', '.oxi-button-' . $oxiid . ':hover .oxi-btn-bg-round');
                                        ?>
                                    </div>
                                </div>   
                            </div>
