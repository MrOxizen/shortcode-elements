...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data =  'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                .'oxi_addons-text-color |' . sanitize_hex_color($_POST['oxi_addons-text-color']) . '|' 
                .'oxi_addons-text-hover-color |' .sanitize_hex_color($_POST['oxi_addons-text-hover-color']) . '|' 
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('oxi_addons-button-text', $stylefiles[3], 'Button Text', 'Write the text for the button here', 'false','.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .'');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-bg-color', $styledata[5], 'rgba', 'Background Color', 'Customize the Button Active Background color, either in gradient or solid color mode', '', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .'', 'background');
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-button-width', $styledata[205], $styledata[206], $styledata[207], 1, 'Width', 'Customize the button width with Responsive Size', 'fales', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .'', 'width');                                        
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-border-W', 9, $styledata, 1, 'Border', 'Set your active button Border with size and different style', 'true', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .'', 'border-width');
                                        echo OxiAddonsADMhelpBorder('oxi-addons-button-border-SC', 25, $styledata, 'fales', '.oxi-addons-button-body-' . $oxiid . ' .oxi-addons-align');
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-border-radius-all',137, $styledata, 1, 'Border Radius', 'Set border radius. 0 value for angular border, 50 for rounded', 'true', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .'', 'border-radius');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-margin', 47, $styledata, 1, 'Margin', 'Customize button margin either Easy or Advance mode', 'true', '.oxi-addons-button-body-' . $oxiid . '', 'padding');
                                        ?>
                                    </div>
                                    <div class="oxi-head">
                                        Hover Setting
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-hover-bg-color', $styledata[7], 'rgba', 'Background Color', 'Customize the Button Active Background color, either in gradient or solid color mode', '', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover .oxi-button-'. $oxiid .'', 'background');
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-hover-border-W', 155, $styledata, 1, 'Border', 'Set your active button Border with size and different style', 'true', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover .oxi-button-'. $oxiid .'', 'border-width');
                                        echo OxiAddonsADMhelpBorder('oxi-addons-button-hover-border-SC', 171, $styledata, 'fales', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover .oxi-button-'. $oxiid .'');
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-hover-border-radius-all',175, $styledata, 1, 'Border Radius', 'Set border radius. 0 value for angular border, 50 for rounded', 'true', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover .oxi-button-'. $oxiid .'', 'border-radius');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-text-hover-color', $styledata[69], '', 'Hover Color', 'Customize the Button active color', '', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover .oxi-button-text', 'color');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-icon-color', $styledata[97], '', 'Color', 'Select Your Icon Color', '', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-icon', 'color');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-icon-hover-color', $styledata[99], '', 'Hover Color', 'Select Your Icon Color', '', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover .oxi-button-icon', 'color');
                                ...
                                <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddButton-button-shadow', 191, $styledata, 'true', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .'');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Hover Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddButton-button-hover-shadow', 197, $styledata, 'true', '.oxi-addons-button-body-' . $oxiid . ' .oxi-button-'. $oxiid .':hover');
                                            ?>
                                        </div>
                                    </div>
                            </div>
