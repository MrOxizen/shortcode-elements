    ...
    if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
        ...
        $data = 'oxi_addons-button-link-opening |' . sanitize_text_field($_POST['oxi_addons-button-link-opening']) . '|'
               ...
               . '' . OxiAddonsADMHelpFontSettingsSanitize('oxi_addons-button-f') . ''
                ...
                . ' oxi-addons-button-hover-border||' . sanitize_text_field($_POST['oxi-addons-button-hover-border-type']) . '|' 
                . sanitize_hex_color($_POST['oxi-addons-button-hover-border-color']) . '|'
                ...
                . '||||||||'
                . '||||||||'
                . ' oxi_addons-button-icon-pisition |' . sanitize_text_field($_POST['oxi_addons-button-icon-pisition']) . '|'
                . ' oxi-addons-button-icon-distance |' . sanitize_text_field($_POST['oxi-addons-button-icon-distance']) . '|'
                ...
                . ' oxi_addons-button-icon-transform |' . sanitize_text_field($_POST['oxi_addons-button-icon-transform']) . '|'
                . '||#||  ||#||'
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('oxi-addons-button-border', 83, $styledata, 1, 'Border', 'Set your active button Border with size and different style', 'true', '.oxi-addons-container .oxi-button-' . $oxiid . '', 'border-width');
                                        echo OxiAddonsADMhelpBorder('oxi-addons-button-border', 38, $styledata, 'true', '.oxi-addons-container .oxi-button-' . $oxiid . '');
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo OxiAddonsADMhelpBorder('oxi-addons-button-hover-border', 48, $styledata, 'true', '.oxi-addons-container .oxi-button-' . $oxiid . ':hover, .oxi-addons-container .oxi-button-' . $oxiid . ':focus, .oxi-addons-container  .oxi-button-' . $oxiid . ':active');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_true_false('oxi_addons-button-icon-pisition', $styledata[115], 'Left', 'left', 'Right', 'right', 'Icon Position', 'Customize your icon Position');
                                        echo oxi_addons_adm_help_number('oxi-addons-button-icon-distance', $styledata[117], '1', 'Icon Distance', 'Set Icon Distance from Text Based on Pixel', '', '');
                                        echo oxi_addons_adm_help_MiniColor('oxi_addons-button-icon-color', $styledata[119], '', 'Color', 'Select Your Icon Color', 'true', '.oxi-addons-container .oxi-button-' . $oxiid . ' .oxi-icons', 'color');
                                        echo oxi_addons_adm_help_number_dtm('oxi_addons-button-icon-size', $styledata[121], $styledata[122], $styledata[123], 1, 'Icon Size', 'Your Button Icon Size', '', '.oxi-addons-container .oxi-button-' . $oxiid . ' .oxi-icons', 'font-size');
                                        OxiAddonsTransformProperty('oxi_addons-button-icon-transform', $styledata[125], 'Viewing Animaton', 'Select Viewing Animation of Icon', 'true', '.oxi-button-' . $oxiid . '')
                                        ?>
                                    </div>                                                
                                </div>
                            </div>
