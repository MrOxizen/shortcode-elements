...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-heading-nonce')) {
        ...
        $data = '||'
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('oxi-addons-heading-line-width') . ''
                . '' . oxi_addons_adm_help_number_dtm_senitize('oxi-addons-heading-line-height') . ''
                . '||||||||||||||'
                . '||#||'.'||#||'
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            <div class="oxi-addons-content-div-body">
                                                ...
                                                echo oxi_addons_adm_help_number_double_dtm('oxi-addons-heading-line-width', $styledata[107],$styledata[108],$styledata[109], 'oxi-addons-heading-line-height', $styledata[111],$styledata[112],$styledata[113], 1, 'Line Width & Height', 'set line width and heigst', 'true') ;
                                                echo oxi_addons_adm_help_MiniColor('oxi-addons-heading-line-color', $styledata[105], 'rgba', 'Line Color', 'Set line color ', 'true');
                                               ?>
                                            </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6"> 
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('oxi-addons-content-padding', 79, $styledata, 1, 'Padding', 'Set padding for content', 'true','.oxi-addons-Content-body-'.$oxiid.'  .oxi-addons-Content-text','padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
