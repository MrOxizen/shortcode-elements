...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    ...
    $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . oxi_addons_adm_help_single_size('oxi-call-middle-line-width')
            . oxi_addons_adm_help_single_size('oxi-call-middle-line-height')
            . 'oxi-call-middle-line-color |' . sanitize_hex_color($_POST['oxi-call-middle-line-color']) . '|'
            . oxi_addons_adm_help_padding_margin_senitize('oxi-call-full-border-radius')
            . 'oxi-call-middle-line-on-off |' . sanitize_text_field($_POST['oxi-call-middle-line-on-off']) . '|'
            . '||#||'
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" >
                            ...
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_MiniColor('oxi-call-button-H-color', $styledata[19], '', 'Color', 'Set Your Button Hover Color', 'false', '.oxi-addons-call-to-action-' . $oxiid . ' .oxi-addons-call-to-action-button-section a.oxi-addons-call-to-action-button:hover', 'color');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_true_false('oxi-call-middle-line-on-off', $styledata[283], 'On', 'on', 'Off', 'off', 'Line On / Off', 'Set the Middle Line On / Off', 'true');
                                        echo oxi_addons_adm_help_number_double_dtm('oxi-call-middle-line-width', $styledata[257], $styledata[258], $styledata[259], 'oxi-call-middle-line-height', $styledata[261], $styledata[262], $styledata[263], 1, 'Line Width & Height', 'Set Your Content Middle Line Width And Height', 'false');
                                        echo oxi_addons_adm_help_MiniColor('oxi-call-middle-line-color', $styledata[265], '', 'Line Color', 'Set Your Line Color', 'false', '.oxi-addons-call-to-action-' . $oxiid . '  .oxi-addons-call-to-action-full-content:after', 'background');
                                        $NOJS = array(
                                            array('oxi-call-middle-line-width', 'Width'),
                                            array('oxi-call-middle-line-height', 'Height'),
                                        );
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_call_to_action_style_5_shortcode($style); ?>
                </div>
            </div>
        </div>
    </div>
