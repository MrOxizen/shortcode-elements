 ...
 */
function oxi_carousel_style_4_shortcode($styledata = FALSE, $listdata = array(), $user = 'user') {
    ...
    $jquery = 'jQuery(".oxi-addons-carousel-' . $oxiid . '").OxiAddowlCarousel({
                    ...
                    responsive: {
                        0: {
                            merge:false,
                            items: ' . OxiAddonscolReplacecarousel4($styledata[5]) . '
                        },
                        668: {
                            merge:false,
                            items: ' . OxiAddonscolReplacecarousel4($styledata[4]) . '
                        },
                        1000: {
                            merge:' . $styledata[233] . ',
                            items: ' . OxiAddonscolReplacecarousel4($styledata[3]) . '
                        }
                    }
                });
               ' . $eualdata . '';
...
function OxiAddonscolReplacecarousel4($data) {
