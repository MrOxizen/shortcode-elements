 ...
 */
function oxi_carousel_style_2_shortcode($styledata = FALSE, $listdata = array(), $user = 'user') {
    ...
    $jquery = 'jQuery(".oxi-addons-carousel-' . $oxiid . '").OxiAddowlCarousel({
                    ...
                    responsive: {
                        0: {
                            merge:false,
                            items: ' . OxiAddonscolReplacecarousel2($styledata[5]) . '
                        },
                        668: {
                            merge:false,
                            items: ' . OxiAddonscolReplacecarousel2($styledata[4]) . '
                        },
                        1000: {
                            merge:' . $styledata[233] . ',
                            items: ' . OxiAddonscolReplacecarousel2($styledata[3]) . '
                        }
                    }
                });
               ' . $eualdata . '';
...
function OxiAddonscolReplacecarousel2($data) {
