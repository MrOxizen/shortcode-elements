 ...
 */
function oxi_carousel_style_3_shortcode($styledata = FALSE, $listdata = array(), $user = 'user') {
    ...
    $jquery = 'jQuery(".oxi-addons-carousel-' . $oxiid . '").OxiAddowlCarousel({
                    ...
                    responsive: {
                        0: {
                            merge:false,
                            items: ' . OxiAddonscolReplacecarousel3($styledata[5]) . '
                        },
                        668: {
                            merge:false,
                            items: ' . OxiAddonscolReplacecarousel3($styledata[4]) . '
                        },
                        1000: {
                            merge:' . $styledata[233] . ',
                            items: ' . OxiAddonscolReplacecarousel3($styledata[3]) . '
                        }
                    }
                });
               ' . $eualdata . '';
...
function OxiAddonscolReplacecarousel3($data) {
