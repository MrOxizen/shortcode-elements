        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php 
                                                echo oxi_addons_adm_help_Text_Align('OxiAddInfoBanner-G-PS', $styledata[3], 'Position Reverse', 'Set Your Front Image Position', 'false');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php 
                                                echo oxi_addons_adm_help_body_image_upload('OxiAddInfoBanner-frontIMG', $styledata[25], 'Front Image', 'Set Your top Front Image ', 'false'); 
                                                echo oxi_addons_adm_help_padding_margin('OxiAddInfoBanner-padding', 33, $styledata, 1, 'Padding', 'Set Your Content Boxes Padding', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-image-body', 'padding');
                                             ?>
                                        </div> 
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_banner_style_7_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo oxi_addons_adm_help_textbox('OxiAddonsInfoBanner-H-TB', $listitemdata[1], 'Heading Two', 'Write Info Banner Heading', 'false');
                    echo oxi_addons_adm_help_form_textarea('OxiAddonsInfoBanner-SD-TA', $listitemdata[3],'Short Details', 'Write Your Short Details','false'); 
