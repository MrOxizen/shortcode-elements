        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-icon-width', $styledata[227], $styledata[228], $styledata[229], 1, 'Width', 'Select Your Icon Width And Height', 'true');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_banner_style_2_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
