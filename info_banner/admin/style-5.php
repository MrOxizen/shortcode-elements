        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-icon-width', $styledata[271], $styledata[272], $styledata[273], 1, 'Width', 'Select Your Icon Width And Height', 'true');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsInfoBanner-H-TB', $stylefiles[2], 'Heading ', 'Set Banner Heading', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-content-boxes-heading');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-heading-size', $styledata[115], $styledata[116], $styledata[117], 1, 'Font Size', 'Select Your Heading Font Size', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-content-boxes-heading', 'font-size');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textarea('OxiAddonsInfoBanner-SD-TA', $stylefiles[4], 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-content-boxes-content');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfoBanner-content-size', $styledata[143], $styledata[144], $styledata[145], 1, 'Font Size', 'Select Your Content Font Size', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-content-boxes-content', 'font-size');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_banner_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
