...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-post-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsDP-arrow-size |' . sanitize_text_field($_POST['OxiAddonsDP-arrow-size']) . '|'
            . ' OxiAddonsDP-bullet-PS |' . sanitize_text_field($_POST['OxiAddonsDP-bullet-PS']) . '|'
            . ' OxiAddonsDP-bullet-BG |' . sanitize_text_field($_POST['OxiAddonsDP-bullet-BG']) . '|'
            . ' OxiAddonsDP-bullet-W |' . sanitize_text_field($_POST['OxiAddonsDP-bullet-W']) . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsDP-bullet-BR') . ''
            . '' . OxiAddonsADMBoxShadowSanitize('OxiAddonsDP-bullet-box-shadow') . ''
            . ' OxiAddonsDP-Divider-BG |' . sanitize_text_field($_POST['OxiAddonsDP-Divider-BG']) . '|'
            . ' OxiAddonsDP-Divider-W |' . sanitize_text_field($_POST['OxiAddonsDP-Divider-W']) . '|'
            . '|||'
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number('OxiAddonsDP-arrow-size', $styledata[345], 1, 'Arrow Size', 'Set Timeline post Arrow size');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number('OxiAddonsDP-bullet-PS', $styledata[347], 1, 'Bullet Position', 'Set Timeline post Bullet Position From Top');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsDP-bullet-BG', $styledata[349], 'rgba', 'Background', 'Select Your Content box Background Color', '', '.oxi-addons__main-wrapper-' . $oxiid . ' .oxi-addons__wrapper', 'background');
                                            echo oxi_addons_adm_help_number('OxiAddonsDP-bullet-W', $styledata[351], 1, 'Width Height', 'Set Bullet Width and height', 'true');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsDP-bullet-BR', 353, $styledata, 1, 'Border Radius', 'Set Post Meta Image Radius', 'true', '.oxi-addons__main-wrapper-' . $oxiid . ' .oxi-addons__meta-left > .oxi-addons__avater', 'border-radius');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Bullet Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsDP-bullet-box-shadow', 369, $styledata, 'true', '');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsDP-Divider-BG', $styledata[375], 'rgba', 'Background', 'Select Your Content box Background Color', '', '.oxi-addons__main-wrapper-' . $oxiid . ' .oxi-addons__wrapper', 'background');
                                            echo oxi_addons_adm_help_number('OxiAddonsDP-Divider-W', $styledata[377], 1, 'Width', 'Set Bullet Width and height', 'true');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
