...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddonsPriceTable-I-C-active |' . sanitize_hex_color($_POST['OxiAddonsPriceTable-I-C-active']) . '|'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsPriceTable-I-P') . ''
            . ' OxiAddonsPriceTable-Image |' . sanitize_text_field($_POST['OxiAddonsPriceTable-Image']) . '|'
            . '||'
            ...
            . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsPriceTable-Image-width') . ''
            . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsPriceTable-Image-height') . ''
            . ' OxiAddonsPriceTable-Image-PS |' . sanitize_text_field($_POST['OxiAddonsPriceTable-Image-PS']) . '|'
            . ' OxiAddonsPriceTable-I-C-deactive |' . sanitize_hex_color($_POST['OxiAddonsPriceTable-I-C-deactive']) . '|'
            . ' OxiAddonsPriceTable-feature-text-deactive |' . sanitize_hex_color($_POST['OxiAddonsPriceTable-feature-text-deactive']) . '|'

            . '||#||'
            . ' OxiAddonsPriceTable-P-TB ||#||' . OxiAddonsADMHelpTextSenitize($_POST['OxiAddonsPriceTable-P-TB']) . '||#|| '
            . ' OxiAddonsPriceTable-I-TA-active ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonsPriceTable-I-TA-active']) . '||#|| '
            ...
            . ' OxiAddonsPriceTable-I-TA-deactive ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonsPriceTable-I-TA-deactive']) . '||#|| '
            . ' ||#||';
...
if (!empty($_POST['OxiAddonsListFile']) && $_POST['OxiAddonsListFile'] == 'Submit') {
    if (!wp_verify_nonce($nonce, 'OxiAddonsListData-nonce')) {
        ...
        $data = '||#||'
            ...
            . ' OxiAddonsPriceTable-feature-active-deactive ||#||' . sanitize_text_field($_POST['OxiAddonsPriceTable-feature-active-deactive']) . '||#|| ';
        if ($oxilistid > 0) {
            $data = sanitize_text_field($data);
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-I-FS', $styledata[106], $styledata[107], $styledata[108], '1', 'Icon Size', 'Set Your Location Icon', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons', 'font-size');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-I-P', 112, $styledata, '1', 'Padding', 'Set Your Icon Padding', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons', 'padding');
                                        ?>
                                    </div>
                                    <div class="oxi-head">
                                        Active Icon
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-I-TA-active', $stylefiles[4], 'Active Icon', 'Write Your Font Awesome Icon class Name', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-I-C-active', $styledata[110], '', 'Icon Color', 'Set Your Icon Font Color', 'false');
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-I-TA-deactive', $stylefiles[14], 'Deactive Icon', 'Write Your Font Awesome Icon class Name', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-li .oxi-icons');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-I-C-deactive', $styledata[322], '', 'Icon Color', 'Set Your Icon Font Color', 'false');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-feature-text-deactive', $styledata[324], '', 'Feature Text color', 'Set Your Feature Text Deactive Color', 'false');
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    <div class="oxi-head">
                                        Price Box Front Image
                                    </div>
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_body_image_upload('OxiAddonsPriceTable-Image', $styledata[128], 'Front Image', 'Upload Your Spacefic Image', 'false');
                                        echo oxi_addons_adm_help_Text_Align('OxiAddonsPriceTable-Image-PS', $styledata[320], 'Position', 'Set Price Table Image Position', 'false', '.oxi-addons-main-wrapper-' . $oxiid . '  .oxi-addons-button', 'text-align');
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-Image-width', $styledata[312], $styledata[313], $styledata[314], '1', 'Max-width', 'Set Price Table Image Width', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'max-width');
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-Image-height', $styledata[316], $styledata[317], $styledata[318], '1', 'Max-height', 'Set Price Table Image Height', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'max-height');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-T-TA', $stylefiles[6], 'Title', 'Write Your Price Table  title', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-title');
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textarea('OxiAddonsPriceTable-SD-TA', $stylefiles[8], 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-details');
                                        echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-SD-FS', $styledata[160], $styledata[161], $styledata[162], '2', 'Font Size', 'Set  Price Table  Title Font Size', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-details', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-SD-C', $styledata[164], '', 'Color', 'Set Price Title Text color', 'false', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-details', 'color');
                                        echo OxiAddonsADMHelpFontSettings('OxiAddonsPriceTable-SD-F', 166, $styledata, 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-details');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-SD-P', 172, $styledata, 1, 'Padding', 'Set  Price Table  Title Padding', 'true', '.oxi-addons-main-wrapper-' . $oxiid . ' .oxi-addons-price-details', 'padding');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-B-BT', $stylefiles[10], 'Button Text', 'Set Price Table Button Text', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link');
                                        echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-B-BL', $stylefiles[12], 'Button Link', 'Set Price Table Button Link', 'false');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_price_table_style_10_shortcode($style, $listdata, 'admin'); ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_true_false('OxiAddonsPriceTable-feature-active-deactive', $listitemdata[4], 'Active', 'true', 'Deactive', 'false', 'Feature Active/Deactive', 'Set Price Table feature Active Deactive', 'false');
