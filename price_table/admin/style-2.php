        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-G-Max-Width', $styledata[351], $styledata[352], $styledata[353], '1', 'Max-Width', 'Set Your Price Table Width', 'false', '.oxi-addons-wrapper-' . $oxiid . '', 'max-width');
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-feature-FS', $styledata[84], $styledata[85], $styledata[86], '1', 'Font Size', 'Set Price Price Table Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-feature', 'font-size');
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-feature-BG', $styledata[98], 'rgba', 'Background color', 'Set Price table Featrue Background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-feature', 'background');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-feature-P', 120, $styledata, 1, 'Padding', 'Set Price Table  Price Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-feature', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-P-FS', $styledata[190], $styledata[191], $styledata[192], '1', 'Font Size', 'Set Price Table Price text Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-P-C', $styledata[200], '', 'Color', 'Set Your Price Table Price Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-P-Second-C', $styledata[202], '', 'Secondary Color', 'Set Your Price Table Price  Secondary Text color. You Need to write Text inside  html span tag', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price span', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsPriceTable-P-F', 194, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-P-P', 204, $styledata, 1, 'Padding', 'Set Price Table  Price Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-T-TA', $stylefiles[12], 'Price', 'Write Your Price Table title', 'false','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-T-FS', $styledata[220], $styledata[221], $styledata[222], '2', 'Font Size', 'Set Price Table Title Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-T-C', $styledata[224], '', 'Color', 'Set Price Table Title Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-T-BG', $styledata[226], 'rgba', 'Background Color', 'Set Price Table Title Background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'background');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsPriceTable-T-F', 228, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-T-P', 234, $styledata, 1, 'Padding', 'Set Price Table Title Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Title Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsPriceTable-T-BS', 250, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title');
                                            ?>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-BC', $styledata[304], '', 'Border Color', 'Set Price Table Border color', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link', 'border-color');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_price_table_style_2_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
