...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsPriceTable-I-width') . ''
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsPriceTable-I-height') . '' 
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiAddonsPriceTable-I-FS') . ''
                . ' OxiAddonsPriceTable-I-TC |' . sanitize_hex_color($_POST['OxiAddonsPriceTable-I-TC']) . '|'
                . ' OxiAddonsPriceTable-I-Bg |' . sanitize_text_field($_POST['OxiAddonsPriceTable-I-Bg']) . '|'
                . '' . OxiAddonsADMHelpBorderSizeType('OxiAddonsPriceTable-I-B') . ''
                . ' OxiAddonsPriceTable-I-BC |' . sanitize_hex_color($_POST['OxiAddonsPriceTable-I-BC']) . '|' 
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsPriceTable-I-P') . '' 
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsPriceTable-I-radius') . ''
                . '' . OxiAddonsADMBoxShadowSanitize('OxiAddonsPriceTable-I-BS') . '' 
                . '||#||'
                ...
                . ' OxiAddonsPriceTable-I-IB ||#||' . OxiAddonsAdminFontAwesomeSenitize($_POST['OxiAddonsPriceTable-I-IB']) . '||#|| '  
                . ' ||#||';
        ...
        <div class="oxi-addons-row">
                        ...
                        <div class="oxi-addons-tabs-wrapper">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-feature-BW', 104, $styledata, 1, 'Border Width', 'Set Your Price Table Feature Border Width', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-main-feature','border-width');
                                ...
                                <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-I-IB', $stylefiles[20], 'Icon', 'Set FontAwesome Icon class Name for Price Table', 'false');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-I-width', $styledata[441], $styledata[442], $styledata[443], 1, 'Width', 'Set Your Icon Width', 'true','.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-I-height', $styledata[445], $styledata[446], $styledata[447], 1, 'Height', 'Set Your Icon  Height', 'true','.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-I-FS', $styledata[449], $styledata[450], $styledata[451], '', 'Font Size', 'Set  Price Table Icon Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-I-TC', $styledata[453], '', 'Icon Color', 'Set  Price Table Icon color', 'false', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-I-Bg', $styledata[455], 'rgba', 'Background Color', 'Set Your Icon Background Color', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'background');
                                            echo oxi_addons_adm_help_border('OxiAddonsPriceTable-I-B', $styledata[457], $styledata[458], 'Border', 'Set Your Icon Border Size and Type', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'border');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-I-BC', $styledata[461], '', 'Border Color', 'Set your Icon Border color', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'border-color');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-I-radius', 479, $styledata, 1, 'Border Radius', 'Set Your Icon Border Radius', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-I-P', 463, $styledata, 1, 'Padding', 'Set your icon padding', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons', 'padding');
                                            echo OxiAddonsADMHelpNoJquery(
                                                array(
                                                    array('OxiAddonsPriceTable-I-PS', 'Position'), 
                                                )
                                            );
                                            ?>
                                        </div>
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsPriceTable-I-BS', 495, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . '  .oxi-icons');
                                            ?>
                                        </div>
                                    </div> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-T-P', 303, $styledata, 1, 'Padding', 'Set Price Table  Title Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-main-heading', 'padding');
                                             ?>
                                        </div>
                                        <div class="oxi-head">
                                          Title Box Shadow
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-Pbox-width', $styledata[325], $styledata[326], $styledata[327], '1', 'Max Width', 'Set Price Boxes Width', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box', 'font-size');
                                             echo oxi_addons_adm_help_Text_Align('OxiAddonsPriceTable-Pbox-PS', $styledata[329], 'Position', 'Set Price Table  Position', 'false');
                                             echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-Pbox-BG', $styledata[331], 'rgba', 'Background Color', 'Set Price Table  background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box', 'background');
                                             echo oxi_addons_adm_help_border('OxiAddonsPriceTable-Pbox-B', $styledata[333], $styledata[334], 'Border', 'Set Price Table Border Size and Type', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box');
                                             echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-Pbox-BC', $styledata[337], '', 'Border Color', 'Set  Price Table Border color', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box','border-color');
                                             echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Pbox-BR', 339, $styledata, 1, 'Border Radius', 'Set Price Table Border Radius', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box','border-radius');
                                             echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Pbox-P', 407, $styledata, 1, 'Padding', 'Set Price Table  Border Radius', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box','border-radius');
                                             echo OxiAddonsADMHelpNoJquery(
                                                array(
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-P-TB', $stylefiles[10], 'Price', 'Write Your Price table Price text for Price Table', 'false','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price');
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-P-C', $styledata[371], '', 'Color', 'Set Price table Price text Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'color');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Psub-P', 407, $styledata, 1, 'Padding', 'Set Your Price Table Sub title Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-title', 'padding');
                                           ?>
                                        </div>
                                    </div> 
                                </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_price_table_style_7_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
