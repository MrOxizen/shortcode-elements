...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-icon-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsPriceTable-Pbox-M') . ''
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                              ...
                                              echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-G-BG', $styledata[3], 'rgba', 'Background', 'Set Your Price Table Background Color', 'false', '.oxi-addons-button-wrapper-' . $oxiid . '', 'background');
                                              echo OxiAddonsADMhelpBorder('OxiAddonsPriceTable-G-CT', 5, $styledata ,'true','.oxi-addons-button-wrapper-' . $oxiid . '','border');
                                              echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-G-BW', 9, $styledata, 1, 'Border Width', 'Set Your Price Table  Border Width', 'true','.oxi-addons-button-wrapper-' . $oxiid . '','border-width');
                                              echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-G-BR', 25, $styledata, 1, 'Border Radius', 'Set Your Price Table  Border Radius', 'true','.oxi-addons-button-wrapper-' . $oxiid . '','border-radius');
                                              ...
                                              echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-G-M', 57, $styledata, 1, 'Margin', 'Set Yout Price Table  Margin', 'true','.oxi-addons-main-wrapper-' . $oxiid . '','margin');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiAddonsPriceTable-G-Animation', 73, $styledata, 'true', '.oxi-addons-button-wrapper-' . $oxiid . '');
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-feature-FS', $styledata[84], $styledata[85], $styledata[86], '1', 'Font Size', 'Set Price Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-feature', 'font-size');
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-feature-Second-C', $styledata[96], '', 'Secondary Color', 'Set Price Table Feature Secondary Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-feature span', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-feature-P', 120, $styledata, 1, 'Padding', 'Set Price Table Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-feature', 'padding');
                                           ?>
                                        </div>
                                    </div> 
                                </div>
                                <div class="oxi-addons-col-6">  
                                    <div class="oxi-addons-content-div">
                                            <div class="oxi-head">
                                                Price Table Main Title Setting
                                            </div>
                                            <div class="oxi-addons-content-div-body">
                                                <?php
                                                ...
                                                echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-T-FS', $styledata[289], $styledata[290], $styledata[291], '2', 'Font Size', 'Set Price Title Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-heading-title', 'font-size');
                                                echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-T-C', $styledata[293], '', 'Color', 'Set Price Title Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-heading-title', 'color');
                                                echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-T-BG', $styledata[295], 'rgba', 'Background Color', 'Set Price Title Background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-heading-title', 'background');
                                                ...
                                                echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-T-P', 303, $styledata, 1, 'Padding', 'Set Price Title Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-heading-title', 'padding');
                                                ?>
                                            </div>
                                            <div class="oxi-head">
                                                Title Box Shadow
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                             echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-Pbox-width', $styledata[325], $styledata[326], $styledata[327], '1', 'Max Width', 'Set Price table Price Boxes Width', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box', 'font-size');
                                             echo oxi_addons_adm_help_Text_Align('OxiAddonsPriceTable-Pbox-PS', $styledata[329], 'Position', 'Set Price Table  Position', 'false');
                                             echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-Pbox-BG', $styledata[331], 'rgba', 'Background Color', 'Set Price Table Price Boxes  background color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box', 'background');
                                             echo oxi_addons_adm_help_border('OxiAddonsPriceTable-Pbox-B', $styledata[333], $styledata[334], 'Border', 'Set Price Table Price Boxes Border Size and Type', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box');
                                             echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-Pbox-BC', $styledata[337], '', 'Border Color', 'Set  Price Table Price Boxes Border color', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box','border-color');
                                             echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Pbox-BR', 339, $styledata, 1, 'Border Radius', 'Set Price Table Price Boxes Border Radius', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box','border-radius');
                                             echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Pbox-P', 397, $styledata, 1, 'Padding', 'Set Price Table Price Boxes  Padding', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-box','padding');
                                             echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-Pbox-M', 413, $styledata, 1, 'Margin', 'Set Price Table Price Boxes Margin', 'true','.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price-position','padding');
                                             echo OxiAddonsADMHelpNoJquery(
                                                array(
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-P-FS', $styledata[361], $styledata[362], $styledata[363], '1', 'Font Size', 'Set Price table Price text Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-P-C', $styledata[371], '', 'Color', 'Set Price table Price Text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'color');
                                             echo OxiAddonsADMHelpFontSettings('OxiAddonsPriceTable-P-F', 365, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-P-P', 373, $styledata, 1, 'Padding', 'Set Price table Price text Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-price', 'padding');
                                           ?>
                                        </div>
                                        <div class="oxi-head">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsPriceTable-B-BT', $stylefiles[14], 'Button Text', 'Set Price Table Button Text', 'false','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-B-P', 192, $styledata, 1, 'Padding', 'Set Price Table Button padding', 'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link','padding');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-B-M', 208, $styledata, 1, 'Margin', 'Set Price Table Button margin', 'true','.oxi-addons-button-wrapper-' . $oxiid . '  .oxi-addons-button','margin');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                            Button Position
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_true_false('OxiAddonsPriceTable-G-button-top-bottom', $styledata[395], 'Top', 'top', 'Bottom', 'bottom', 'Button Top Bottom', 'Set Your Button Top Or Bottom', 'false');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsPriceTable-B-FS', $styledata[226], $styledata[227], $styledata[228], '', 'Font Size', 'Set Price Table Button Font Size', 'true', '.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-TC', $styledata[230], '', 'Text Color', 'Set Price Table Button Text color', 'false', '.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-BG', $styledata[232], 'rgba', 'Background Color', 'Set Price Table Button background color', 'false', '.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link', 'background');
                                            echo oxi_addons_adm_help_border('OxiAddonsPriceTable-B-B', $styledata[234], $styledata[235], 'Border', 'Set Price Table Border Size and Type', 'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-BC', $styledata[238], '', 'Border Color', 'Set Border color', 'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link','border-color');
                                            echo OxiAddonsADMHelpButtonFontSettings('OxiAddonsPriceTable-B-F', 240, $styledata, 'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsPriceTable-B-BR', 246, $styledata, 1, 'Border Radius', 'Set Price Table Button Border Radius', 'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link','border-radius');
                                            ?>
                                        </div> 
                                        <div class="oxi-head">
                                            Button Box Shadow
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsPriceTable-B-BS', 262, $styledata,'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link');
                                            ?> 
                                        </div> 
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">  
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-HTC', $styledata[273], '', 'Color', 'Set Price Table Button Hover Text color', 'false', '.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link:hover', 'color');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-HBG', $styledata[275], 'rgba', 'Background Color', 'Set Price Table Button Hover Background color', 'false', '.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link:hover', 'background');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsPriceTable-B-HBC', $styledata[277], '', 'Border Color', 'Set Price Table Button Hover Border color', 'true', '.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link:hover', 'border-color');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddonsPriceTable-B-HBS', 279, $styledata,'true','.oxi-addons-button-wrapper-' . $oxiid . ' .oxi-addons-button .oxi-addons-link:hover');
                                            ?> 
                                        </div>
                                    </div>   
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_price_table_style_6_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
