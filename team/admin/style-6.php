...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddons-social-box-padding-top') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddons-social-box-margin-top') . ''
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddons-border') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddons-social-fs') . ''
            . ' OxiAddons-img-scale|' . sanitize_text_field($_POST['OxiAddons-img-scale']) . '|'
            . ' OxiAddons-img-Hoverscale|' . sanitize_text_field($_POST['OxiAddons-img-Hoverscale']) . '|'
            . ' OxiAddons-img-scaleduration|' . sanitize_text_field($_POST['OxiAddons-img-scaleduration']) . '|'
            . '||'
            ...
            . '' . OxiAddonsADMHelpBorderSanitize('OxiAddons-border') . '|'
            . '||||||||'
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddons-social-box-border-radius') . ''
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMHelpBGImage('OxiAddons-BG', $styledata, 7, 'true');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddons-border', 159, $styledata, 1, 'Border width', 'Set Your Team Border width', 'true', '', 'border-width');
                                            echo OxiAddonsADMhelpBorder('OxiAddons-border', 215, $styledata, 'true', '', 'border');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddons-social-box-border-radius', 227, $styledata, 1, 'Border Radius', 'Set Your Team Name Border Radius Top Bottom and Left Right', 'true');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddons-img-scale', $styledata[179], 0.01, 'Scale', 'Set Your Team Profile Image Scale', 'true');
                                            echo oxi_addons_adm_help_number('OxiAddons-img-Hoverscale', $styledata[181], 0.01, 'Hover Scale', 'Set Your Team Profile Image Hover Scale', 'true');
                                            echo oxi_addons_adm_help_number('OxiAddons-img-scaleduration', $styledata[183], 0.1, 'Scale Duration', 'Set Your Team Profile Image Hover Scale Duration', 'true');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddons-box-shadow', 51, $styledata, 'true');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMhelpBoxShadow('OxiAddons-hover-box-shadow', 58, $styledata, 'true');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-social-box-padding-top', $styledata[151], $styledata[152], $styledata[153], 1, 'Padding', 'Set Your Social icon Box Padding Top', 'true');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-social-box-margin-top', $styledata[155], $styledata[156], $styledata[157], 1, 'Margin', 'Set Your Social icon Box Padding Top', 'true');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_6_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
