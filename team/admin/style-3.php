...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddons-transform-hover-opacity|' . sanitize_text_field($_POST['OxiAddons-transform-hover-opacity']) . '|'
            . ' ||'
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number('OxiAddons-transform-hover-opacity', $styledata[151], 0.01, 'Hover Opacity', 'Set Your Team Hover Opacity', 'FALSE');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-social-height', $styledata[191], $styledata[192], $styledata[193], 1, 'Height', 'Set Your Social icon Box Height Size', 'false');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_3_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
