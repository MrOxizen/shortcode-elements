...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '||||'
            . ' OxiAddons-hover-img-BG|' . sanitize_text_field($_POST['OxiAddons-hover-img-BG']) . '|'
            . ' animation-position|' . sanitize_text_field($_POST['animation-position']) . '|'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddons-border-line-width') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddons-border-line-height') . ''
            . ' OxiAddons-border-line-C|' . sanitize_text_field($_POST['OxiAddons-border-line-C']) . '|'
            . '' . oxi_addons_adm_help_single_size('OxiAddons-bottom-border-width') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddons-bottom-border-height') . ''
            . ' OxiAddons-bottom-border-C|' . sanitize_text_field($_POST['OxiAddons-bottom-border-C']) . '|'
            . '||||||||'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddons-des-fs') . ''
            . ' OxiAddons-des-C|' . sanitize_text_field($_POST['OxiAddons-des-C']) . '|'
            . '' . OxiAddonsADMHelpFontSettingsSanitize('OxiAddons-des') . ''
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddons-des-padding') . ''
            . '||#||'
            . $socialindata;
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddons-padding', 11, $styledata, 1, 'Padding', 'Set Your Team Paddins Top Bottom and Left Right', 'true');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="animation-position" class="col-sm-6 control-label" oxi-addons-tooltip="Set your Animation">Animation Position </label>
                                                <div class="col-sm-6 addons-dtm-laptop-lock">
                                                    <select class="form-control" id="animation-position" name="animation-position">
                                                        <option value="top" <?php echo selected('top', $styledata[185], true); ?>>Top</option>
                                                        <option value="bottom" <?php echo selected('bottom', $styledata[185], true); ?>>Bottom</option>
                                                        <option value="left" <?php echo selected('left', $styledata[185], true); ?>>Left</option>
                                                        <option value="right" <?php echo selected('right', $styledata[185], true); ?>>Right</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-hover-img-BG', $styledata[183], 'rgba', 'Background Color', 'Select Your Hover Background Color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-name-C', $styledata[73], 'hex', 'Color', 'Select Your Heading Hover Color');
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-des-fs', $styledata[275], $styledata[276], $styledata[277], 1, 'Font Size', 'Set Your Team Name Font Size', 'true');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-des-C', $styledata[279], 'hex', 'Color', 'Select Your Heading Hover Color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddons-des', 281, $styledata);
                                            echo oxi_addons_adm_help_padding_margin('OxiAddons-des-padding', 287, $styledata, 1, 'Padding', 'Set Your Team Name Padding Top Bottom and Left Right', 'true');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-border-line-width', $styledata[215], $styledata[216], $styledata[217], 1, 'Width', 'Set Your Team Name Font Size', 'true');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-border-line-height', $styledata[219], $styledata[220], $styledata[221], 1, 'Height', 'Set Your Team Name Font Size', 'true');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-border-line-C', $styledata[223], 'hex', 'Color', 'Select Your Heading Hover Color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-bottom-border-width', $styledata[225], $styledata[226], $styledata[227], 1, 'Width', 'Set Your Team Name Font Size', 'true');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-bottom-border-height', $styledata[229], $styledata[230], $styledata[231], 1, 'Height', 'Set Your Team Name Font Size', 'true');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-bottom-border-C', $styledata[233], 'hex', 'Color', 'Select Your Heading Hover Color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_22_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_form_textarea('OxiAddCB-content', $listitemdata[9], 'Description:', 'Write your content box short details', 'false');
                    ?>
                    <div class="oxi-addons-content-div">
                        <div class="oxi-head">
                            Social Icons
