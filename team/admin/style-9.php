...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . ' OxiAddons-line-border|' . sanitize_text_field($_POST['OxiAddons-line-border']) . '|'
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-social-width', $styledata[187], $styledata[188], $styledata[189], 1, 'Width', 'Set Your Social icon Box Width Size', 'true');
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-social-P-BG', $styledata[153], 'rgba', 'Background', 'Select Your Socail Box Background Color');
                                            echo oxi_addons_adm_help_number('OxiAddons-line-border', $styledata[151], 1, 'Left Right Border', 'Set Your Team Icon Box Left Right line border', 'true');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_9_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
