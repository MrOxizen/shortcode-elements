...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-team-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_single_size('OxiAddons-sidebar-W') . ''
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddons-social-margin') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddons-sidebar-H') . ''
            . '' . oxi_addons_adm_help_single_size('OxiAddons-social-fs') . ''
            . ' OxiAddons-sidebar-C|' . sanitize_text_field($_POST['OxiAddons-sidebar-C']) . '|'
            . '' . oxi_addons_adm_help_single_size('OxiAddons-img-border') . ''
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-img-border', $styledata[181], $styledata[182], $styledata[183], 1, 'Border Width', 'Select Your Image Border Width', 'true');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-sidebar-W', $styledata[151], $styledata[152], $styledata[153], 1, 'Width', 'Select Your Image Side Bar Width', 'true');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddons-sidebar-H', $styledata[171], $styledata[172], $styledata[173], 1, 'Height', 'Select Your Image Side Bar Height with the Percentage', 'true');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddons-sidebar-C', $styledata[179], 'hex', 'Color', 'Select Your Side Bar Color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-style-left-preview" style="margin-top: 0; border-top: 0">
                    <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                        <?php echo oxi_team_style_12_shortcode($style, $listdata, 'admin') ?>
                    </div>
                </div>
            </div>
        </div>
