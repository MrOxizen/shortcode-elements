        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMhelpBorder('OxiAddonsLogoShowcase-border', 70, $styledata, 'true', '.oxi-addons-container .oxi-addons-logo-showcase-img-' . $oxiid . '', '');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsLogoShowcase-border-width', 73, $styledata, 1, 'Border-width', 'Set Your Logo Border', 'true', '.oxi-addons-container .oxi-addons-logo-showcase-img-' . $oxiid . '', 'border-width');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_logo_showcase_style_4_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
