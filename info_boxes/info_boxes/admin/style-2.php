                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-box-icon-hover-border-radius', 87, $styledata, 1, 'Border Radius', 'Set hover Icon  border radius ', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-box-content-padding', 145, $styledata, 1, 'Padding', 'Set Your Content Padding', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-contetn.oxi-add-info-box' . $oxiid . ' .oxi-info-contetn', 'padding');
                                            ?>
                                        </div>
                                    </div>                                 
                                </div>
