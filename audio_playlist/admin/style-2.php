        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsAudioPlaylist-title-C', $styledata[64], '', 'Color', 'Set Audio title  text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-title', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddonsAudioPlaylist-title-F', 58, $styledata, 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-title');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsAudioPlaylist-title-P', 66, $styledata, 1, 'Padding', 'Set Audio title  Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-title', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $NOJS = array(
                                                array('OxiAddonsAudioPlaylist-audio-BG', 'Background Color'),
                                            );
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            $NOJS = array(
                                                array('OxiAddonsAudioPlaylist-PBS-C', 'Previous Color'),
                                                array('OxiAddonsAudioPlaylist-PBS-active-C', 'Active Color'),
                                            );
                                            echo OxiAddonsADMHelpNoJquery($NOJS);
                                            ?>
                                        </div>
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_audio_playlist_style_2_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
