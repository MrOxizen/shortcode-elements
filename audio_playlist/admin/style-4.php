...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
            ...
            . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsAudioPlaylist-audio-margin') . ''
        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
                                ...
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_textbox('OxiAddonsAudioPlaylist-title-TA', $stylefiles[2], 'Title', 'Write your Audio Title');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudioPlaylist-title-FS', $styledata[54], $styledata[55], $styledata[56], '2', 'Font Size', 'Set Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-title', 'font-size');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-2">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsAudioPlaylist-audio-margin', 804, $styledata, 1, 'Margin', 'Set Audio play controls Margin', 'true', '.oxi-addons-wrapper-' . $oxiid . '  .jp-audio .jp-controls-holder', 'margin');
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_double_dtm('OxiAddonsAudioPlaylist-progress-W', $styledata[296], $styledata[297], $styledata[298], 'OxiAddonsAudioPlaylist-progress-H', $styledata[300], $styledata[301], $styledata[302], 1, 'Width Height', 'Set Audio Progress Bar  width must be %  and height must be px', 'true');
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-3">
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsAudioPlaylist-playlist-item-FS', $styledata[724], $styledata[725], $styledata[726], '2', 'Font Size', 'Set Audio title  Font Size', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .jp-playlist li .jp-playlist-item', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddonsAudioPlaylist-playlist-item-C', $styledata[660], '', 'Color', 'Set Audio Playlist Item text color', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .jp-playlist li .jp-playlist-item', 'color');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsAudioPlaylist-playlist-item-P', 668, $styledata, 1, 'Padding', 'Set Audio Playlist Item Padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .jp-playlist li .jp-playlist-item', 'padding');
                                            ?>
                                        </div>
                                        <div class="oxi-head">
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_audio_playlist_style_4_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
